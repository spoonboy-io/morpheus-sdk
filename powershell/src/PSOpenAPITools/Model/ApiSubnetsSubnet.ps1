...
ApiSubnetsSubnet<PSCustomObject>
#>

function Initialize-ApiSubnetsSubnet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiSubnetsSubnet' | Write-Debug
...
Convert from JSON to ApiSubnetsSubnet<PSCustomObject>
...
ApiSubnetsSubnet<PSCustomObject>
#>
function ConvertFrom-JsonToApiSubnetsSubnet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiSubnetsSubnet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiSubnetsSubnet
