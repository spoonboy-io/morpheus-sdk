...
ClusterDeployments<PSCustomObject>
#>

function Initialize-ClusterDeployments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterDeployments' | Write-Debug
...
Convert from JSON to ClusterDeployments<PSCustomObject>
...
ClusterDeployments<PSCustomObject>
#>
function ConvertFrom-JsonToClusterDeployments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterDeployments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterDeployments
