...
ExecuteTasksRequestJob<PSCustomObject>
#>

function Initialize-ExecuteTasksRequestJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExecuteTasksRequestJob' | Write-Debug
...
Convert from JSON to ExecuteTasksRequestJob<PSCustomObject>
...
ExecuteTasksRequestJob<PSCustomObject>
#>
function ConvertFrom-JsonToExecuteTasksRequestJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExecuteTasksRequestJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExecuteTasksRequestJob
