...
IdentitySourcesJumpCloudConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesJumpCloudConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesJumpCloudConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesJumpCloudConfig<PSCustomObject>
...
IdentitySourcesJumpCloudConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesJumpCloudConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesJumpCloudConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesJumpCloudConfig
