...
AddSecurityGroupLocationsRequestSecurityGroupLocation<PSCustomObject>
#>

function Initialize-AddSecurityGroupLocationsRequestSecurityGroupLocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddSecurityGroupLocationsRequestSecurityGroupLocation' | Write-Debug
...
Convert from JSON to AddSecurityGroupLocationsRequestSecurityGroupLocation<PSCustomObject>
...
AddSecurityGroupLocationsRequestSecurityGroupLocation<PSCustomObject>
#>
function ConvertFrom-JsonToAddSecurityGroupLocationsRequestSecurityGroupLocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddSecurityGroupLocationsRequestSecurityGroupLocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddSecurityGroupLocationsRequestSecurityGroupLocation
