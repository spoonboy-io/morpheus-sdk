...
BillingInstancesPrices<PSCustomObject>
#>

function Initialize-BillingInstancesPrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesPrices' | Write-Debug
...
Convert from JSON to BillingInstancesPrices<PSCustomObject>
...
BillingInstancesPrices<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesPrices {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesPrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesPrices
