...
CheckElastic<PSCustomObject>
#>

function Initialize-CheckElastic {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CheckElastic' | Write-Debug
...
Convert from JSON to CheckElastic<PSCustomObject>
...
CheckElastic<PSCustomObject>
#>
function ConvertFrom-JsonToCheckElastic {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CheckElastic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CheckElastic
