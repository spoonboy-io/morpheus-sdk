...
CheckWeb<PSCustomObject>
#>

function Initialize-CheckWeb {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CheckWeb' | Write-Debug
...
Convert from JSON to CheckWeb<PSCustomObject>
...
CheckWeb<PSCustomObject>
#>
function ConvertFrom-JsonToCheckWeb {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CheckWeb' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CheckWeb
