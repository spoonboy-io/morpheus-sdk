...
GetNetworkTransportZone200ResponseNetworkScope<PSCustomObject>
#>

function Initialize-GetNetworkTransportZone200ResponseNetworkScope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkTransportZone200ResponseNetworkScope' | Write-Debug
...
Convert from JSON to GetNetworkTransportZone200ResponseNetworkScope<PSCustomObject>
...
GetNetworkTransportZone200ResponseNetworkScope<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkTransportZone200ResponseNetworkScope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkTransportZone200ResponseNetworkScope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkTransportZone200ResponseNetworkScope
