...
BudgetStatsIntervals<PSCustomObject>
#>

function Initialize-BudgetStatsIntervals {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BudgetStatsIntervals' | Write-Debug
...
Convert from JSON to BudgetStatsIntervals<PSCustomObject>
...
BudgetStatsIntervals<PSCustomObject>
#>
function ConvertFrom-JsonToBudgetStatsIntervals {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BudgetStatsIntervals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BudgetStatsIntervals
