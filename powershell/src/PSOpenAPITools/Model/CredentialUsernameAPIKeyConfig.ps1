...
CredentialUsernameAPIKeyConfig<PSCustomObject>
#>

function Initialize-CredentialUsernameAPIKeyConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("username-api-key")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CredentialUsernameAPIKeyConfig' | Write-Debug
...
Convert from JSON to CredentialUsernameAPIKeyConfig<PSCustomObject>
...
CredentialUsernameAPIKeyConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCredentialUsernameAPIKeyConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CredentialUsernameAPIKeyConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CredentialUsernameAPIKeyConfig
