...
ClusterUpdatePermissionsResourcePermissions<PSCustomObject>
#>

function Initialize-ClusterUpdatePermissionsResourcePermissions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterUpdatePermissionsResourcePermissions' | Write-Debug
...
Convert from JSON to ClusterUpdatePermissionsResourcePermissions<PSCustomObject>
...
ClusterUpdatePermissionsResourcePermissions<PSCustomObject>
#>
function ConvertFrom-JsonToClusterUpdatePermissionsResourcePermissions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterUpdatePermissionsResourcePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterUpdatePermissionsResourcePermissions
