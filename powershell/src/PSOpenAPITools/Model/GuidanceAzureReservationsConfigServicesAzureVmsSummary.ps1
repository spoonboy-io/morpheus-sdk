...
GuidanceAzureReservationsConfigServicesAzureVmsSummary<PSCustomObject>
#>

function Initialize-GuidanceAzureReservationsConfigServicesAzureVmsSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceAzureReservationsConfigServicesAzureVmsSummary' | Write-Debug
...
Convert from JSON to GuidanceAzureReservationsConfigServicesAzureVmsSummary<PSCustomObject>
...
GuidanceAzureReservationsConfigServicesAzureVmsSummary<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceAzureReservationsConfigServicesAzureVmsSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceAzureReservationsConfigServicesAzureVmsSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceAzureReservationsConfigServicesAzureVmsSummary
