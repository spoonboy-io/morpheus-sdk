...
ClusterLayoutComputeServers<PSCustomObject>
#>

function Initialize-ClusterLayoutComputeServers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterLayoutComputeServers' | Write-Debug
...
Convert from JSON to ClusterLayoutComputeServers<PSCustomObject>
...
ClusterLayoutComputeServers<PSCustomObject>
#>
function ConvertFrom-JsonToClusterLayoutComputeServers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterLayoutComputeServers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterLayoutComputeServers
