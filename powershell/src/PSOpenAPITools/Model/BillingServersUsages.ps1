...
BillingServersUsages<PSCustomObject>
#>

function Initialize-BillingServersUsages {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersUsages' | Write-Debug
...
Convert from JSON to BillingServersUsages<PSCustomObject>
...
BillingServersUsages<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersUsages {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersUsages' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersUsages
