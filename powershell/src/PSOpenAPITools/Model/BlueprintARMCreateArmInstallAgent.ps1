...
BlueprintARMCreateArmInstallAgent<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintARMCreateArmInstallAgent {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Boolean' defined in oneOf (BlueprintARMCreateArmInstallAgent). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (BlueprintARMCreateArmInstallAgent). Proceeding to the next one if any."
        }
