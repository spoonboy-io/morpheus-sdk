...
BillingInstancesUsages<PSCustomObject>
#>

function Initialize-BillingInstancesUsages {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesUsages' | Write-Debug
...
Convert from JSON to BillingInstancesUsages<PSCustomObject>
...
BillingInstancesUsages<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesUsages {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesUsages' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesUsages
