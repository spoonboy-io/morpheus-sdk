...
BlueprintTerraformCreateSuccess<PSCustomObject>
#>

function Initialize-BlueprintTerraformCreateSuccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlueprintTerraformCreateSuccess' | Write-Debug
...
Convert from JSON to BlueprintTerraformCreateSuccess<PSCustomObject>
...
BlueprintTerraformCreateSuccess<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintTerraformCreateSuccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlueprintTerraformCreateSuccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlueprintTerraformCreateSuccess
        $AllProperties = ("name", "image", "type", "terraform", "config", "visibility", "resourcePermission", "owner", "tenant")
