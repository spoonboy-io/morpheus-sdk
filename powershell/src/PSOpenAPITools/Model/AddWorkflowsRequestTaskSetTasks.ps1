...
AddWorkflowsRequestTaskSetTasks<PSCustomObject>
#>

function Initialize-AddWorkflowsRequestTaskSetTasks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddWorkflowsRequestTaskSetTasks' | Write-Debug
...
Convert from JSON to AddWorkflowsRequestTaskSetTasks<PSCustomObject>
...
AddWorkflowsRequestTaskSetTasks<PSCustomObject>
#>
function ConvertFrom-JsonToAddWorkflowsRequestTaskSetTasks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddWorkflowsRequestTaskSetTasks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddWorkflowsRequestTaskSetTasks
