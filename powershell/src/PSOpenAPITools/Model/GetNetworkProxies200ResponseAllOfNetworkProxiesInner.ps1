...
GetNetworkProxies200ResponseAllOfNetworkProxiesInner<PSCustomObject>
#>

function Initialize-GetNetworkProxies200ResponseAllOfNetworkProxiesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkProxies200ResponseAllOfNetworkProxiesInner' | Write-Debug
...
Convert from JSON to GetNetworkProxies200ResponseAllOfNetworkProxiesInner<PSCustomObject>
...
GetNetworkProxies200ResponseAllOfNetworkProxiesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkProxies200ResponseAllOfNetworkProxiesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkProxies200ResponseAllOfNetworkProxiesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkProxies200ResponseAllOfNetworkProxiesInner
        $AllProperties = ("id", "name", "proxyHost", "proxyPort", "proxyUser", "proxyPassword", "proxyDomain", "proxyWorkstation", "visibility", "account", "owner")
