...
BillingServerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
#>

function Initialize-BillingServerUsagesInnerApplicablePricesInnerPricesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServerUsagesInnerApplicablePricesInnerPricesInner' | Write-Debug
...
Convert from JSON to BillingServerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
...
BillingServerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServerUsagesInnerApplicablePricesInnerPricesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServerUsagesInnerApplicablePricesInnerPricesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServerUsagesInnerApplicablePricesInnerPricesInner
        $AllProperties = ("type", "pricePerUnit", "costPerUnit", "cost", "price", "quantity", "datastoreId", "volumeType", "datastore")
