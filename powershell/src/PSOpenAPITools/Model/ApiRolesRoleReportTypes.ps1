...
ApiRolesRoleReportTypes<PSCustomObject>
#>

function Initialize-ApiRolesRoleReportTypes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiRolesRoleReportTypes' | Write-Debug
...
Convert from JSON to ApiRolesRoleReportTypes<PSCustomObject>
...
ApiRolesRoleReportTypes<PSCustomObject>
#>
function ConvertFrom-JsonToApiRolesRoleReportTypes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiRolesRoleReportTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiRolesRoleReportTypes
