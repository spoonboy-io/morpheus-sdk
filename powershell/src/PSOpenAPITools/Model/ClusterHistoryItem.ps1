...
ClusterHistoryItem<PSCustomObject>
#>

function Initialize-ClusterHistoryItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterHistoryItem' | Write-Debug
...
Convert from JSON to ClusterHistoryItem<PSCustomObject>
...
ClusterHistoryItem<PSCustomObject>
#>
function ConvertFrom-JsonToClusterHistoryItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterHistoryItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterHistoryItem
        $AllProperties = ("id", "accountId", "uniqueId", "processType", "description", "subType", "subId", "zoneId", "integrationId", "appId", "instanceId", "containerId", "serverId", "containerName", "displayName", "status", "reason", "percent", "statusEta", "message", "output", "error", "startDate", "endDate", "duration", "dateCreated", "lastUpdated", "createdBy", "updatedBy", "events")
