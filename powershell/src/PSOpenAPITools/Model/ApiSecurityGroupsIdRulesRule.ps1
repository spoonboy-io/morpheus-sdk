...
ApiSecurityGroupsIdRulesRule<PSCustomObject>
#>

function Initialize-ApiSecurityGroupsIdRulesRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiSecurityGroupsIdRulesRule' | Write-Debug
...
Convert from JSON to ApiSecurityGroupsIdRulesRule<PSCustomObject>
...
ApiSecurityGroupsIdRulesRule<PSCustomObject>
#>
function ConvertFrom-JsonToApiSecurityGroupsIdRulesRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiSecurityGroupsIdRulesRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiSecurityGroupsIdRulesRule
