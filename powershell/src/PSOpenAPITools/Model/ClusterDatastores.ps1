...
ClusterDatastores<PSCustomObject>
#>

function Initialize-ClusterDatastores {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterDatastores' | Write-Debug
...
Convert from JSON to ClusterDatastores<PSCustomObject>
...
ClusterDatastores<PSCustomObject>
#>
function ConvertFrom-JsonToClusterDatastores {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterDatastores' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterDatastores
        $AllProperties = ("id", "name", "code", "type", "visibility", "storageSize", "freeSpace", "drsEnabled", "active", "allowWrite", "defaultStore", "online", "allowRead", "allowProvision", "refType", "refId", "externalId", "zone", "zonePool", "owner", "tenants", "datastores", "permissions")
