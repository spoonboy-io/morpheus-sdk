...
CheckElasticConfig<PSCustomObject>
#>

function Initialize-CheckElasticConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CheckElasticConfig' | Write-Debug
...
Convert from JSON to CheckElasticConfig<PSCustomObject>
...
CheckElasticConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCheckElasticConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CheckElasticConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CheckElasticConfig
