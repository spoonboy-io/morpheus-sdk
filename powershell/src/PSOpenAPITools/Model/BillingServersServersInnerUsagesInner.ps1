...
BillingServersServersInnerUsagesInner<PSCustomObject>
#>

function Initialize-BillingServersServersInnerUsagesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInner' | Write-Debug
...
Convert from JSON to BillingServersServersInnerUsagesInner<PSCustomObject>
...
BillingServersServersInnerUsagesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersServersInnerUsagesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersServersInnerUsagesInner
        $AllProperties = ("name", "zoneName", "accountName", "volumes", "maxMemory", "maxCpu", "maxCores", "serverExternalId", "serverInternalId", "planName", "hourlyPrice", "hourlyCost", "currency", "pricesUsed", "cost", "price", "createdByUser", "createdByUserId", "siteId", "siteName", "siteUUID", "siteCode", "startDate", "endDate", "status", "tags", "applicablePrices", "servicePlanId", "servicePlanName", "resourcePoolId", "resourcePoolName")
