...
ClusterDatastoresPermissionsResourcePermissions<PSCustomObject>
#>

function Initialize-ClusterDatastoresPermissionsResourcePermissions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterDatastoresPermissionsResourcePermissions' | Write-Debug
...
Convert from JSON to ClusterDatastoresPermissionsResourcePermissions<PSCustomObject>
...
ClusterDatastoresPermissionsResourcePermissions<PSCustomObject>
#>
function ConvertFrom-JsonToClusterDatastoresPermissionsResourcePermissions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterDatastoresPermissionsResourcePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterDatastoresPermissionsResourcePermissions
