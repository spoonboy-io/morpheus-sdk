...
CatalogOrderCreateSuccessItems<PSCustomObject>
#>

function Initialize-CatalogOrderCreateSuccessItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogOrderCreateSuccessItems' | Write-Debug
...
Convert from JSON to CatalogOrderCreateSuccessItems<PSCustomObject>
...
CatalogOrderCreateSuccessItems<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogOrderCreateSuccessItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogOrderCreateSuccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogOrderCreateSuccessItems
