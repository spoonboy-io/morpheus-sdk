...
GuidanceVmwareSizingPlanAfterAction<PSCustomObject>
#>

function Initialize-GuidanceVmwareSizingPlanAfterAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingPlanAfterAction' | Write-Debug
...
Convert from JSON to GuidanceVmwareSizingPlanAfterAction<PSCustomObject>
...
GuidanceVmwareSizingPlanAfterAction<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceVmwareSizingPlanAfterAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingPlanAfterAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceVmwareSizingPlanAfterAction
