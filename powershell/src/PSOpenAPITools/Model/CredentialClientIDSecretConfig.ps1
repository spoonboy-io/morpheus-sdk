...
CredentialClientIDSecretConfig<PSCustomObject>
#>

function Initialize-CredentialClientIDSecretConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("client-id-secret")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CredentialClientIDSecretConfig' | Write-Debug
...
Convert from JSON to CredentialClientIDSecretConfig<PSCustomObject>
...
CredentialClientIDSecretConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCredentialClientIDSecretConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CredentialClientIDSecretConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CredentialClientIDSecretConfig
