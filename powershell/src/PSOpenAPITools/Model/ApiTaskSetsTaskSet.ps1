...
ApiTaskSetsTaskSet<PSCustomObject>
#>

function Initialize-ApiTaskSetsTaskSet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiTaskSetsTaskSet' | Write-Debug
...
Convert from JSON to ApiTaskSetsTaskSet<PSCustomObject>
...
ApiTaskSetsTaskSet<PSCustomObject>
#>
function ConvertFrom-JsonToApiTaskSetsTaskSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiTaskSetsTaskSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiTaskSetsTaskSet
