...
AddEnvironmentsRequestEnvironment<PSCustomObject>
#>

function Initialize-AddEnvironmentsRequestEnvironment {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddEnvironmentsRequestEnvironment' | Write-Debug
...
Convert from JSON to AddEnvironmentsRequestEnvironment<PSCustomObject>
...
AddEnvironmentsRequestEnvironment<PSCustomObject>
#>
function ConvertFrom-JsonToAddEnvironmentsRequestEnvironment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddEnvironmentsRequestEnvironment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddEnvironmentsRequestEnvironment
