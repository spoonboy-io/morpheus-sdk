...
ApiInstancesIdThresholdInstanceThreshold<PSCustomObject>
#>

function Initialize-ApiInstancesIdThresholdInstanceThreshold {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiInstancesIdThresholdInstanceThreshold' | Write-Debug
...
Convert from JSON to ApiInstancesIdThresholdInstanceThreshold<PSCustomObject>
...
ApiInstancesIdThresholdInstanceThreshold<PSCustomObject>
#>
function ConvertFrom-JsonToApiInstancesIdThresholdInstanceThreshold {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiInstancesIdThresholdInstanceThreshold' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiInstancesIdThresholdInstanceThreshold
        $AllProperties = ("autoUp", "autoDown", "minCount", "maxCount", "cpuEnabled", "minCpu", "maxCpu", "memoryEnabled", "minMemory", "maxMemory", "diskEnabled", "minDisk", "maxDisk")
