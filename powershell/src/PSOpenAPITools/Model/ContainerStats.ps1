...
function Initialize-ContainerStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContainerStats' | Write-Debug
...
Convert from JSON to ContainerStats<PSCustomObject>
...
ContainerStats<PSCustomObject>
#>
function ConvertFrom-JsonToContainerStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContainerStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContainerStats
