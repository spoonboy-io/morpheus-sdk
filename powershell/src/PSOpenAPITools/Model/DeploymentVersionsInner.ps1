...
DeploymentVersionsInner<PSCustomObject>
#>

function Initialize-DeploymentVersionsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeploymentVersionsInner' | Write-Debug
...
Convert from JSON to DeploymentVersionsInner<PSCustomObject>
...
DeploymentVersionsInner<PSCustomObject>
#>
function ConvertFrom-JsonToDeploymentVersionsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeploymentVersionsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeploymentVersionsInner
