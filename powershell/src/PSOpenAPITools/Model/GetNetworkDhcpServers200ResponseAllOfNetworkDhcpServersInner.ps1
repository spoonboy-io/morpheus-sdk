...
GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner<PSCustomObject>
#>

function Initialize-GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner' | Write-Debug
...
Convert from JSON to GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner<PSCustomObject>
...
GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkDhcpServers200ResponseAllOfNetworkDhcpServersInner
