...
ApiRolesRole<PSCustomObject>
#>

function Initialize-ApiRolesRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiRolesRole' | Write-Debug
...
Convert from JSON to ApiRolesRole<PSCustomObject>
...
ApiRolesRole<PSCustomObject>
#>
function ConvertFrom-JsonToApiRolesRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiRolesRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiRolesRole
