...
BillingServerUsagesInner<PSCustomObject>
#>

function Initialize-BillingServerUsagesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServerUsagesInner' | Write-Debug
...
Convert from JSON to BillingServerUsagesInner<PSCustomObject>
...
BillingServerUsagesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServerUsagesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServerUsagesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServerUsagesInner
