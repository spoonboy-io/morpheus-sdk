...
ApiTasksTaskFile<PSCustomObject>
#>

function Initialize-ApiTasksTaskFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiTasksTaskFile' | Write-Debug
...
Convert from JSON to ApiTasksTaskFile<PSCustomObject>
...
ApiTasksTaskFile<PSCustomObject>
#>
function ConvertFrom-JsonToApiTasksTaskFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiTasksTaskFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiTasksTaskFile
