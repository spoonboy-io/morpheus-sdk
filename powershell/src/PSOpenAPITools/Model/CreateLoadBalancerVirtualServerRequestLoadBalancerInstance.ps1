...
CreateLoadBalancerVirtualServerRequestLoadBalancerInstance<PSCustomObject>
#>

function Initialize-CreateLoadBalancerVirtualServerRequestLoadBalancerInstance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateLoadBalancerVirtualServerRequestLoadBalancerInstance' | Write-Debug
...
Convert from JSON to CreateLoadBalancerVirtualServerRequestLoadBalancerInstance<PSCustomObject>
...
CreateLoadBalancerVirtualServerRequestLoadBalancerInstance<PSCustomObject>
#>
function ConvertFrom-JsonToCreateLoadBalancerVirtualServerRequestLoadBalancerInstance {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateLoadBalancerVirtualServerRequestLoadBalancerInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateLoadBalancerVirtualServerRequestLoadBalancerInstance
