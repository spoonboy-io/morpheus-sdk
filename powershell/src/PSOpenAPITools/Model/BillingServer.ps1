...
BillingServer<PSCustomObject>
#>

function Initialize-BillingServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServer' | Write-Debug
...
Convert from JSON to BillingServer<PSCustomObject>
...
BillingServer<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServer
