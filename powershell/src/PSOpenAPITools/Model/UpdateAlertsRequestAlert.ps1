...
UpdateAlertsRequestAlert<PSCustomObject>
#>

function Initialize-UpdateAlertsRequestAlert {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateAlertsRequestAlert' | Write-Debug
...
Convert from JSON to UpdateAlertsRequestAlert<PSCustomObject>
...
UpdateAlertsRequestAlert<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateAlertsRequestAlert {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateAlertsRequestAlert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateAlertsRequestAlert
