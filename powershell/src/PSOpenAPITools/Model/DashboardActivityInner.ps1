...
DashboardActivityInner<PSCustomObject>
#>

function Initialize-DashboardActivityInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DashboardActivityInner' | Write-Debug
...
Convert from JSON to DashboardActivityInner<PSCustomObject>
...
DashboardActivityInner<PSCustomObject>
#>
function ConvertFrom-JsonToDashboardActivityInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DashboardActivityInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DashboardActivityInner
