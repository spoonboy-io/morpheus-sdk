...
AddWikiRequestPage<PSCustomObject>
#>

function Initialize-AddWikiRequestPage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddWikiRequestPage' | Write-Debug
...
Convert from JSON to AddWikiRequestPage<PSCustomObject>
...
AddWikiRequestPage<PSCustomObject>
#>
function ConvertFrom-JsonToAddWikiRequestPage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddWikiRequestPage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddWikiRequestPage
