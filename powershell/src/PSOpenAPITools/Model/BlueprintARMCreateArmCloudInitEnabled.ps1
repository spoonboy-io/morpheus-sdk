...
BlueprintARMCreateArmCloudInitEnabled<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintARMCreateArmCloudInitEnabled {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Boolean' defined in oneOf (BlueprintARMCreateArmCloudInitEnabled). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (BlueprintARMCreateArmCloudInitEnabled). Proceeding to the next one if any."
        }
