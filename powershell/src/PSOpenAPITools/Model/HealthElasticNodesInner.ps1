...
HealthElasticNodesInner<PSCustomObject>
#>

function Initialize-HealthElasticNodesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HealthElasticNodesInner' | Write-Debug
...
Convert from JSON to HealthElasticNodesInner<PSCustomObject>
...
HealthElasticNodesInner<PSCustomObject>
#>
function ConvertFrom-JsonToHealthElasticNodesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HealthElasticNodesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HealthElasticNodesInner
