...
AddStorageServersRequestStorageServer<PSCustomObject>
#>

function Initialize-AddStorageServersRequestStorageServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddStorageServersRequestStorageServer' | Write-Debug
...
Convert from JSON to AddStorageServersRequestStorageServer<PSCustomObject>
...
AddStorageServersRequestStorageServer<PSCustomObject>
#>
function ConvertFrom-JsonToAddStorageServersRequestStorageServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddStorageServersRequestStorageServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddStorageServersRequestStorageServer
