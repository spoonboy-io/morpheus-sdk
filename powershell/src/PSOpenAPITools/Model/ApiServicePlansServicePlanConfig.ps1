...
ApiServicePlansServicePlanConfig<PSCustomObject>
#>

function Initialize-ApiServicePlansServicePlanConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlanConfig' | Write-Debug
...
Convert from JSON to ApiServicePlansServicePlanConfig<PSCustomObject>
...
ApiServicePlansServicePlanConfig<PSCustomObject>
#>
function ConvertFrom-JsonToApiServicePlansServicePlanConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlanConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiServicePlansServicePlanConfig
