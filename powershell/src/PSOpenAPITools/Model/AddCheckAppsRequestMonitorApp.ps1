...
AddCheckAppsRequestMonitorApp<PSCustomObject>
#>

function Initialize-AddCheckAppsRequestMonitorApp {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddCheckAppsRequestMonitorApp' | Write-Debug
...
Convert from JSON to AddCheckAppsRequestMonitorApp<PSCustomObject>
...
AddCheckAppsRequestMonitorApp<PSCustomObject>
#>
function ConvertFrom-JsonToAddCheckAppsRequestMonitorApp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddCheckAppsRequestMonitorApp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddCheckAppsRequestMonitorApp
