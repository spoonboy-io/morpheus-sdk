...
ApiScaleThresholdsScaleThreshold<PSCustomObject>
#>

function Initialize-ApiScaleThresholdsScaleThreshold {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiScaleThresholdsScaleThreshold' | Write-Debug
...
Convert from JSON to ApiScaleThresholdsScaleThreshold<PSCustomObject>
...
ApiScaleThresholdsScaleThreshold<PSCustomObject>
#>
function ConvertFrom-JsonToApiScaleThresholdsScaleThreshold {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiScaleThresholdsScaleThreshold' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiScaleThresholdsScaleThreshold
