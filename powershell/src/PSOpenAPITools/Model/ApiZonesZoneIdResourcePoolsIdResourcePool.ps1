...
ApiZonesZoneIdResourcePoolsIdResourcePool<PSCustomObject>
#>

function Initialize-ApiZonesZoneIdResourcePoolsIdResourcePool {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiZonesZoneIdResourcePoolsIdResourcePool' | Write-Debug
...
Convert from JSON to ApiZonesZoneIdResourcePoolsIdResourcePool<PSCustomObject>
...
ApiZonesZoneIdResourcePoolsIdResourcePool<PSCustomObject>
#>
function ConvertFrom-JsonToApiZonesZoneIdResourcePoolsIdResourcePool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiZonesZoneIdResourcePoolsIdResourcePool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiZonesZoneIdResourcePoolsIdResourcePool
        $AllProperties = ("active", "visibility", "displayName", "inventory", "tenantPermissions", "resourcePermissions")
