...
ApiExecuteSchedulesSchedule<PSCustomObject>
#>

function Initialize-ApiExecuteSchedulesSchedule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiExecuteSchedulesSchedule' | Write-Debug
...
Convert from JSON to ApiExecuteSchedulesSchedule<PSCustomObject>
...
ApiExecuteSchedulesSchedule<PSCustomObject>
#>
function ConvertFrom-JsonToApiExecuteSchedulesSchedule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiExecuteSchedulesSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiExecuteSchedulesSchedule
