...
.PARAMETER MinPerDiskSize
Custom min per disk size in GB
.PARAMETER MaxPerDiskSize
...
AddServicePlansRequestServicePlanConfigRanges<PSCustomObject>
#>

function Initialize-AddServicePlansRequestServicePlanConfigRanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlanConfigRanges' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "minPerDiskSize" = ${MinPerDiskSize}
            "maxPerDiskSize" = ${MaxPerDiskSize}
            "minMemory" = ${MinMemory}
            "maxMemory" = ${MaxMemory}
            "minCores" = ${MinCores}
            "maxCores" = ${MaxCores}
...
Convert from JSON to AddServicePlansRequestServicePlanConfigRanges<PSCustomObject>
...
AddServicePlansRequestServicePlanConfigRanges<PSCustomObject>
#>
function ConvertFrom-JsonToAddServicePlansRequestServicePlanConfigRanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlanConfigRanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddServicePlansRequestServicePlanConfigRanges
        $AllProperties = ("minStorage", "maxStorage", "minPerDiskSize", "maxPerDiskSize", "minMemory", "maxMemory", "minCores", "maxCores", "minSockets", "maxSockets", "minCoresPerSocket", "maxCoresPerSocket")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "minPerDiskSize"))) { #optional property not found
            $MinPerDiskSize = $null
        } else {
            $MinPerDiskSize = $JsonParameters.PSobject.Properties["minPerDiskSize"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "maxPerDiskSize"))) { #optional property not found
            $MaxPerDiskSize = $null
        } else {
            $MaxPerDiskSize = $JsonParameters.PSobject.Properties["maxPerDiskSize"].value
        }
