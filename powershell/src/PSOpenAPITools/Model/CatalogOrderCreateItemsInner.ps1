...
CatalogOrderCreateItemsInner<PSCustomObject>
#>

function Initialize-CatalogOrderCreateItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogOrderCreateItemsInner' | Write-Debug
...
Convert from JSON to CatalogOrderCreateItemsInner<PSCustomObject>
...
CatalogOrderCreateItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogOrderCreateItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogOrderCreateItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogOrderCreateItemsInner
