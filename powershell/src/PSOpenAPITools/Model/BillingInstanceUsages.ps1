...
BillingInstanceUsages<PSCustomObject>
#>

function Initialize-BillingInstanceUsages {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstanceUsages' | Write-Debug
...
Convert from JSON to BillingInstanceUsages<PSCustomObject>
...
BillingInstanceUsages<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstanceUsages {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstanceUsages' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstanceUsages
