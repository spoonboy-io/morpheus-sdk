...
function Initialize-Approvals {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Approvals' | Write-Debug
...
Convert from JSON to Approvals<PSCustomObject>
...
Approvals<PSCustomObject>
#>
function ConvertFrom-JsonToApprovals {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Approvals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approvals
        $AllProperties = ("id", "name", "internalId", "externalId", "externalName", "requestType", "account", "approver", "accountIntegration", "status", "errorMessage", "dateCreated", "lastUpdated", "requestBy")
