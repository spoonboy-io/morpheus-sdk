...
AddServicePlansRequestServicePlan<PSCustomObject>
#>

function Initialize-AddServicePlansRequestServicePlan {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlan' | Write-Debug
        ...
        if ($null -eq $MaxStorage) {
            throw "invalid value for 'MaxStorage', 'MaxStorage' cannot be null."
        }

        if ($null -eq $MaxMemory) {
            throw "invalid value for 'MaxMemory', 'MaxMemory' cannot be null."
        }

        if ($null -eq $ProvisionType) {
...
Convert from JSON to AddServicePlansRequestServicePlan<PSCustomObject>
...
AddServicePlansRequestServicePlan<PSCustomObject>
#>
function ConvertFrom-JsonToAddServicePlansRequestServicePlan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddServicePlansRequestServicePlan
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "maxStorage"))) {
            throw "Error! JSON cannot be serialized due to the required property 'maxStorage' missing."
        } else {
            $MaxStorage = $JsonParameters.PSobject.Properties["maxStorage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "maxMemory"))) {
            throw "Error! JSON cannot be serialized due to the required property 'maxMemory' missing."
        } else {
