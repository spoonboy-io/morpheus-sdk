...
BlueprintCFTCreateCloudFormationGit<PSCustomObject>
#>

function Initialize-BlueprintCFTCreateCloudFormationGit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlueprintCFTCreateCloudFormationGit' | Write-Debug
...
Convert from JSON to BlueprintCFTCreateCloudFormationGit<PSCustomObject>
...
BlueprintCFTCreateCloudFormationGit<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintCFTCreateCloudFormationGit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlueprintCFTCreateCloudFormationGit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlueprintCFTCreateCloudFormationGit
