...
No description available.
.PARAMETER ContainersCount
No description available.
.PARAMETER DeploymentsCount
No description available.
.PARAMETER PodsCount
No description available.
.PARAMETER JobsCount
...
function ConvertFrom-JsonToCluster {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "containersCount"))) { #optional property not found
            $ContainersCount = $null
        } else {
            $ContainersCount = $JsonParameters.PSobject.Properties["containersCount"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "deploymentsCount"))) { #optional property not found
            $DeploymentsCount = $null
        } else {
            $DeploymentsCount = $JsonParameters.PSobject.Properties["deploymentsCount"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "podsCount"))) { #optional property not found
            $PodsCount = $null
        } else {
            $PodsCount = $JsonParameters.PSobject.Properties["podsCount"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "jobsCount"))) { #optional property not found
            $JobsCount = $null
        } else {
            $JobsCount = $JsonParameters.PSobject.Properties["jobsCount"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "workersCount"))) { #optional property not found
            $WorkersCount = $null
        } else {
            $WorkersCount = $JsonParameters.PSobject.Properties["workersCount"].value
        }
