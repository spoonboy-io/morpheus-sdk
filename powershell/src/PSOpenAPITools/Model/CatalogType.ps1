...
CatalogType<PSCustomObject>
#>

function Initialize-CatalogType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogType' | Write-Debug
...
Convert from JSON to CatalogType<PSCustomObject>
...
CatalogType<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogType
        $AllProperties = ("id", "name", "description", "type", "context", "featured", "allowQuantity", "imagePath", "darkImagePath", "optionTypes")
