...
GuidanceVmwareSizingResourceVolumesInner<PSCustomObject>
#>

function Initialize-GuidanceVmwareSizingResourceVolumesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceVolumesInner' | Write-Debug
...
Convert from JSON to GuidanceVmwareSizingResourceVolumesInner<PSCustomObject>
...
GuidanceVmwareSizingResourceVolumesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceVmwareSizingResourceVolumesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceVolumesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceVmwareSizingResourceVolumesInner
