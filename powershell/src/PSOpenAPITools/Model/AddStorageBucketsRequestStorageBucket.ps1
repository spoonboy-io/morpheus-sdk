...
AddStorageBucketsRequestStorageBucket<PSCustomObject>
#>

function Initialize-AddStorageBucketsRequestStorageBucket {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddStorageBucketsRequestStorageBucket' | Write-Debug
        ...
        if ($null -eq $ProviderType) {
            throw "invalid value for 'ProviderType', 'ProviderType' cannot be null."
        }
...
Convert from JSON to AddStorageBucketsRequestStorageBucket<PSCustomObject>
...
AddStorageBucketsRequestStorageBucket<PSCustomObject>
#>
function ConvertFrom-JsonToAddStorageBucketsRequestStorageBucket {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddStorageBucketsRequestStorageBucket' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddStorageBucketsRequestStorageBucket
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "providerType"))) {
            throw "Error! JSON cannot be serialized due to the required property 'providerType' missing."
        } else {
