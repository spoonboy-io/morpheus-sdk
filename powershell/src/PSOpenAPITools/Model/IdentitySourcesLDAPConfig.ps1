...
IdentitySourcesLDAPConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesLDAPConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesLDAPConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesLDAPConfig<PSCustomObject>
...
IdentitySourcesLDAPConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesLDAPConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesLDAPConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesLDAPConfig
