...
CredentialUsernameKeypairConfig<PSCustomObject>
#>

function Initialize-CredentialUsernameKeypairConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("username-keypair")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CredentialUsernameKeypairConfig' | Write-Debug
...
Convert from JSON to CredentialUsernameKeypairConfig<PSCustomObject>
...
CredentialUsernameKeypairConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCredentialUsernameKeypairConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CredentialUsernameKeypairConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CredentialUsernameKeypairConfig
