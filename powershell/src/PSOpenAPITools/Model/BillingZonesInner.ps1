...
BillingZonesInner<PSCustomObject>
#>

function Initialize-BillingZonesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingZonesInner' | Write-Debug
...
Convert from JSON to BillingZonesInner<PSCustomObject>
...
BillingZonesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingZonesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingZonesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingZonesInner
