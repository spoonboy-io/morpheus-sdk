...
ClusterLayoutSpecTemplatesInner<PSCustomObject>
#>

function Initialize-ClusterLayoutSpecTemplatesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterLayoutSpecTemplatesInner' | Write-Debug
...
Convert from JSON to ClusterLayoutSpecTemplatesInner<PSCustomObject>
...
ClusterLayoutSpecTemplatesInner<PSCustomObject>
#>
function ConvertFrom-JsonToClusterLayoutSpecTemplatesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterLayoutSpecTemplatesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterLayoutSpecTemplatesInner
