...
CatalogItemTypeWorkflowUpdate<PSCustomObject>
#>

function Initialize-CatalogItemTypeWorkflowUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogItemTypeWorkflowUpdate' | Write-Debug
...
Convert from JSON to CatalogItemTypeWorkflowUpdate<PSCustomObject>
...
CatalogItemTypeWorkflowUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogItemTypeWorkflowUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogItemTypeWorkflowUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogItemTypeWorkflowUpdate
