...
AddServicePlansRequestServicePlanConfig<PSCustomObject>
#>

function Initialize-AddServicePlansRequestServicePlanConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlanConfig' | Write-Debug
...
Convert from JSON to AddServicePlansRequestServicePlanConfig<PSCustomObject>
...
AddServicePlansRequestServicePlanConfig<PSCustomObject>
#>
function ConvertFrom-JsonToAddServicePlansRequestServicePlanConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddServicePlansRequestServicePlanConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddServicePlansRequestServicePlanConfig
