...
ActivityActivity<PSCustomObject>
#>

function Initialize-ActivityActivity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityActivity' | Write-Debug
...
Convert from JSON to ActivityActivity<PSCustomObject>
...
ActivityActivity<PSCustomObject>
#>
function ConvertFrom-JsonToActivityActivity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityActivity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityActivity
