...
BillingServersApplicablePrices<PSCustomObject>
#>

function Initialize-BillingServersApplicablePrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersApplicablePrices' | Write-Debug
...
Convert from JSON to BillingServersApplicablePrices<PSCustomObject>
...
BillingServersApplicablePrices<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersApplicablePrices {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersApplicablePrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersApplicablePrices
