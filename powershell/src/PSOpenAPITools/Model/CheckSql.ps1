...
CheckSql<PSCustomObject>
#>

function Initialize-CheckSql {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CheckSql' | Write-Debug
...
Convert from JSON to CheckSql<PSCustomObject>
...
CheckSql<PSCustomObject>
#>
function ConvertFrom-JsonToCheckSql {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CheckSql' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CheckSql
