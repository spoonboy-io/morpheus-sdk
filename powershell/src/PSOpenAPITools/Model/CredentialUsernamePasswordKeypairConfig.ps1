...
CredentialUsernamePasswordKeypairConfig<PSCustomObject>
#>

function Initialize-CredentialUsernamePasswordKeypairConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("username-password-keypair")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CredentialUsernamePasswordKeypairConfig' | Write-Debug
...
Convert from JSON to CredentialUsernamePasswordKeypairConfig<PSCustomObject>
...
CredentialUsernamePasswordKeypairConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCredentialUsernamePasswordKeypairConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CredentialUsernamePasswordKeypairConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CredentialUsernamePasswordKeypairConfig
        $AllProperties = ("type", "name", "description", "enabled", "integration", "username", "password", "authKey")
