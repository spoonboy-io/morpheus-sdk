...
ApiContainersIdAttachFloatingIpConfig<PSCustomObject>
#>

function Initialize-ApiContainersIdAttachFloatingIpConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiContainersIdAttachFloatingIpConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if (!$OsExternalNetworkId) {
...
Convert from JSON to ApiContainersIdAttachFloatingIpConfig<PSCustomObject>
...
ApiContainersIdAttachFloatingIpConfig<PSCustomObject>
#>
function ConvertFrom-JsonToApiContainersIdAttachFloatingIpConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiContainersIdAttachFloatingIpConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiContainersIdAttachFloatingIpConfig
