...
function Initialize-AppState {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppState' | Write-Debug
...
Convert from JSON to AppState<PSCustomObject>
...
AppState<PSCustomObject>
#>
function ConvertFrom-JsonToAppState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppState
        $AllProperties = ("workloads", "iacDrift", "planResources", "specs", "stateData", "planData", "input", "output")
