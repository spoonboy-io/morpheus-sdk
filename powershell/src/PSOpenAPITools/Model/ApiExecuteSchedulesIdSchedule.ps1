...
ApiExecuteSchedulesIdSchedule<PSCustomObject>
#>

function Initialize-ApiExecuteSchedulesIdSchedule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiExecuteSchedulesIdSchedule' | Write-Debug
...
Convert from JSON to ApiExecuteSchedulesIdSchedule<PSCustomObject>
...
ApiExecuteSchedulesIdSchedule<PSCustomObject>
#>
function ConvertFrom-JsonToApiExecuteSchedulesIdSchedule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiExecuteSchedulesIdSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiExecuteSchedulesIdSchedule
