...
ApiStorageBucketsStorageBucket<PSCustomObject>
#>

function Initialize-ApiStorageBucketsStorageBucket {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiStorageBucketsStorageBucket' | Write-Debug
...
Convert from JSON to ApiStorageBucketsStorageBucket<PSCustomObject>
...
ApiStorageBucketsStorageBucket<PSCustomObject>
#>
function ConvertFrom-JsonToApiStorageBucketsStorageBucket {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiStorageBucketsStorageBucket' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiStorageBucketsStorageBucket
