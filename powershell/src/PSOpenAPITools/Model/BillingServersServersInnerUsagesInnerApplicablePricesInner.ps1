...
BillingServersServersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
#>

function Initialize-BillingServersServersInnerUsagesInnerApplicablePricesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInnerApplicablePricesInner' | Write-Debug
...
Convert from JSON to BillingServersServersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
...
BillingServersServersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersServersInnerUsagesInnerApplicablePricesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInnerApplicablePricesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersServersInnerUsagesInnerApplicablePricesInner
