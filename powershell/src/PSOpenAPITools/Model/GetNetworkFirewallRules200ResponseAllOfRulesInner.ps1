...
GetNetworkFirewallRules200ResponseAllOfRulesInner<PSCustomObject>
#>

function Initialize-GetNetworkFirewallRules200ResponseAllOfRulesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkFirewallRules200ResponseAllOfRulesInner' | Write-Debug
...
Convert from JSON to GetNetworkFirewallRules200ResponseAllOfRulesInner<PSCustomObject>
...
GetNetworkFirewallRules200ResponseAllOfRulesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkFirewallRules200ResponseAllOfRulesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkFirewallRules200ResponseAllOfRulesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkFirewallRules200ResponseAllOfRulesInner
