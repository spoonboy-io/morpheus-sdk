...
ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions<PSCustomObject>
#>

function Initialize-ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions' | Write-Debug
...
Convert from JSON to ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions<PSCustomObject>
...
ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions<PSCustomObject>
#>
function ConvertFrom-JsonToApiZonesZoneIdDataStoresIdDatastoreResourcePermissions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiZonesZoneIdDataStoresIdDatastoreResourcePermissions
