...
AddSecurityGroupsRequestSecurityGroup<PSCustomObject>
#>

function Initialize-AddSecurityGroupsRequestSecurityGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddSecurityGroupsRequestSecurityGroup' | Write-Debug
...
Convert from JSON to AddSecurityGroupsRequestSecurityGroup<PSCustomObject>
...
AddSecurityGroupsRequestSecurityGroup<PSCustomObject>
#>
function ConvertFrom-JsonToAddSecurityGroupsRequestSecurityGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddSecurityGroupsRequestSecurityGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddSecurityGroupsRequestSecurityGroup
