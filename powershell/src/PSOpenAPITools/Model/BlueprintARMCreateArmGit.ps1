...
BlueprintARMCreateArmGit<PSCustomObject>
#>

function Initialize-BlueprintARMCreateArmGit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlueprintARMCreateArmGit' | Write-Debug
...
Convert from JSON to BlueprintARMCreateArmGit<PSCustomObject>
...
BlueprintARMCreateArmGit<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintARMCreateArmGit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlueprintARMCreateArmGit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlueprintARMCreateArmGit
