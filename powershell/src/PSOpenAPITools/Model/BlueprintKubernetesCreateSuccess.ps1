...
BlueprintKubernetesCreateSuccess<PSCustomObject>
#>

function Initialize-BlueprintKubernetesCreateSuccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlueprintKubernetesCreateSuccess' | Write-Debug
...
Convert from JSON to BlueprintKubernetesCreateSuccess<PSCustomObject>
...
BlueprintKubernetesCreateSuccess<PSCustomObject>
#>
function ConvertFrom-JsonToBlueprintKubernetesCreateSuccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlueprintKubernetesCreateSuccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlueprintKubernetesCreateSuccess
        $AllProperties = ("name", "image", "type", "kubernetes", "config", "visibility", "resourcePermission", "owner", "tenant")
