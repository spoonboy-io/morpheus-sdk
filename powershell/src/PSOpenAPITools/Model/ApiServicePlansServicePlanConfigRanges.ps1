...
ApiServicePlansServicePlanConfigRanges<PSCustomObject>
#>

function Initialize-ApiServicePlansServicePlanConfigRanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlanConfigRanges' | Write-Debug
...
Convert from JSON to ApiServicePlansServicePlanConfigRanges<PSCustomObject>
...
ApiServicePlansServicePlanConfigRanges<PSCustomObject>
#>
function ConvertFrom-JsonToApiServicePlansServicePlanConfigRanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlanConfigRanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiServicePlansServicePlanConfigRanges
