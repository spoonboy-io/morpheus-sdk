...
AddTasksRequestTask<PSCustomObject>
#>

function Initialize-AddTasksRequestTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddTasksRequestTask' | Write-Debug
...
Convert from JSON to AddTasksRequestTask<PSCustomObject>
...
AddTasksRequestTask<PSCustomObject>
#>
function ConvertFrom-JsonToAddTasksRequestTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddTasksRequestTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddTasksRequestTask
