...
ContainerType<PSCustomObject>
#>

function Initialize-ContainerType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContainerType' | Write-Debug
...
Convert from JSON to ContainerType<PSCustomObject>
...
ContainerType<PSCustomObject>
#>
function ConvertFrom-JsonToContainerType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContainerType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContainerType
