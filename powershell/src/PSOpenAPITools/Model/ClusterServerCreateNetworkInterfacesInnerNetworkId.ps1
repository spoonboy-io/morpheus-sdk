...
ClusterServerCreateNetworkInterfacesInnerNetworkId<PSCustomObject>
#>
function ConvertFrom-JsonToClusterServerCreateNetworkInterfacesInnerNetworkId {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Int32' defined in oneOf (ClusterServerCreateNetworkInterfacesInnerNetworkId). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (ClusterServerCreateNetworkInterfacesInnerNetworkId). Proceeding to the next one if any."
        }
