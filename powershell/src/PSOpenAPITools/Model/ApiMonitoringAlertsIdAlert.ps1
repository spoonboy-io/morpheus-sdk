...
ApiMonitoringAlertsIdAlert<PSCustomObject>
#>

function Initialize-ApiMonitoringAlertsIdAlert {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiMonitoringAlertsIdAlert' | Write-Debug
...
Convert from JSON to ApiMonitoringAlertsIdAlert<PSCustomObject>
...
ApiMonitoringAlertsIdAlert<PSCustomObject>
#>
function ConvertFrom-JsonToApiMonitoringAlertsIdAlert {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiMonitoringAlertsIdAlert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiMonitoringAlertsIdAlert
