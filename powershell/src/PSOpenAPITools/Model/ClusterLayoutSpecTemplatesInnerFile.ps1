...
ClusterLayoutSpecTemplatesInnerFile<PSCustomObject>
#>

function Initialize-ClusterLayoutSpecTemplatesInnerFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterLayoutSpecTemplatesInnerFile' | Write-Debug
...
Convert from JSON to ClusterLayoutSpecTemplatesInnerFile<PSCustomObject>
...
ClusterLayoutSpecTemplatesInnerFile<PSCustomObject>
#>
function ConvertFrom-JsonToClusterLayoutSpecTemplatesInnerFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterLayoutSpecTemplatesInnerFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterLayoutSpecTemplatesInnerFile
