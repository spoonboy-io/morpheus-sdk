...
AddBlueprint200Response<PSCustomObject>
#>

function Initialize-AddBlueprint200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddBlueprint200Response' | Write-Debug
...
Convert from JSON to AddBlueprint200Response<PSCustomObject>
...
AddBlueprint200Response<PSCustomObject>
#>
function ConvertFrom-JsonToAddBlueprint200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddBlueprint200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddBlueprint200Response
        $AllProperties = ("blueprint", "msg", "errors", "errorCode", "inProgress", "success")
