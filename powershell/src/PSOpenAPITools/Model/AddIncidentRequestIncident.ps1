...
AddIncidentRequestIncident<PSCustomObject>
#>

function Initialize-AddIncidentRequestIncident {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddIncidentRequestIncident' | Write-Debug
...
Convert from JSON to AddIncidentRequestIncident<PSCustomObject>
...
AddIncidentRequestIncident<PSCustomObject>
#>
function ConvertFrom-JsonToAddIncidentRequestIncident {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddIncidentRequestIncident' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddIncidentRequestIncident
