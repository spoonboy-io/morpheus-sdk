...
ApiMonitoringGroupsIdCheckGroup<PSCustomObject>
#>

function Initialize-ApiMonitoringGroupsIdCheckGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiMonitoringGroupsIdCheckGroup' | Write-Debug
...
Convert from JSON to ApiMonitoringGroupsIdCheckGroup<PSCustomObject>
...
ApiMonitoringGroupsIdCheckGroup<PSCustomObject>
#>
function ConvertFrom-JsonToApiMonitoringGroupsIdCheckGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiMonitoringGroupsIdCheckGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiMonitoringGroupsIdCheckGroup
