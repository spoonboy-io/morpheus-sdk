...
ClusterNamespaceCreateResourcePermissions<PSCustomObject>
#>

function Initialize-ClusterNamespaceCreateResourcePermissions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterNamespaceCreateResourcePermissions' | Write-Debug
...
Convert from JSON to ClusterNamespaceCreateResourcePermissions<PSCustomObject>
...
ClusterNamespaceCreateResourcePermissions<PSCustomObject>
#>
function ConvertFrom-JsonToClusterNamespaceCreateResourcePermissions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterNamespaceCreateResourcePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterNamespaceCreateResourcePermissions
