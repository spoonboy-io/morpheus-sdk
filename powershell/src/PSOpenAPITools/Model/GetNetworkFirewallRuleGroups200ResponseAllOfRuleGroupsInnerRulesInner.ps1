...
GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner<PSCustomObject>
#>

function Initialize-GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner' | Write-Debug
...
Convert from JSON to GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner<PSCustomObject>
...
GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkFirewallRuleGroups200ResponseAllOfRuleGroupsInnerRulesInner
