...
CredentialAccessSecretKeyConfig<PSCustomObject>
#>

function Initialize-CredentialAccessSecretKeyConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("access-key-secret")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CredentialAccessSecretKeyConfig' | Write-Debug
...
Convert from JSON to CredentialAccessSecretKeyConfig<PSCustomObject>
...
CredentialAccessSecretKeyConfig<PSCustomObject>
#>
function ConvertFrom-JsonToCredentialAccessSecretKeyConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CredentialAccessSecretKeyConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CredentialAccessSecretKeyConfig
