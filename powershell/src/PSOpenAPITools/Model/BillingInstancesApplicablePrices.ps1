...
BillingInstancesApplicablePrices<PSCustomObject>
#>

function Initialize-BillingInstancesApplicablePrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesApplicablePrices' | Write-Debug
...
Convert from JSON to BillingInstancesApplicablePrices<PSCustomObject>
...
BillingInstancesApplicablePrices<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesApplicablePrices {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesApplicablePrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesApplicablePrices
