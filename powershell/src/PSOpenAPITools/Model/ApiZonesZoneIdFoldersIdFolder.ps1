...
ApiZonesZoneIdFoldersIdFolder<PSCustomObject>
#>

function Initialize-ApiZonesZoneIdFoldersIdFolder {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiZonesZoneIdFoldersIdFolder' | Write-Debug
...
Convert from JSON to ApiZonesZoneIdFoldersIdFolder<PSCustomObject>
...
ApiZonesZoneIdFoldersIdFolder<PSCustomObject>
#>
function ConvertFrom-JsonToApiZonesZoneIdFoldersIdFolder {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiZonesZoneIdFoldersIdFolder' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiZonesZoneIdFoldersIdFolder
        $AllProperties = ("defaultFolder", "defaultImage", "active", "visibility", "tenantPermissions", "resourcePermissions")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "defaultFolder"))) { #optional property not found
            $DefaultFolder = $null
        } else {
            $DefaultFolder = $JsonParameters.PSobject.Properties["defaultFolder"].value
        }
