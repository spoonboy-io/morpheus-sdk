...
BillingServersPrices<PSCustomObject>
#>

function Initialize-BillingServersPrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersPrices' | Write-Debug
...
Convert from JSON to BillingServersPrices<PSCustomObject>
...
BillingServersPrices<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersPrices {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersPrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersPrices
