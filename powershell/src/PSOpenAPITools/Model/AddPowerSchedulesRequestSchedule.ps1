...
AddPowerSchedulesRequestSchedule<PSCustomObject>
#>

function Initialize-AddPowerSchedulesRequestSchedule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddPowerSchedulesRequestSchedule' | Write-Debug
...
Convert from JSON to AddPowerSchedulesRequestSchedule<PSCustomObject>
...
AddPowerSchedulesRequestSchedule<PSCustomObject>
#>
function ConvertFrom-JsonToAddPowerSchedulesRequestSchedule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddPowerSchedulesRequestSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddPowerSchedulesRequestSchedule
