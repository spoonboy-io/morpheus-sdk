...
GetNetworkTransportZones200ResponseAllOfNetworkScopesInner<PSCustomObject>
#>

function Initialize-GetNetworkTransportZones200ResponseAllOfNetworkScopesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkTransportZones200ResponseAllOfNetworkScopesInner' | Write-Debug
...
Convert from JSON to GetNetworkTransportZones200ResponseAllOfNetworkScopesInner<PSCustomObject>
...
GetNetworkTransportZones200ResponseAllOfNetworkScopesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkTransportZones200ResponseAllOfNetworkScopesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkTransportZones200ResponseAllOfNetworkScopesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkTransportZones200ResponseAllOfNetworkScopesInner
        $AllProperties = ("id", "internalId", "visibility", "dateCreated", "providerId", "lastUpdated", "active", "streamType", "displayName", "name", "status", "enabled", "externalId", "config", "owner", "networkServer", "zone", "tenants")
