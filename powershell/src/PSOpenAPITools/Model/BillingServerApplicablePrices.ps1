...
BillingServerApplicablePrices<PSCustomObject>
#>

function Initialize-BillingServerApplicablePrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServerApplicablePrices' | Write-Debug
...
Convert from JSON to BillingServerApplicablePrices<PSCustomObject>
...
BillingServerApplicablePrices<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServerApplicablePrices {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServerApplicablePrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServerApplicablePrices
