...
BillingServersServers<PSCustomObject>
#>

function Initialize-BillingServersServers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersServers' | Write-Debug
...
Convert from JSON to BillingServersServers<PSCustomObject>
...
BillingServersServers<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersServers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersServers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersServers
