...
function Initialize-Deployment {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Deployment' | Write-Debug
...
Convert from JSON to Deployment<PSCustomObject>
...
Deployment<PSCustomObject>
#>
function ConvertFrom-JsonToDeployment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Deployment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Deployment
        $AllProperties = ("id", "name", "description", "accountId", "externalId", "dateCreated", "lastUpdated", "versionCount", "versions")
