...
GetNetworkRouters200ResponseNetworkRoutersInner<PSCustomObject>
#>

function Initialize-GetNetworkRouters200ResponseNetworkRoutersInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkRouters200ResponseNetworkRoutersInner' | Write-Debug
...
Convert from JSON to GetNetworkRouters200ResponseNetworkRoutersInner<PSCustomObject>
...
GetNetworkRouters200ResponseNetworkRoutersInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkRouters200ResponseNetworkRoutersInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkRouters200ResponseNetworkRoutersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkRouters200ResponseNetworkRoutersInner
        $AllProperties = ("id", "code", "name", "description", "category", "dateCreated", "lastUpdated", "routerType", "status", "enabled", "externalIp", "externalId", "providerId", "type", "networkServer", "zone", "instance", "externalNetwork", "site", "interfaces")
