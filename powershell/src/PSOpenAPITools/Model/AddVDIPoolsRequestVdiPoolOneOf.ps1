...
AddVDIPoolsRequestVdiPoolOneOf<PSCustomObject>
#>

function Initialize-AddVDIPoolsRequestVdiPoolOneOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddVDIPoolsRequestVdiPoolOneOf' | Write-Debug
        ...
        if ($null -eq $InstanceConfig) {
            throw "invalid value for 'InstanceConfig', 'InstanceConfig' cannot be null."
        }
...
Convert from JSON to AddVDIPoolsRequestVdiPoolOneOf<PSCustomObject>
...
AddVDIPoolsRequestVdiPoolOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToAddVDIPoolsRequestVdiPoolOneOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddVDIPoolsRequestVdiPoolOneOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddVDIPoolsRequestVdiPoolOneOf
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "instanceConfig"))) {
            throw "Error! JSON cannot be serialized due to the required property 'instanceConfig' missing."
        } else {
