...
GuidanceAzureReservationsConfigDetailList<PSCustomObject>
#>

function Initialize-GuidanceAzureReservationsConfigDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceAzureReservationsConfigDetailList' | Write-Debug
...
Convert from JSON to GuidanceAzureReservationsConfigDetailList<PSCustomObject>
...
GuidanceAzureReservationsConfigDetailList<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceAzureReservationsConfigDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceAzureReservationsConfigDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceAzureReservationsConfigDetailList
