...
IdentitySourcesAzureADConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesAzureADConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesAzureADConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesAzureADConfig<PSCustomObject>
...
IdentitySourcesAzureADConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesAzureADConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesAzureADConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesAzureADConfig
