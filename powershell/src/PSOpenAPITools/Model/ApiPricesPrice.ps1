...
ApiPricesPrice<PSCustomObject>
#>

function Initialize-ApiPricesPrice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiPricesPrice' | Write-Debug
...
Convert from JSON to ApiPricesPrice<PSCustomObject>
...
ApiPricesPrice<PSCustomObject>
#>
function ConvertFrom-JsonToApiPricesPrice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiPricesPrice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiPricesPrice
