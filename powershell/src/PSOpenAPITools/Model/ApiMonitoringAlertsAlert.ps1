...
ApiMonitoringAlertsAlert<PSCustomObject>
#>

function Initialize-ApiMonitoringAlertsAlert {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiMonitoringAlertsAlert' | Write-Debug
...
Convert from JSON to ApiMonitoringAlertsAlert<PSCustomObject>
...
ApiMonitoringAlertsAlert<PSCustomObject>
#>
function ConvertFrom-JsonToApiMonitoringAlertsAlert {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiMonitoringAlertsAlert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiMonitoringAlertsAlert
