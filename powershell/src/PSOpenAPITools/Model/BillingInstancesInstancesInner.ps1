...
BillingInstancesInstancesInner<PSCustomObject>
#>

function Initialize-BillingInstancesInstancesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInner' | Write-Debug
...
Convert from JSON to BillingInstancesInstancesInner<PSCustomObject>
...
BillingInstancesInstancesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesInstancesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesInstancesInner
