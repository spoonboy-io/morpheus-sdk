...
ClusterMasters<PSCustomObject>
#>

function Initialize-ClusterMasters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterMasters' | Write-Debug
...
Convert from JSON to ClusterMasters<PSCustomObject>
...
ClusterMasters<PSCustomObject>
#>
function ConvertFrom-JsonToClusterMasters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterMasters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterMasters
