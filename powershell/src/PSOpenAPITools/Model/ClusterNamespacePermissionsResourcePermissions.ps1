...
ClusterNamespacePermissionsResourcePermissions<PSCustomObject>
#>

function Initialize-ClusterNamespacePermissionsResourcePermissions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterNamespacePermissionsResourcePermissions' | Write-Debug
...
Convert from JSON to ClusterNamespacePermissionsResourcePermissions<PSCustomObject>
...
ClusterNamespacePermissionsResourcePermissions<PSCustomObject>
#>
function ConvertFrom-JsonToClusterNamespacePermissionsResourcePermissions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterNamespacePermissionsResourcePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterNamespacePermissionsResourcePermissions
