...
ClusterStatefulSets<PSCustomObject>
#>

function Initialize-ClusterStatefulSets {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterStatefulSets' | Write-Debug
...
Convert from JSON to ClusterStatefulSets<PSCustomObject>
...
ClusterStatefulSets<PSCustomObject>
#>
function ConvertFrom-JsonToClusterStatefulSets {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterStatefulSets' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterStatefulSets
