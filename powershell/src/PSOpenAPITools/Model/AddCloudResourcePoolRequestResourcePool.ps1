...
AddCloudResourcePoolRequestResourcePool<PSCustomObject>
#>

function Initialize-AddCloudResourcePoolRequestResourcePool {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddCloudResourcePoolRequestResourcePool' | Write-Debug
...
Convert from JSON to AddCloudResourcePoolRequestResourcePool<PSCustomObject>
...
AddCloudResourcePoolRequestResourcePool<PSCustomObject>
#>
function ConvertFrom-JsonToAddCloudResourcePoolRequestResourcePool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddCloudResourcePoolRequestResourcePool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddCloudResourcePoolRequestResourcePool
