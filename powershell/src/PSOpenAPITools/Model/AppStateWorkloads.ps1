...
AppStateWorkloads<PSCustomObject>
#>

function Initialize-AppStateWorkloads {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppStateWorkloads' | Write-Debug
...
Convert from JSON to AppStateWorkloads<PSCustomObject>
...
AppStateWorkloads<PSCustomObject>
#>
function ConvertFrom-JsonToAppStateWorkloads {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppStateWorkloads' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppStateWorkloads
