...
ClusterHistoryEventsInner<PSCustomObject>
#>

function Initialize-ClusterHistoryEventsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterHistoryEventsInner' | Write-Debug
...
Convert from JSON to ClusterHistoryEventsInner<PSCustomObject>
...
ClusterHistoryEventsInner<PSCustomObject>
#>
function ConvertFrom-JsonToClusterHistoryEventsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterHistoryEventsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterHistoryEventsInner
