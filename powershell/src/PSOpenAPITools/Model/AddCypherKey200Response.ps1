...
AddCypherKey200Response<PSCustomObject>
#>

function Initialize-AddCypherKey200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddCypherKey200Response' | Write-Debug
...
Convert from JSON to AddCypherKey200Response<PSCustomObject>
...
AddCypherKey200Response<PSCustomObject>
#>
function ConvertFrom-JsonToAddCypherKey200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddCypherKey200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddCypherKey200Response
        $AllProperties = ("data", "type", "lease_duration", "cypher", "success")
