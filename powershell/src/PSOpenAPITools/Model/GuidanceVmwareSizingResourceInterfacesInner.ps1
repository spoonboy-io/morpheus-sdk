...
GuidanceVmwareSizingResourceInterfacesInner<PSCustomObject>
#>

function Initialize-GuidanceVmwareSizingResourceInterfacesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceInterfacesInner' | Write-Debug
...
Convert from JSON to GuidanceVmwareSizingResourceInterfacesInner<PSCustomObject>
...
GuidanceVmwareSizingResourceInterfacesInner<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceVmwareSizingResourceInterfacesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceInterfacesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceVmwareSizingResourceInterfacesInner
