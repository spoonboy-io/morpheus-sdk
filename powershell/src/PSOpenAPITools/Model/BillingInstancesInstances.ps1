...
BillingInstancesInstances<PSCustomObject>
#>

function Initialize-BillingInstancesInstances {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesInstances' | Write-Debug
...
Convert from JSON to BillingInstancesInstances<PSCustomObject>
...
BillingInstancesInstances<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesInstances {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesInstances' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesInstances
