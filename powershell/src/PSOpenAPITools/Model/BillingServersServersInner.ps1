...
BillingServersServersInner<PSCustomObject>
#>

function Initialize-BillingServersServersInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersServersInner' | Write-Debug
...
Convert from JSON to BillingServersServersInner<PSCustomObject>
...
BillingServersServersInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersServersInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersServersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersServersInner
        $AllProperties = ("refType", "refUUID", "refId", "startDate", "endDate", "cost", "price", "numUnits", "unit", "currency", "usages", "numUsages", "totalUsages", "hasMoreUsages", "foundPricing", "name", "serverUUID", "serverUniqueId", "serverExternalId", "serverInternalId", "resourcePoolId", "resourcePoolName")
