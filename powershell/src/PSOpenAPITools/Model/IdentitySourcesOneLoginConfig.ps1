...
IdentitySourcesOneLoginConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesOneLoginConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesOneLoginConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesOneLoginConfig<PSCustomObject>
...
IdentitySourcesOneLoginConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesOneLoginConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesOneLoginConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesOneLoginConfig
