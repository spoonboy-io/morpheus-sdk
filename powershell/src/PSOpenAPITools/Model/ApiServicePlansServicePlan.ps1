...
ApiServicePlansServicePlan<PSCustomObject>
#>

function Initialize-ApiServicePlansServicePlan {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlan' | Write-Debug
...
Convert from JSON to ApiServicePlansServicePlan<PSCustomObject>
...
ApiServicePlansServicePlan<PSCustomObject>
#>
function ConvertFrom-JsonToApiServicePlansServicePlan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiServicePlansServicePlan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiServicePlansServicePlan
