...
ImageBuildConfigVolumes<PSCustomObject>
#>

function Initialize-ImageBuildConfigVolumes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ImageBuildConfigVolumes' | Write-Debug
...
Convert from JSON to ImageBuildConfigVolumes<PSCustomObject>
...
ImageBuildConfigVolumes<PSCustomObject>
#>
function ConvertFrom-JsonToImageBuildConfigVolumes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ImageBuildConfigVolumes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ImageBuildConfigVolumes
