...
BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
#>

function Initialize-BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner' | Write-Debug
...
Convert from JSON to BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
...
BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner
