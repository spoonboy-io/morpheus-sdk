...
ClusterHistoryEvents<PSCustomObject>
#>

function Initialize-ClusterHistoryEvents {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterHistoryEvents' | Write-Debug
...
Convert from JSON to ClusterHistoryEvents<PSCustomObject>
...
ClusterHistoryEvents<PSCustomObject>
#>
function ConvertFrom-JsonToClusterHistoryEvents {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterHistoryEvents' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterHistoryEvents
