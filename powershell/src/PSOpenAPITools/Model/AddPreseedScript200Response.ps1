...
AddPreseedScript200Response<PSCustomObject>
#>

function Initialize-AddPreseedScript200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddPreseedScript200Response' | Write-Debug
...
Convert from JSON to AddPreseedScript200Response<PSCustomObject>
...
AddPreseedScript200Response<PSCustomObject>
#>
function ConvertFrom-JsonToAddPreseedScript200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddPreseedScript200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddPreseedScript200Response
        $AllProperties = ("preseedScript", "errorCode", "success", "msg", "errors")
