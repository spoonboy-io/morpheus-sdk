...
ClusterLayoutContainerType<PSCustomObject>
#>

function Initialize-ClusterLayoutContainerType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterLayoutContainerType' | Write-Debug
...
Convert from JSON to ClusterLayoutContainerType<PSCustomObject>
...
ClusterLayoutContainerType<PSCustomObject>
#>
function ConvertFrom-JsonToClusterLayoutContainerType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterLayoutContainerType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterLayoutContainerType
