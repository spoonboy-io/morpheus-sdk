...
ApiMonitoringAppsIdMonitorApp<PSCustomObject>
#>

function Initialize-ApiMonitoringAppsIdMonitorApp {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiMonitoringAppsIdMonitorApp' | Write-Debug
...
Convert from JSON to ApiMonitoringAppsIdMonitorApp<PSCustomObject>
...
ApiMonitoringAppsIdMonitorApp<PSCustomObject>
#>
function ConvertFrom-JsonToApiMonitoringAppsIdMonitorApp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiMonitoringAppsIdMonitorApp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiMonitoringAppsIdMonitorApp
