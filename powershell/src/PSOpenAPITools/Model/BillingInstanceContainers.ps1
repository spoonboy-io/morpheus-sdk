...
BillingInstanceContainers<PSCustomObject>
#>

function Initialize-BillingInstanceContainers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstanceContainers' | Write-Debug
...
Convert from JSON to BillingInstanceContainers<PSCustomObject>
...
BillingInstanceContainers<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstanceContainers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstanceContainers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstanceContainers
