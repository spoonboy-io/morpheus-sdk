...
GuidanceAzureReservations<PSCustomObject>
#>

function Initialize-GuidanceAzureReservations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceAzureReservations' | Write-Debug
...
Convert from JSON to GuidanceAzureReservations<PSCustomObject>
...
GuidanceAzureReservations<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceAzureReservations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceAzureReservations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceAzureReservations
        $AllProperties = ("id", "dateCreated", "lastUpdated", "actionCategory", "actionMessage", "actionTitle", "actionType", "actionValue", "actionValueType", "actionPlanId", "statusMessage", "accountId", "userId", "siteId", "zone", "state", "stateMessage", "severity", "resolved", "resolvedMessage", "refType", "refId", "refName", "type", "savings", "config")
