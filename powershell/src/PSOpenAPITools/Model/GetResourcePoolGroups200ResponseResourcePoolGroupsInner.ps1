...
GetResourcePoolGroups200ResponseResourcePoolGroupsInner<PSCustomObject>
#>

function Initialize-GetResourcePoolGroups200ResponseResourcePoolGroupsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetResourcePoolGroups200ResponseResourcePoolGroupsInner' | Write-Debug
...
Convert from JSON to GetResourcePoolGroups200ResponseResourcePoolGroupsInner<PSCustomObject>
...
GetResourcePoolGroups200ResponseResourcePoolGroupsInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetResourcePoolGroups200ResponseResourcePoolGroupsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetResourcePoolGroups200ResponseResourcePoolGroupsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetResourcePoolGroups200ResponseResourcePoolGroupsInner
