...
BillingInstancesPricesUsed<PSCustomObject>
#>

function Initialize-BillingInstancesPricesUsed {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesPricesUsed' | Write-Debug
...
Convert from JSON to BillingInstancesPricesUsed<PSCustomObject>
...
BillingInstancesPricesUsed<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesPricesUsed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesPricesUsed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesPricesUsed
