...
BillingInstancesInstancesInnerContainersInner<PSCustomObject>
#>

function Initialize-BillingInstancesInstancesInnerContainersInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInnerContainersInner' | Write-Debug
...
Convert from JSON to BillingInstancesInstancesInnerContainersInner<PSCustomObject>
...
BillingInstancesInstancesInnerContainersInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesInstancesInnerContainersInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInnerContainersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesInstancesInnerContainersInner
