...
BillingInstanceContainersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
#>

function Initialize-BillingInstanceContainersInnerUsagesInnerApplicablePricesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstanceContainersInnerUsagesInnerApplicablePricesInner' | Write-Debug
...
Convert from JSON to BillingInstanceContainersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
...
BillingInstanceContainersInnerUsagesInnerApplicablePricesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstanceContainersInnerUsagesInnerApplicablePricesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstanceContainersInnerUsagesInnerApplicablePricesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstanceContainersInnerUsagesInnerApplicablePricesInner
