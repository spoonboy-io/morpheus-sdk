...
BillingInstancesInstancesInnerContainersInnerUsagesInner<PSCustomObject>
#>

function Initialize-BillingInstancesInstancesInnerContainersInnerUsagesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInnerContainersInnerUsagesInner' | Write-Debug
...
Convert from JSON to BillingInstancesInstancesInnerContainersInnerUsagesInner<PSCustomObject>
...
BillingInstancesInstancesInnerContainersInnerUsagesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesInstancesInnerContainersInnerUsagesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesInstancesInnerContainersInnerUsagesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesInstancesInnerContainersInnerUsagesInner
