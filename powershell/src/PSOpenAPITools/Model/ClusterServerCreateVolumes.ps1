...
ClusterServerCreateVolumes<PSCustomObject>
#>

function Initialize-ClusterServerCreateVolumes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterServerCreateVolumes' | Write-Debug
...
Convert from JSON to ClusterServerCreateVolumes<PSCustomObject>
...
ClusterServerCreateVolumes<PSCustomObject>
#>
function ConvertFrom-JsonToClusterServerCreateVolumes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterServerCreateVolumes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterServerCreateVolumes
