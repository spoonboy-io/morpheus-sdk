...
BillingZone<PSCustomObject>
#>

function Initialize-BillingZone {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingZone' | Write-Debug
...
Convert from JSON to BillingZone<PSCustomObject>
...
BillingZone<PSCustomObject>
#>
function ConvertFrom-JsonToBillingZone {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingZone' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingZone
