...
ClusterContainers<PSCustomObject>
#>

function Initialize-ClusterContainers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterContainers' | Write-Debug
...
Convert from JSON to ClusterContainers<PSCustomObject>
...
ClusterContainers<PSCustomObject>
#>
function ConvertFrom-JsonToClusterContainers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterContainers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterContainers
