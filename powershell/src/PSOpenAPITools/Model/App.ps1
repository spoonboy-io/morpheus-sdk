...
function Initialize-App {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => App' | Write-Debug
...
function ConvertFrom-JsonToApp {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => App' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in App
        $AllProperties = ("id", "name", "description", "labels", "environment", "accountId", "account", "owner", "siteId", "group", "blueprint", "type", "dateCreated", "lastUpdated", "removalDate", "appContext", "status", "appStatus", "instanceCount", "containerCount", "appTiers", "instances", "stats")
