...
GetNetworkProxy200ResponseNetworkProxy<PSCustomObject>
#>

function Initialize-GetNetworkProxy200ResponseNetworkProxy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetNetworkProxy200ResponseNetworkProxy' | Write-Debug
...
Convert from JSON to GetNetworkProxy200ResponseNetworkProxy<PSCustomObject>
...
GetNetworkProxy200ResponseNetworkProxy<PSCustomObject>
#>
function ConvertFrom-JsonToGetNetworkProxy200ResponseNetworkProxy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetNetworkProxy200ResponseNetworkProxy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetNetworkProxy200ResponseNetworkProxy
