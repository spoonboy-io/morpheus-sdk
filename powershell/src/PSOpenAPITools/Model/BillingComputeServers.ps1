...
BillingComputeServers<PSCustomObject>
#>

function Initialize-BillingComputeServers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingComputeServers' | Write-Debug
...
Convert from JSON to BillingComputeServers<PSCustomObject>
...
BillingComputeServers<PSCustomObject>
#>
function ConvertFrom-JsonToBillingComputeServers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingComputeServers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingComputeServers
