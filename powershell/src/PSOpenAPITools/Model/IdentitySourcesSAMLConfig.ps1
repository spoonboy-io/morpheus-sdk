...
IdentitySourcesSAMLConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesSAMLConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesSAMLConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesSAMLConfig<PSCustomObject>
...
IdentitySourcesSAMLConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesSAMLConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesSAMLConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesSAMLConfig
