...
IdentitySourcesADConfig<PSCustomObject>
#>

function Initialize-IdentitySourcesADConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentitySourcesADConfig' | Write-Debug
...
Convert from JSON to IdentitySourcesADConfig<PSCustomObject>
...
IdentitySourcesADConfig<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitySourcesADConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentitySourcesADConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentitySourcesADConfig
