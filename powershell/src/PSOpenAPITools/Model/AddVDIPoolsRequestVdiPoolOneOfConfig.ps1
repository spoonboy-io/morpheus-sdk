...
AddVDIPoolsRequestVdiPoolOneOfConfig<PSCustomObject>
#>

function Initialize-AddVDIPoolsRequestVdiPoolOneOfConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddVDIPoolsRequestVdiPoolOneOfConfig' | Write-Debug
...
Convert from JSON to AddVDIPoolsRequestVdiPoolOneOfConfig<PSCustomObject>
...
AddVDIPoolsRequestVdiPoolOneOfConfig<PSCustomObject>
#>
function ConvertFrom-JsonToAddVDIPoolsRequestVdiPoolOneOfConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddVDIPoolsRequestVdiPoolOneOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddVDIPoolsRequestVdiPoolOneOfConfig
