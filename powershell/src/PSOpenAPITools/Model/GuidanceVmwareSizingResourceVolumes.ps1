...
GuidanceVmwareSizingResourceVolumes<PSCustomObject>
#>

function Initialize-GuidanceVmwareSizingResourceVolumes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceVolumes' | Write-Debug
...
Convert from JSON to GuidanceVmwareSizingResourceVolumes<PSCustomObject>
...
GuidanceVmwareSizingResourceVolumes<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceVmwareSizingResourceVolumes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceVolumes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceVmwareSizingResourceVolumes
