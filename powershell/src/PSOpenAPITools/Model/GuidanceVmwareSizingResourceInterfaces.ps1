...
GuidanceVmwareSizingResourceInterfaces<PSCustomObject>
#>

function Initialize-GuidanceVmwareSizingResourceInterfaces {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceInterfaces' | Write-Debug
...
Convert from JSON to GuidanceVmwareSizingResourceInterfaces<PSCustomObject>
...
GuidanceVmwareSizingResourceInterfaces<PSCustomObject>
#>
function ConvertFrom-JsonToGuidanceVmwareSizingResourceInterfaces {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuidanceVmwareSizingResourceInterfaces' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuidanceVmwareSizingResourceInterfaces
