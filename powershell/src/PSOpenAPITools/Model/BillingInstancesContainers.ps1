...
BillingInstancesContainers<PSCustomObject>
#>

function Initialize-BillingInstancesContainers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInstancesContainers' | Write-Debug
...
Convert from JSON to BillingInstancesContainers<PSCustomObject>
...
BillingInstancesContainers<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInstancesContainers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInstancesContainers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInstancesContainers
