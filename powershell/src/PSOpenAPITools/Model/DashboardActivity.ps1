...
DashboardActivity<PSCustomObject>
#>

function Initialize-DashboardActivity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DashboardActivity' | Write-Debug
...
Convert from JSON to DashboardActivity<PSCustomObject>
...
DashboardActivity<PSCustomObject>
#>
function ConvertFrom-JsonToDashboardActivity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DashboardActivity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DashboardActivity
