...
ApiSecurityGroupsIdRulesSgIdRule<PSCustomObject>
#>

function Initialize-ApiSecurityGroupsIdRulesSgIdRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiSecurityGroupsIdRulesSgIdRule' | Write-Debug
...
Convert from JSON to ApiSecurityGroupsIdRulesSgIdRule<PSCustomObject>
...
ApiSecurityGroupsIdRulesSgIdRule<PSCustomObject>
#>
function ConvertFrom-JsonToApiSecurityGroupsIdRulesSgIdRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiSecurityGroupsIdRulesSgIdRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiSecurityGroupsIdRulesSgIdRule
