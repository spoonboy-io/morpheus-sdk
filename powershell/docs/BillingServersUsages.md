...
**Volumes** | [**BillingServersVolumes[]**](BillingServersVolumes.md) |  | [optional] 
...
**PricesUsed** | [**BillingServersPricesUsed[]**](BillingServersPricesUsed.md) |  | [optional] 
...
**ApplicablePrices** | [**BillingServersApplicablePrices[]**](BillingServersApplicablePrices.md) |  | [optional] 
...
```powershell
$BillingServersUsages = Initialize-PSOpenAPIToolsBillingServersUsages  -Name null `
 -ZoneName null `
 -AccountName null `
 -Volumes null `
 -MaxMemory null `
...
```powershell
$BillingServersUsages | ConvertTo-JSON
```
