...
```powershell
$CreateLoadBalancerMonitorRequestLoadBalancerMonitor = Initialize-PSOpenAPIToolsCreateLoadBalancerMonitorRequestLoadBalancerMonitor  -Name null `
 -Description null `
 -MonitorType null `
 -MonitorTimeout null `
 -Config null
...
```powershell
$CreateLoadBalancerMonitorRequestLoadBalancerMonitor | ConvertTo-JSON
```
