...
**RoleMappings** | [**IdentitySourcesJumpCloudConfigRoleMappingsInner[]**](IdentitySourcesJumpCloudConfigRoleMappingsInner.md) |  | [optional] 
...
```powershell
$IdentitySourcesJumpCloudConfig = Initialize-PSOpenAPIToolsIdentitySourcesJumpCloudConfig  -Id null `
 -Name null `
 -Description null `
 -Code null `
 -Type null `
...
```powershell
$IdentitySourcesJumpCloudConfig | ConvertTo-JSON
```
