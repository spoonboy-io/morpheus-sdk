...
```powershell
$AddInstanceDeployRequestAppDeploy = Initialize-PSOpenAPIToolsAddInstanceDeployRequestAppDeploy  -DeploymentId null `
 -Version null `
 -VersionId null `
 -Config null `
 -StageOnly null
...
```powershell
$AddInstanceDeployRequestAppDeploy | ConvertTo-JSON
```
