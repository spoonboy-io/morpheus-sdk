...
```powershell
$ApiLoadBalancerPoolsLoadBalancerPoolIdNodesLoadBalancerNode = Initialize-PSOpenAPIToolsApiLoadBalancerPoolsLoadBalancerPoolIdNodesLoadBalancerNode  -Name null `
 -Description null `
 -IpAddress null `
 -Port null `
 -Weight null `
...
```powershell
$ApiLoadBalancerPoolsLoadBalancerPoolIdNodesLoadBalancerNode | ConvertTo-JSON
```
