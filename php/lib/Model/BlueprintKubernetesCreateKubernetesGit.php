...
/**
 * BlueprintKubernetesCreateKubernetesGit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintKubernetesCreateKubernetesGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintKubernetesCreate_kubernetes_git';
     ...
     * Sets repo_id
     *
     * @param int|null $repo_id Morpheus SCM Repository ID
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Path to kubernetes Files in the Repository
     *
     * @return self
     */
     ...
     * Sets integration_id
     *
     * @param int|null $integration_id Morpheus SCM Integration ID
     *
     * @return self
     */
