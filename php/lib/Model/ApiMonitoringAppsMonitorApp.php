...
/**
 * ApiMonitoringAppsMonitorApp Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiMonitoringAppsMonitorApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_monitoring_apps_monitorApp';
     ...
     * Sets name
     *
     * @param string $name Unique name scoped to your account for the check app
     *
     * @return self
     */
