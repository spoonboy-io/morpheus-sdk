...
/**
 * RolePermissionCatalogItemType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionCatalogItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionCatalogItemType';
    ...
    protected static $attributeMap = [
        'catalog_item_type_id' => 'catalogItemTypeId',
        'access' => 'access'
    ];
    ...
    {
        $this->container['catalog_item_type_id'] = $data['catalog_item_type_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['catalog_item_type_id'] === null) {
            $invalidProperties[] = "'catalog_item_type_id' can't be null";
        }
     ...
     *
     * @param int $catalog_item_type_id `id` of the catalog item type
     *
     * @return self
     */
