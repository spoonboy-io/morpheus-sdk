...
/**
 * IntegrationSaltMaster Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationSaltMaster implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'integrationSaltMaster';
    ...
    protected static $openAPITypes = [
        ...
        'service_mode' => 'string',
        'is_plugin' => 'bool',
        'config' => '\OpenAPI\Client\Model\IntegrationSaltMasterConfig',
        'status' => 'string',
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\IntegrationSaltMasterConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\IntegrationSaltMasterConfig|null $config config
     *
     * @return self
     */
