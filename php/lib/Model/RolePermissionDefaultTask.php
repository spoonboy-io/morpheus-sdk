...
/**
 * RolePermissionDefaultTask Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultTask';
    ...
    const PERMISSION_CODE_TASK = 'Task';
     ...
     *
     * @param string $permission_code `Task` is the code for Default Task Access
     *
     * @return self
     */
