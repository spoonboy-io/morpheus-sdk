...
/**
 * CheckElasticsearchConfig Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckElasticsearchConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'checkElasticsearchConfig';
    ...
    {
        $this->container['es_host'] = $data['es_host'] ?? null;
        $this->container['es_port'] = $data['es_port'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['es_host'] === null) {
            $invalidProperties[] = "'es_host' can't be null";
        }
        if ($this->container['es_port'] === null) {
            $invalidProperties[] = "'es_port' can't be null";
        }
     ...
     * @return string
     */
    public function getEsHost()
    {
        return $this->container['es_host'];
    }

    /**
     * Sets es_host
     *
     * @param string $es_host Hostname or IP address of the Elasticsearch server
     *
     * @return self
     */
    public function setEsHost($es_host)
    {
        $this->container['es_host'] = $es_host;
    ...
    {
        return $this->container['es_port'];
    }

    /**
     * Sets es_port
     *
     * @param string $es_port Port to connect to the HTTP service
     *
     * @return self
     */
    public function setEsPort($es_port)
    {
        $this->container['es_port'] = $es_port;
