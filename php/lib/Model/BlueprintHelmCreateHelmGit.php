...
/**
 * BlueprintHelmCreateHelmGit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintHelmCreateHelmGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintHelmCreate_helm_git';
     ...
     * Sets path
     *
     * @param string $path Path to Helm Files in the Repository
     *
     * @return self
     */
