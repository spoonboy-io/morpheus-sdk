...
/**
 * ApiServicePlansIdServicePlan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiServicePlansIdServicePlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_service_plans__id__servicePlan';
    ...
    protected static $openAPITypes = [
        ...
        'max_cores' => 'float',
        'max_disks' => 'float',
        'provision_type' => '\OpenAPI\Client\Model\ApiServicePlansIdServicePlanProvisionType[]',
        'custom_cores' => 'bool',
        ...
        'sort_order' => 'float',
        'price_sets' => 'int[]',
        'config' => '\OpenAPI\Client\Model\ApiServicePlansIdServicePlanConfig'
    ];
     ...
     * Sets name
     *
     * @param string|null $name Service plan name
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Service plan code, must be unique
     *
     * @return self
     */
     ...
     * Sets max_storage
     *
     * @param float|null $max_storage Max storage size in bytes
     *
     * @return self
     */
     ...
     * Sets max_memory
     *
     * @param float|null $max_memory Max memory size in bytes
     *
     * @return self
     */
     ...
     * Gets provision_type
     *
     * @return \OpenAPI\Client\Model\ApiServicePlansIdServicePlanProvisionType[]|null
     */
     ...
     * Sets provision_type
     *
     * @param \OpenAPI\Client\Model\ApiServicePlansIdServicePlanProvisionType[]|null $provision_type provision_type
     *
     * @return self
     */
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\ApiServicePlansIdServicePlanConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\ApiServicePlansIdServicePlanConfig|null $config config
     *
     * @return self
     */
