...
/**
 * RolePermissionDefaultTaskSet Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultTaskSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultTaskSet';
    ...
    const PERMISSION_CODE_TASK_SET = 'TaskSet';
     ...
     *
     * @param string $permission_code `TaskSet` is the code for Default Workflow Access
     *
     * @return self
     */
