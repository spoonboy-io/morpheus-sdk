...
/**
 * NetworkTransportZoneCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkTransportZoneCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'networkTransportZoneCreate';
     ...
     * Sets name
     *
     * @param string $name Network transport zone name
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Network transport zone description
     *
     * @return self
     */
