...
class InlineObject49 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['security_group_ids'] = $data['security_group_ids'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['security_group_ids'] === null) {
            $invalidProperties[] = "'security_group_ids' can't be null";
        }
     ...
     *
     * @param int[] $security_group_ids security_group_ids
     *
     * @return self
     */
