...
/**
 * ApiRolesRoleZones Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleZones implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_zones';
     ...
     * Sets id
     *
     * @param int $id `id` of the cloud (zone)
     *
     * @return self
     */
