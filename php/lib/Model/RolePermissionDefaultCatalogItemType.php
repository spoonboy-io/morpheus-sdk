...
/**
 * RolePermissionDefaultCatalogItemType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultCatalogItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultCatalogItemType';
    ...
    const PERMISSION_CODE_CATALOG_ITEM_TYPE = 'CatalogItemType';
    ...
    {
        return [
            self::PERMISSION_CODE_CATALOG_ITEM_TYPE,
        ];
    }
     ...
     *
     * @param string $permission_code `CatalogItemType` is the code for Default Catalog Item Type Access
     *
     * @return self
     */
