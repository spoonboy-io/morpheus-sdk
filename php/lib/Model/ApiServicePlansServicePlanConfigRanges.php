...
/**
 * ApiServicePlansServicePlanConfigRanges Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiServicePlansServicePlanConfigRanges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_service_plans_servicePlan_config_ranges';
     ...
     * Sets min_storage
     *
     * @param string|null $min_storage Custom min storage in GB
     *
     * @return self
     */
     ...
     * Sets max_storage
     *
     * @param string|null $max_storage Custom max storage in GB
     *
     * @return self
     */
     ...
     *
     * @param string|null $min_per_disk_size Custom min per disk size in GB
     *
     * @return self
     */
     ...
     *
     * @param string|null $max_per_disk_size Custom max per disk size in GB
     *
     * @return self
     */
