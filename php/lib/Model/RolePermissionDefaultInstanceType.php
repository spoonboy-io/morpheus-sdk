...
/**
 * RolePermissionDefaultInstanceType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultInstanceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultInstanceType';
    ...
    const PERMISSION_CODE_INSTANCE_TYPE = 'InstanceType';
    ...
    {
        return [
            self::PERMISSION_CODE_INSTANCE_TYPE,
        ];
    }
     ...
     *
     * @param string $permission_code `InstanceType` is the code for Default Instance Type Access
     *
     * @return self
     */
