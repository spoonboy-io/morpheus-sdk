...
/**
 * IntegrationPuppet Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationPuppet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'integrationPuppet';
    ...
    protected static $openAPITypes = [
        ...
        'is_plugin' => 'bool',
        'config' => '\OpenAPI\Client\Model\IntegrationPuppetConfig',
        'status' => 'string',
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\IntegrationPuppetConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\IntegrationPuppetConfig|null $config config
     *
     * @return self
     */
