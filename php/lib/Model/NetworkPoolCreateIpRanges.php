...
/**
 * NetworkPoolCreateIpRanges Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkPoolCreateIpRanges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'networkPoolCreate_ipRanges';
     ...
     * Sets start_address
     *
     * @param string|null $start_address Starting IP Address
     *
     * @return self
     */
     ...
     * Sets end_address
     *
     * @param string|null $end_address Ending IP Address
     *
     * @return self
     */
