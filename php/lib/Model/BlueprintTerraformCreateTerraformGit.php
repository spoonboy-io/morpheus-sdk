...
/**
 * BlueprintTerraformCreateTerraformGit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintTerraformCreateTerraformGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintTerraformCreate_terraform_git';
     ...
     * Sets path
     *
     * @param string $path Path to terraform Files in the Repository
     *
     * @return self
     */
