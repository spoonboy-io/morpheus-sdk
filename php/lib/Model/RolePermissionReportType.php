...
/**
 * RolePermissionReportType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionReportType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionReportType';
    ...
    {
        $this->container['report_type_id'] = $data['report_type_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['report_type_id'] === null) {
            $invalidProperties[] = "'report_type_id' can't be null";
        }
     ...
     * Sets report_type_id
     *
     * @param int $report_type_id `id` of the report type
     *
     * @return self
     */
