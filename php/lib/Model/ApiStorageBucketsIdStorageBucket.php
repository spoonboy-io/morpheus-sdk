...
/**
 * ApiStorageBucketsIdStorageBucket Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiStorageBucketsIdStorageBucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_storage_buckets__id__storageBucket';
     ...
     * Sets name
     *
     * @param string|null $name A unique name scoped to your account for the storage bucket
     *
     * @return self
     */
     ...
     * Sets provider_type
     *
     * @param string|null $provider_type The type of storage bucket
     *
     * @return self
     */
     ...
     * Gets config
     *
     * @return OneOfObjectObjectObjectObjectObjectObjectObject|null
     */
     ...
     * Sets config
     *
     * @param OneOfObjectObjectObjectObjectObjectObjectObject|null $config config
     *
     * @return self
     */
