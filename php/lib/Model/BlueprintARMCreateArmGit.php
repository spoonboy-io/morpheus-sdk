...
/**
 * BlueprintARMCreateArmGit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintARMCreateArmGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintARMCreate_arm_git';
     ...
     * Sets path
     *
     * @param string $path Path to ARM Files in the Repository
     *
     * @return self
     */
