...
/**
 * CheckSocketConfig Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckSocketConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'checkSocketConfig';
    ...
    protected static $setters = [
        ...
        'port' => 'setPort',
        'send' => 'setSend',
        'response_match' => 'setResponseMatch',
    ...
    protected static $getters = [
        ...
        'port' => 'getPort',
        'send' => 'getSend',
        'response_match' => 'getResponseMatch',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['send'] = $data['send'] ?? null;
        $this->container['response_match'] = $data['response_match'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['response_match'] === null) {
            $invalidProperties[] = "'response_match' can't be null";
        }
     ...
     * Sets host
     *
     * @param string $host Hostname or IP address of the socket server
     *
     * @return self
     */
     ...
     * Sets send
     *
     * @param string $send Connection string you might want to send to the service
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getResponseMatch()
    {
        return $this->container['response_match'];
    }

    /**
     * Sets response_match
     *
     * @param string $response_match Response from the service to match against
     *
     * @return self
     */
    public function setResponseMatch($response_match)
    {
        $this->container['response_match'] = $response_match;
