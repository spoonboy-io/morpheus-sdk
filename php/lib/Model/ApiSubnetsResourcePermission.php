...
/**
 * ApiSubnetsResourcePermission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiSubnetsResourcePermission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_subnets_resourcePermission';
     ...
     * Sets sites
     *
     * @param \OpenAPI\Client\Model\ApiBlueprintsIdUpdatePermissionsResourcePermissionSites[]|null $sites Array of groups ID objects that are allowed access
     *
     * @return self
     */
