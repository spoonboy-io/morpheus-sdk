...
/**
 * RolePermissionInstanceType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionInstanceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionInstanceType';
     ...
     *
     * @param int $instance_type_id `id` of the instance type
     *
     * @return self
     */
