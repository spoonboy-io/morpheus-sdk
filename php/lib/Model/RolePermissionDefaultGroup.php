...
/**
 * RolePermissionDefaultGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultGroup';
    ...
    const PERMISSION_CODE_COMPUTE_SITE = 'ComputeSite';
    ...
    {
        return [
            self::PERMISSION_CODE_COMPUTE_SITE,
        ];
    }
    ...
    {
        $this->container['permission_code'] = $data['permission_code'] ?? 'ComputeSite';
     ...
     *
     * @param string $permission_code `ComputeSite` is the code for Default Group Access
     *
     * @return self
     */
