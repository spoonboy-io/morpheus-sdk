...
/**
 * ApiStorageServersStorageServer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiStorageServersStorageServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_storage_servers_storageServer';
     ...
     * Sets type
     *
     * @param string $type The `Storage Type` Code or ID
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param object $config Configuration object with parameters that vary by `type`
     *
     * @return self
     */
