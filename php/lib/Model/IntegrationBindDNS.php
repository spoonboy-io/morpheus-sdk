...
/**
 * IntegrationBindDNS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationBindDNS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'integrationBindDNS';
    ...
    protected static $openAPITypes = [
        ...
        'host' => 'string',
        'is_plugin' => 'bool',
        'config' => '\OpenAPI\Client\Model\IntegrationBindDNSConfig',
        'status' => 'string',
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\IntegrationBindDNSConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\IntegrationBindDNSConfig|null $config config
     *
     * @return self
     */
