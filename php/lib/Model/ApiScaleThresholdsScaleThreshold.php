...
/**
 * ApiScaleThresholdsScaleThreshold Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiScaleThresholdsScaleThreshold implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_scale_thresholds_scaleThreshold';
     ...
     * Sets name
     *
     * @param string $name A name for the scale threshold
     *
     * @return self
     */
