...
/**
 * SecurityGroupLocationOpenstackCustomOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecurityGroupLocationOpenstackCustomOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'securityGroupLocationOpenstackCustomOptions';
     ...
     *
     * @param int|null $resource_pool_id Resource Pool ID (applicable to cloud types Openstack/OpenTelekom/Huawei)
     *
     * @return self
     */
