...
/**
 * ApiRolesRoleTaskSets Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleTaskSets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_taskSets';
     ...
     * Sets id
     *
     * @param int $id `id` of the workflow (taskSet)
     *
     * @return self
     */
