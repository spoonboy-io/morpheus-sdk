...
/**
 * ApiRolesRoleReportTypes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleReportTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_reportTypes';
     ...
     * Sets code
     *
     * @param string $code `code` of the report type
     *
     * @return self
     */
