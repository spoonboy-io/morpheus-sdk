...
/**
 * ApiRolesRoleInstanceTypes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleInstanceTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_instanceTypes';
     ...
     * Sets id
     *
     * @param int $id `id` of the instance type
     *
     * @return self
     */
