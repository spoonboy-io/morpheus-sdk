...
/**
 * ApiExecuteSchedulesIdSchedule Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiExecuteSchedulesIdSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_execute_schedules__id__schedule';
     ...
     * Sets name
     *
     * @param string|null $name A name for the execute schedule
     *
     * @return self
     */
