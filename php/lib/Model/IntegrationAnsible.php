...
/**
 * IntegrationAnsible Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationAnsible implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'integrationAnsible';
    ...
    protected static $openAPITypes = [
        ...
        'is_plugin' => 'bool',
        'config' => '\OpenAPI\Client\Model\IntegrationAnsibleConfig',
        'status' => 'string',
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\IntegrationAnsibleConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\IntegrationAnsibleConfig|null $config config
     *
     * @return self
     */
