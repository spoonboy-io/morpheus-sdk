...
/**
 * LoadBalancerCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoadBalancerCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loadBalancerCreate';
     ...
     *
     * @param int|null $network_server_id Network Server ID
     *
     * @return self
     */
