...
/**
 * RolePermissionGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionGroup';
     ...
     * Sets group_id
     *
     * @param int $group_id `id` of the group (site)
     *
     * @return self
     */
