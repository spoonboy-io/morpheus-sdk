...
/**
 * RolePermissionTaskSet Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionTaskSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionTaskSet';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['task_set_id'] === null) {
            $invalidProperties[] = "'task_set_id' can't be null";
        }
     ...
     * Sets task_set_id
     *
     * @param int $task_set_id `id` of the workflow (taskSet)
     *
     * @return self
     */
