...
/**
 * ApiScaleThresholdsIdScaleThreshold Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiScaleThresholdsIdScaleThreshold implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_scale_thresholds__id__scaleThreshold';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['auto_up'] = $data['auto_up'] ?? false;
        $this->container['auto_down'] = $data['auto_down'] ?? false;
        $this->container['min_count'] = $data['min_count'] ?? null;
        $this->container['max_count'] = $data['max_count'] ?? null;
        $this->container['cpu_enabled'] = $data['cpu_enabled'] ?? false;
        $this->container['min_cpu'] = $data['min_cpu'] ?? 0;
        $this->container['max_cpu'] = $data['max_cpu'] ?? 0;
        $this->container['memory_enabled'] = $data['memory_enabled'] ?? false;
        $this->container['min_memory'] = $data['min_memory'] ?? 0;
        $this->container['max_memory'] = $data['max_memory'] ?? 0;
        $this->container['disk_enabled'] = $data['disk_enabled'] ?? false;
        $this->container['min_disk'] = $data['min_disk'] ?? 0;
        $this->container['max_disk'] = $data['max_disk'] ?? 0;
    }
     ...
     * Sets name
     *
     * @param string|null $name A name for the scale threshold
     *
     * @return self
     */
     ...
     * Sets min_cpu
     *
     * @param float|null $min_cpu Min CPU (%)
     *
     * @return self
     */
     ...
     * Sets max_cpu
     *
     * @param float|null $max_cpu Max CPU (%)
     *
     * @return self
     */
     ...
     * Sets min_memory
     *
     * @param float|null $min_memory Min Memory (%)
     *
     * @return self
     */
     ...
     * Sets max_memory
     *
     * @param float|null $max_memory Max Memory (%)
     *
     * @return self
     */
     ...
     * Sets min_disk
     *
     * @param float|null $min_disk Min Disk (%)
     *
     * @return self
     */
     ...
     * Sets max_disk
     *
     * @param float|null $max_disk Max Disk (%)
     *
     * @return self
     */
