...
/**
 * PolicyCloudUpdatePolicyType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PolicyCloudUpdatePolicyType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'policyCloudUpdate_policyType';
     ...
     * Sets ref_id
     *
     * @param int|null $ref_id Scope object ID (`cloud`)
     *
     * @return self
     */
