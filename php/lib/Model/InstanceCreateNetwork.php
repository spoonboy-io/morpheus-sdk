...
/**
 * InstanceCreateNetwork Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceCreateNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'instanceCreateNetwork';
    ...
    protected static $openAPITypes = [
        'network' => '\OpenAPI\Client\Model\InstanceCreateNetworkNetwork',
     ...
     * Gets network
     *
     * @return \OpenAPI\Client\Model\InstanceCreateNetworkNetwork
     */
     ...
     * Sets network
     *
     * @param \OpenAPI\Client\Model\InstanceCreateNetworkNetwork $network network
     *
     * @return self
     */
     ...
     *
     * @param int|null $network_interface_type_id The id of type of the network interface.
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address The ip address. Not applicable when using DHCP or IP Pools.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id The interface id. Applicable when resizing and you want to identify an interface to update that already exists.
     *
     * @return self
     */
