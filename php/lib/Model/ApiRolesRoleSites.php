...
/**
 * ApiRolesRoleSites Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleSites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_sites';
     ...
     * Sets id
     *
     * @param int $id `id` of the group (site)
     *
     * @return self
     */
