...
/**
 * ActivityActivity Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivityActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'activity_activity';
    ...
    protected static $openAPITypes = [
        ...
        'object_type' => 'string',
        'object_id' => 'int',
        'user' => '\OpenAPI\Client\Model\InlineResponse200107NetworkPoolCreatedBy',
        'ts' => '\DateTime'
    ];
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\InlineResponse200107NetworkPoolCreatedBy|null $user user
     *
     * @return self
     */
