...
/**
 * FileTemplateCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileTemplateCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fileTemplateCreate';
     ...
     * Sets name
     *
     * @param string $name File template name
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string $file_name Filename for the file template
     *
     * @return self
     */
