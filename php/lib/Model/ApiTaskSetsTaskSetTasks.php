...
/**
 * ApiTaskSetsTaskSetTasks Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiTaskSetsTaskSetTasks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_task_sets_taskSet_tasks';
    ...
    const TASK_PHASE_OPERATION = 'operation';
     ...
     * Sets task_phase
     *
     * @param string|null $task_phase Task Phase. Pass operation for `operational` workflows.
     *
     * @return self
     */
