...
/**
 * GroupCreateConfig Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupCreateConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'groupCreate_config';
     ...
     *
     * @param string|null $dns_integration_id Optional DNS Integration ID
     *
     * @return self
     */
     ...
     * Sets config_cmdb_id
     *
     * @param string|null $config_cmdb_id Optional CMDB Integration ID
     *
     * @return self
     */
     ...
     * Sets config_cm_id
     *
     * @param string|null $config_cm_id Optional Change Management Integration ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $service_registry_id Optional Service Registry Integration ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $config_management_id Optional Configuration Management Integration ID
     *
     * @return self
     */
     ...
     *
     * @param bool|null $config_cmdb_discovery Enable or disable CMDB Discovery
     *
     * @return self
     */
