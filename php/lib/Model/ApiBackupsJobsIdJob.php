...
/**
 * ApiBackupsJobsIdJob Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiBackupsJobsIdJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_backups_jobs__id__job';
     ...
     * Sets name
     *
     * @param string|null $name A name for the backup job
     *
     * @return self
     */
     ...
     *
     * @param int|null $retention_count Retention Count
     *
     * @return self
     */
