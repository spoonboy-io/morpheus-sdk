...
/**
 * ApiTasksTask Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiTasksTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_tasks_task';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['execute_target'] === null) {
            $invalidProperties[] = "'execute_target' can't be null";
        }
     ...
     * Gets task_type
     *
     * @return \OpenAPI\Client\Model\ApiTasksTaskTaskType
     */
     ...
     * Sets task_type
     *
     * @param \OpenAPI\Client\Model\ApiTasksTaskTaskType $task_type task_type
     *
     * @return self
     */
     ...
     * Sets execute_target
     *
     * @param string $execute_target The execution target. eg. local,remote,resource. The default value varies by task type.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getExecuteTargetAllowableValues();
        if (!in_array($execute_target, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'execute_target', must be one of '%s'",
                    $execute_target,
