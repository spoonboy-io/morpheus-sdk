...
/**
 * InstanceTypeLayoutUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceTypeLayoutUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'instanceTypeLayoutUpdate';
     ...
     *
     * @param string|null $instance_version Version of the layout
     *
     * @return self
     */
     ...
     *
     * @param string|null $provision_type_code Provision type code
     *
     * @return self
     */
