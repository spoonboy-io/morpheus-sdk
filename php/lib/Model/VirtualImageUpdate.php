...
/**
 * VirtualImageUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualImageUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'virtualImageUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'add_tags' => '\OpenAPI\Client\Model\VirtualImageCreateTags[]',
        'remove_tags' => '\OpenAPI\Client\Model\VirtualImageUpdateRemoveTags[]'
    ];
     ...
     * Sets tags
     *
     * @param \OpenAPI\Client\Model\VirtualImageCreateTags[]|null $tags Metadata tags, Array of objects having a name and value, this adds or updates the specified tags and removes any tags not specified.
     *
     * @return self
     */
     ...
     * Sets add_tags
     *
     * @param \OpenAPI\Client\Model\VirtualImageCreateTags[]|null $add_tags Add or update value of Metadata tags, Array of objects having a name and value.
     *
     * @return self
     */
     ...
     * Gets remove_tags
     *
     * @return \OpenAPI\Client\Model\VirtualImageUpdateRemoveTags[]|null
     */
     ...
     * Sets remove_tags
     *
     * @param \OpenAPI\Client\Model\VirtualImageUpdateRemoveTags[]|null $remove_tags Remove Metadata tags, Array of objects having a name and an optional value. If value is passed, it must match to be removed.
     *
     * @return self
     */
