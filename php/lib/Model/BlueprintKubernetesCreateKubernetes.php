...
/**
 * BlueprintKubernetesCreateKubernetes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintKubernetesCreateKubernetes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintKubernetesCreate_kubernetes';
    ...
    protected static $openAPITypes = [
        'config_type' => 'string',
        'yaml' => 'string',
        'git' => '\OpenAPI\Client\Model\BlueprintKubernetesCreateKubernetesGit'
    ];
     ...
     * Sets yaml
     *
     * @param string|null $yaml Kubernetes Spec in YAML
     *
     * @return self
     */
     ...
     * Gets git
     *
     * @return \OpenAPI\Client\Model\BlueprintKubernetesCreateKubernetesGit|null
     */
     ...
     * Sets git
     *
     * @param \OpenAPI\Client\Model\BlueprintKubernetesCreateKubernetesGit|null $git git
     *
     * @return self
     */
