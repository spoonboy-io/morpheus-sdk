...
/**
 * RolePermissionDefaultReportType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultReportType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultReportType';
    ...
    const PERMISSION_CODE_REPORT_TYPES = 'ReportTypes';
    ...
    {
        return [
            self::PERMISSION_CODE_REPORT_TYPES,
        ];
    }
     ...
     *
     * @param string $permission_code `ReportTypes` is the code for Default Report Type Access
     *
     * @return self
     */
