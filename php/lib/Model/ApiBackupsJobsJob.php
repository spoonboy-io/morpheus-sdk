...
/**
 * ApiBackupsJobsJob Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiBackupsJobsJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_backups_jobs_job';
     ...
     * Sets name
     *
     * @param string $name A name for the backup job
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code A code for the backup job
     *
     * @return self
     */
     ...
     * Sets schedule_id
     *
     * @param int|null $schedule_id Execute Schedule ID to use for the backup job
     *
     * @return self
     */
     ...
     *
     * @param int|null $retention_count Retention Count. By default the backup settings value will be used.
     *
     * @return self
     */
