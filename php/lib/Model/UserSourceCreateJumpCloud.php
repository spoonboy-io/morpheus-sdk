...
/**
 * UserSourceCreateJumpCloud Class Doc Comment
 *
 * @category Class
 ...
 */
class UserSourceCreateJumpCloud implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userSourceCreateJumpCloud';
    ...
    {
        $this->container['organization_id'] = $data['organization_id'] ?? false;
     ...
     *
     * @param bool|null $organization_id Organization ID
     *
     * @return self
     */
     ...
     * Sets required_role
     *
     * @param string|null $required_role Required group name
     *
     * @return self
     */
