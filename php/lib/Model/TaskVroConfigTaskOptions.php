...
/**
 * TaskVroConfigTaskOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaskVroConfigTaskOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'taskVroConfig_taskOptions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vro_body'] = $data['vro_body'] ?? null;
     ...
     * @return string|null
     */
    public function getVroBody()
    {
        return $this->container['vro_body'];
    }

    /**
     * Sets vro_body
     *
     * @param string|null $vro_body vro_body
     *
     * @return self
     */
    public function setVroBody($vro_body)
    {
        $this->container['vro_body'] = $vro_body;
