...
/**
 * NetworkPoolServerCreatePhpIpam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkPoolServerCreatePhpIpam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'networkPoolServerCreatePhpIpam';
    ...
    protected static $openAPITypes = [
        ...
        'config' => '\OpenAPI\Client\Model\NetworkPoolServerCreatePhpIpamConfig',
     ...
     * Sets type
     *
     * @param string $type Type Code (phpIPAM)
     *
     * @return self
     */
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\NetworkPoolServerCreatePhpIpamConfig
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\NetworkPoolServerCreatePhpIpamConfig $config config
     *
     * @return self
     */
