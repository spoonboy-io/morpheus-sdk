...
/**
 * ApiRolesRoleVdiPools Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleVdiPools implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_vdiPools';
     ...
     * Sets id
     *
     * @param int $id `id` of the VDI pool
     *
     * @return self
     */
