...
/**
 * ContainerTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContainerTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'containerTypeCreate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['container_version'] === null) {
            $invalidProperties[] = "'container_version' can't be null";
        }
     ...
     * Sets short_name
     *
     * @param string $short_name The short name is a name with no spaces used for display in your container list.
     *
     * @return self
     */
     ...
     *
     * @param string $container_version Version of the node type
     *
     * @return self
     */
     ...
     *
     * @param string $provision_type_code Provision type code, eg. `amazon`, etc.
     *
     * @return self
     */
