...
/**
 * NetworkPoolServerCreateInfoblox Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkPoolServerCreateInfoblox implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'networkPoolServerCreateInfoblox';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_match' => 'string',
        'service_mode' => 'string',
        'config' => '\OpenAPI\Client\Model\NetworkPoolServerCreateInfobloxConfig',
    ...
    const TYPE_INFOBLOX = 'infoblox';
    const SERVICE_MODE__STATIC = 'static';
    const SERVICE_MODE_DHCP = 'dhcp';
    ...
    {
        return [
            self::SERVICE_MODE__STATIC,
            self::SERVICE_MODE_DHCP,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['service_mode'] = $data['service_mode'] ?? 'static';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['service_mode']) && !in_array($this->container['service_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'service_mode', must be one of '%s'",
                $this->container['service_mode'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets type
     *
     * @param string $type Type Code (Infoblox)
     *
     * @return self
     */
     ...
     * Sets service_mode
     *
     * @param string|null $service_mode IP Mode
     *
     * @return self
     */
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\NetworkPoolServerCreateInfobloxConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\NetworkPoolServerCreateInfobloxConfig|null $config config
     *
     * @return self
     */
