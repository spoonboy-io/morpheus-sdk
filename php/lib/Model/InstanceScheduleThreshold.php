...
/**
 * InstanceScheduleThreshold Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceScheduleThreshold implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'instanceSchedule_threshold';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scale_increment'] = $data['scale_increment'] ?? 1;
     ...
     *
     * @param int|null $scale_increment The number of nodes that are added or removed at one time when scaling up or down
     *
     * @return self
     */
