...
/**
 * RolePermissionGroupAll Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionGroupAll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionGroupAll';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['all_groups'] === null) {
            $invalidProperties[] = "'all_groups' can't be null";
        }
     ...
     * Sets all_groups
     *
     * @param bool $all_groups Apply to all groups (site)
     *
     * @return self
     */
