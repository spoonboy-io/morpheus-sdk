...
/**
 * ApiRolesRoleCatalogItemTypes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleCatalogItemTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_catalogItemTypes';
     ...
     * Sets id
     *
     * @param int $id `id` of the catalog item type
     *
     * @return self
     */
