...
/**
 * ImageBuildsConfigNetwork Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImageBuildsConfigNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'imageBuilds_config_network';
    ...
    protected static $openAPITypes = [
        'id_name' => 'string',
        'pool' => '\OpenAPI\Client\Model\AppPrepareApplyDataGroup',
        'id' => 'string',
        'has_pool' => 'bool'
    ];
    ...
    {
        $this->container['id_name'] = $data['id_name'] ?? null;
     ...
     * Sets id_name
     *
     * @param string|null $id_name id_name
     *
     * @return self
     */
     ...
     * Sets pool
     *
     * @param \OpenAPI\Client\Model\AppPrepareApplyDataGroup|null $pool pool
     *
     * @return self
     */
