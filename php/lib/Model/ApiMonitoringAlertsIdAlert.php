...
/**
 * ApiMonitoringAlertsIdAlert Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiMonitoringAlertsIdAlert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_monitoring_alerts__id__alert';
     ...
     * Sets name
     *
     * @param string|null $name Unique name scoped to your account for the alert
     *
     * @return self
     */
