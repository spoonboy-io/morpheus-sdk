...
/**
 * RolePermissionDefaultCloud Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultCloud implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultCloud';
    ...
    const PERMISSION_CODE_COMPUTE_ZONE = 'ComputeZone';
    ...
    {
        return [
            self::PERMISSION_CODE_COMPUTE_ZONE,
        ];
    }
     ...
     *
     * @param string $permission_code `ComputeZone` is the code for Default Cloud Access
     *
     * @return self
     */
