...
/**
 * BlueprintCFTCreateCloudFormationGit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlueprintCFTCreateCloudFormationGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprintCFTCreate_cloudFormation_git';
     ...
     * Sets repo_id
     *
     * @param int $repo_id Morpheus SCM Repository ID
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string $path Path to CloudFormation Files in the Repository
     *
     * @return self
     */
     ...
     * Sets integration_id
     *
     * @param int $integration_id Morpheus SCM Integration ID
     *
     * @return self
     */
