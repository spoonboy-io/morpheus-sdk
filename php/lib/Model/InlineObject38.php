...
class InlineObject38 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'check_group' => '\OpenAPI\Client\Model\ApiMonitoringGroupsIdCheckGroup'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['check_group'] === null) {
            $invalidProperties[] = "'check_group' can't be null";
        }
     ...
     * Gets check_group
     *
     * @return \OpenAPI\Client\Model\ApiMonitoringGroupsIdCheckGroup
     */
     ...
     * Sets check_group
     *
     * @param \OpenAPI\Client\Model\ApiMonitoringGroupsIdCheckGroup $check_group check_group
     *
     * @return self
     */
