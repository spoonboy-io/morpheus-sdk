...
/**
 * ApiRolesRolePersonas Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRolePersonas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_personas';
    ...
    const CODE_SERVICE_CATALOG = 'serviceCatalog';
    const CODE_VDI = 'vdi';
     ...
     * Sets code
     *
     * @param string|null $code `code` of the persona
     *
     * @return self
     */
