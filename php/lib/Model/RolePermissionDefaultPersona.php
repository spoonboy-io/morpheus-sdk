...
/**
 * RolePermissionDefaultPersona Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultPersona implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultPersona';
    ...
    const PERMISSION_CODE_PERSONA = 'Persona';
     ...
     *
     * @param string $permission_code `Persona` is the code for Default Persona Access
     *
     * @return self
     */
