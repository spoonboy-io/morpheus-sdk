...
class InlineObject252 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'user' => '\OpenAPI\Client\Model\UserSettingsUpdate'
    ];
     ...
     * Gets user
     *
     * @return \OpenAPI\Client\Model\UserSettingsUpdate|null
     */
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\UserSettingsUpdate|null $user user
     *
     * @return self
     */
