...
/**
 * RolePermissionDefaultBlueprint Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultBlueprint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultBlueprint';
    ...
    const PERMISSION_CODE_APP_TEMPLATE = 'AppTemplate';
    ...
    {
        return [
            self::PERMISSION_CODE_APP_TEMPLATE,
        ];
    }
     ...
     *
     * @param string $permission_code `AppTemplate` is the code for Default Blueprint Access
     *
     * @return self
     */
