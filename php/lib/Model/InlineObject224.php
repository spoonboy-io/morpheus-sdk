...
class InlineObject224 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'server' => '\OpenAPI\Client\Model\ApiServersIdResizeServer',
        'service_plan_options' => '\OpenAPI\Client\Model\ApiServersIdResizeServicePlanOptions',
     ...
     * Gets server
     *
     * @return \OpenAPI\Client\Model\ApiServersIdResizeServer|null
     */
     ...
     * Sets server
     *
     * @param \OpenAPI\Client\Model\ApiServersIdResizeServer|null $server server
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ApiServersIdResizeServicePlanOptions|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ApiServersIdResizeServicePlanOptions|null $service_plan_options service_plan_options
     *
     * @return self
     */
     ...
     * Sets volumes
     *
     * @param \OpenAPI\Client\Model\InstanceCreateVolume[]|null $volumes List of volumes with their new sizes.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InstanceCreateNetwork[]|null $network_interfaces Key for network configurations. Include id to update an existing interface.
     *
     * @return self
     */
