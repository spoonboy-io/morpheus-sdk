...
/**
 * ApiTaskSetsTaskSet Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiTaskSetsTaskSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_task_sets_taskSet';
     ...
     * Sets name
     *
     * @param string $name A unique name for the workflow
     *
     * @return self
     */
