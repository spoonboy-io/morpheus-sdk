...
/**
 * NetworkPoolServerCreateSolarWinds Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkPoolServerCreateSolarWinds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'networkPoolServerCreateSolarWinds';
    ...
    const TYPE_SOLARWINDSIPAM = 'solarwindsipam';
     ...
     * Sets type
     *
     * @param string $type Type Code (SolarWinds)
     *
     * @return self
     */
