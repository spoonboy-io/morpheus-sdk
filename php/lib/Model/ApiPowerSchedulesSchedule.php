...
/**
 * ApiPowerSchedulesSchedule Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiPowerSchedulesSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_power_schedules_schedule';
     ...
     * Sets name
     *
     * @param string $name A name for the power schedule
     *
     * @return self
     */
