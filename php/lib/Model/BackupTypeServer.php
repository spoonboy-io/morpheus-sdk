...
/**
 * BackupTypeServer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BackupTypeServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'backupTypeServer';
     ...
     * Sets server_id
     *
     * @param int|null $server_id The ID of the server to backup
     *
     * @return self
     */
