...
/**
 * RolePermissionDefaultVDIPool Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RolePermissionDefaultVDIPool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rolePermissionDefaultVDIPool';
    ...
    const PERMISSION_CODE_VDI_POOLS = 'VdiPools';
    ...
    {
        return [
            self::PERMISSION_CODE_VDI_POOLS,
        ];
    }
     ...
     *
     * @param string $permission_code `VdiPools` is the code for Default VDI Pool Access
     *
     * @return self
     */
