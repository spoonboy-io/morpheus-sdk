...
/**
 * ApiRolesRole Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiRolesRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role';
    ...
    {
        return [
            self::GLOBAL_SITE_ACCESS__DEFAULT,
    ...
    {
        return [
            self::GLOBAL_ZONE_ACCESS__DEFAULT,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['role_type'] = $data['role_type'] ?? 'user';
        $this->container['base_role_id'] = $data['base_role_id'] ?? null;
        $this->container['multitenant'] = $data['multitenant'] ?? false;
        $this->container['multitenant_locked'] = $data['multitenant_locked'] ?? false;
     ...
     * Sets role_type
     *
     * @param string|null $role_type Role type
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRoleTypeAllowableValues();
        if (!is_null($role_type) && !in_array($role_type, $allowedValues, true)) {
     ...
     * Sets base_role_id
     *
     * @param int|null $base_role_id Base Role ID. Create the new role with the same permissions and access levels that the specified base role has. If this is not passed, the role is create without any permissions.
     *
     * @return self
     */
     ...
     * Sets multitenant
     *
     * @param bool|null $multitenant Multitenant roles are copied to all tenant accounts and kept in sync until a sub-tenant user modifies their copy of the role. *Only available to master tenant*
     *
     * @return self
     */
     ...
     *
     * @param bool|null $multitenant_locked Multitenant Locked, prevents sub-tenant users from modifying their copy of multienant roles. *Only available to master tenant*
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param int|null $owner Set the role owner (tenant) by ID. *Only available to master tenant*
     *
     * @return self
     */
