...
/**
 * ApiRolesRoleAppTemplates Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiRolesRoleAppTemplates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_roles_role_appTemplates';
     ...
     * Sets id
     *
     * @param int $id `id` of the blueprint (appTemplate)
     *
     * @return self
     */
