...
class DashboardApi
{
     ...
     * @return \OpenAPI\Client\Model\Dashboard|\OpenAPI\Client\Model\DefaultError|\OpenAPI\Client\Model\DefaultError
     */
    public function dashboard()
    {
        list($response) = $this->dashboardWithHttpInfo();
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Dashboard|\OpenAPI\Client\Model\DefaultError|\OpenAPI\Client\Model\DefaultError, HTTP status code, HTTP response headers (array of strings)
     */
    public function dashboardWithHttpInfo()
    {
     ...
     */
    public function dashboardAsync()
    {
        return $this->dashboardAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dashboardAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\Dashboard';
        $request = $this->dashboardRequest();
