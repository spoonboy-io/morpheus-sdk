...
import org.openapitools.model.TaskVroConfigTaskOptions;
import org.openapitools.model.TaskVroConfigTaskType;
...
class TaskVroConfig {
    ...
    TaskVroConfigTaskType taskType
    
    List<String> labels = new ArrayList<String>()
    
    String visibility
    
    TaskVroConfigTaskOptions taskOptions
