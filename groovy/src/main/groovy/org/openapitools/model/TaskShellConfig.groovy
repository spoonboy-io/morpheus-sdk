...
import org.openapitools.model.TaskShellConfigTaskOptions;
import org.openapitools.model.TaskShellConfigTaskType;
...
class TaskShellConfig {
    ...
    TaskShellConfigTaskType taskType
    
    List<String> labels = new ArrayList<String>()
    
    String visibility
    
    TaskShellConfigTaskOptions taskOptions
