...
import org.openapitools.model.TaskPowershellConfigTaskOptions;
import org.openapitools.model.TaskPowershellConfigTaskType;
...
class TaskPowershellConfig {
    ...
    TaskPowershellConfigTaskType taskType
    
    List<String> labels = new ArrayList<String>()
    
    String visibility
    
    TaskPowershellConfigTaskOptions taskOptions
