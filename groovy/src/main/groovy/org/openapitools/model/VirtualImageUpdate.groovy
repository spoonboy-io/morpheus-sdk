...
import org.openapitools.model.VirtualImageUpdateRemoveTags;
...
class VirtualImageUpdate {
    ...
    List<VirtualImageCreateTags> addTags = new ArrayList<VirtualImageCreateTags>()
    /* Remove Metadata tags, Array of objects having a name and an optional value. If value is passed, it must match to be removed. */
    List<VirtualImageUpdateRemoveTags> removeTags = new ArrayList<VirtualImageUpdateRemoveTags>()
}
