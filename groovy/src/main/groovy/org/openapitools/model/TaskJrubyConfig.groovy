...
import org.openapitools.model.TaskJrubyConfigTaskOptions;
import org.openapitools.model.TaskJrubyConfigTaskType;

@Canonical
class TaskJrubyConfig {
    ...
    TaskJrubyConfigTaskType taskType
    
    List<String> labels = new ArrayList<String>()
    
    String visibility
    
    TaskJrubyConfigTaskOptions taskOptions
