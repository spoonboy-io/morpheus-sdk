...
type Check struct {
	...
	Config *AnyOfcheckWebConfigcheckSqlConfigcheckElasticsearchConfigcheckSocketConfigobjectcheckVmConfig `json:"config,omitempty"`
...
func (o *Check) GetCheckInterval() int64 {
	if o == nil || o.CheckInterval.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *Check) GetConfig() AnyOfcheckWebConfigcheckSqlConfigcheckElasticsearchConfigcheckSocketConfigobjectcheckVmConfig {
	if o == nil || o.Config == nil {
		var ret AnyOfcheckWebConfigcheckSqlConfigcheckElasticsearchConfigcheckSocketConfigobjectcheckVmConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given AnyOfcheckWebConfigcheckSqlConfigcheckElasticsearchConfigcheckSocketConfigobjectcheckVmConfig and assigns it to the Config field.
...
func (o *Check) GetLastBoxStats() string {
	if o == nil || o.LastBoxStats.Get() == nil {
		var ret string
		return ret
	}
