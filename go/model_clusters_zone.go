...
type ClustersZone struct {
	...
	ZoneType *ApiBlueprintsIdUpdatePermissionsResourcePermissionSites `json:"zoneType,omitempty"`
}
...
// SetZoneType gets a reference to the given ApiBlueprintsIdUpdatePermissionsResourcePermissionSites and assigns it to the ZoneType field.
