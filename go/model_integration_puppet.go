...
type IntegrationPuppet struct {
	...
	Config *IntegrationPuppetConfig `json:"config,omitempty"`
...
func (o *IntegrationPuppet) GetConfig() IntegrationPuppetConfig {
	if o == nil || o.Config == nil {
		var ret IntegrationPuppetConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given IntegrationPuppetConfig and assigns it to the Config field.
