...
// TaskShellConfigTaskType struct for TaskShellConfigTaskType
type TaskShellConfigTaskType struct {
...
func (o TaskShellConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskShellConfigTaskType struct {
	value *TaskShellConfigTaskType
	isSet bool
}

func (v NullableTaskShellConfigTaskType) Get() *TaskShellConfigTaskType {
	return v.value
}

func (v *NullableTaskShellConfigTaskType) Set(val *TaskShellConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskShellConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskShellConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskShellConfigTaskType(val *TaskShellConfigTaskType) *NullableTaskShellConfigTaskType {
	return &NullableTaskShellConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskShellConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskShellConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
