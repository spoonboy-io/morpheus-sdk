...
type IdentitySourcesJumpCloudConfig struct {
	...
	Config *IdentitySourcesJumpCloudConfigConfig `json:"config,omitempty"`
...
func (o *IdentitySourcesJumpCloudConfig) GetConfig() IdentitySourcesJumpCloudConfigConfig {
	if o == nil || o.Config == nil {
		var ret IdentitySourcesJumpCloudConfigConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given IdentitySourcesJumpCloudConfigConfig and assigns it to the Config field.
