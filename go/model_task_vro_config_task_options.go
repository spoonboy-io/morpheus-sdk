...
// TaskVroConfigTaskOptions struct for TaskVroConfigTaskOptions
type TaskVroConfigTaskOptions struct {
...
func (o *TaskVroConfigTaskOptions) SetSshKeyNil() {
	o.SshKey.Set(nil)
}
...
func (o *TaskVroConfigTaskOptions) SetLocalScriptGitRefNil() {
...
func (o *TaskVroConfigTaskOptions) GetPort() string {
...
func (o *TaskVroConfigTaskOptions) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *TaskVroConfigTaskOptions) SetVroBodyNil() {
	o.VroBody.Set(nil)
}
...
func (o *TaskVroConfigTaskOptions) SetPasswordNil() {
	o.Password.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TaskVroConfigTaskOptions) GetPasswordHashOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TaskVroConfigTaskOptions) SetPasswordHashNil() {
...
func (o *TaskVroConfigTaskOptions) SetHostNil() {
	o.Host.Set(nil)
}
...
func (o *TaskVroConfigTaskOptions) SetLocalScriptGitIdNil() {
...
func (o *TaskVroConfigTaskOptions) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o TaskVroConfigTaskOptions) MarshalJSON() ([]byte, error) {
...
type NullableTaskVroConfigTaskOptions struct {
	value *TaskVroConfigTaskOptions
	isSet bool
}

func (v NullableTaskVroConfigTaskOptions) Get() *TaskVroConfigTaskOptions {
	return v.value
}

func (v *NullableTaskVroConfigTaskOptions) Set(val *TaskVroConfigTaskOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskVroConfigTaskOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskVroConfigTaskOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskVroConfigTaskOptions(val *TaskVroConfigTaskOptions) *NullableTaskVroConfigTaskOptions {
	return &NullableTaskVroConfigTaskOptions{value: val, isSet: true}
}

func (v NullableTaskVroConfigTaskOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskVroConfigTaskOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
