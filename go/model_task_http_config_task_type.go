...
// TaskHttpConfigTaskType struct for TaskHttpConfigTaskType
type TaskHttpConfigTaskType struct {
...
func (o TaskHttpConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskHttpConfigTaskType struct {
	value *TaskHttpConfigTaskType
	isSet bool
}

func (v NullableTaskHttpConfigTaskType) Get() *TaskHttpConfigTaskType {
	return v.value
}

func (v *NullableTaskHttpConfigTaskType) Set(val *TaskHttpConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskHttpConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskHttpConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskHttpConfigTaskType(val *TaskHttpConfigTaskType) *NullableTaskHttpConfigTaskType {
	return &NullableTaskHttpConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskHttpConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskHttpConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
