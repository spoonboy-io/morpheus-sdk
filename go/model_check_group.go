...
type CheckGroup struct {
	...
	Instance NullableInlineResponse20082LoadBalancerInstanceSslCert `json:"instance,omitempty"`
...
// SetInstance gets a reference to the given NullableInlineResponse20082LoadBalancerInstanceSslCert and assigns it to the Instance field.
