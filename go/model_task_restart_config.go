...
type TaskRestartConfig struct {
	...
	TaskType *TaskRestartConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskRestartConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskRestartConfig) GetTaskType() TaskRestartConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskRestartConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskRestartConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskRestartConfig) GetTaskOptions() TaskRestartConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskRestartConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskRestartConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskRestartConfig) SetFileNil() {
	o.File.Set(nil)
}
