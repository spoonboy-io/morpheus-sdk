...
// InvoiceCloud struct for InvoiceCloud
type InvoiceCloud struct {
...
func (o InvoiceCloud) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceCloud struct {
	value *InvoiceCloud
	isSet bool
}

func (v NullableInvoiceCloud) Get() *InvoiceCloud {
	return v.value
}

func (v *NullableInvoiceCloud) Set(val *InvoiceCloud) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceCloud) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceCloud) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceCloud(val *InvoiceCloud) *NullableInvoiceCloud {
	return &NullableInvoiceCloud{value: val, isSet: true}
}

func (v NullableInvoiceCloud) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceCloud) UnmarshalJSON(src []byte) error {
	v.isSet = true
