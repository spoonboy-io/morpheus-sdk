...
// TaskVroConfigTaskType struct for TaskVroConfigTaskType
type TaskVroConfigTaskType struct {
...
func (o TaskVroConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskVroConfigTaskType struct {
	value *TaskVroConfigTaskType
	isSet bool
}

func (v NullableTaskVroConfigTaskType) Get() *TaskVroConfigTaskType {
	return v.value
}

func (v *NullableTaskVroConfigTaskType) Set(val *TaskVroConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskVroConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskVroConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskVroConfigTaskType(val *TaskVroConfigTaskType) *NullableTaskVroConfigTaskType {
	return &NullableTaskVroConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskVroConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskVroConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
