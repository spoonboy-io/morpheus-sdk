...
type IntegrationSNOW struct {
	...
	Config *IntegrationSNOWConfig `json:"config,omitempty"`
...
// SetConfig gets a reference to the given IntegrationSNOWConfig and assigns it to the Config field.
