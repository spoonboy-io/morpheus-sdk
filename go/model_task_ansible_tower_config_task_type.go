...
// TaskAnsibleTowerConfigTaskType struct for TaskAnsibleTowerConfigTaskType
type TaskAnsibleTowerConfigTaskType struct {
...
func NewTaskAnsibleTowerConfigTaskType() *TaskAnsibleTowerConfigTaskType {
	this := TaskAnsibleTowerConfigTaskType{}
	return &this
}
...
func (o TaskAnsibleTowerConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskAnsibleTowerConfigTaskType struct {
	value *TaskAnsibleTowerConfigTaskType
	isSet bool
}

func (v NullableTaskAnsibleTowerConfigTaskType) Get() *TaskAnsibleTowerConfigTaskType {
	return v.value
}

func (v *NullableTaskAnsibleTowerConfigTaskType) Set(val *TaskAnsibleTowerConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskAnsibleTowerConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskAnsibleTowerConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskAnsibleTowerConfigTaskType(val *TaskAnsibleTowerConfigTaskType) *NullableTaskAnsibleTowerConfigTaskType {
	return &NullableTaskAnsibleTowerConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskAnsibleTowerConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskAnsibleTowerConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
