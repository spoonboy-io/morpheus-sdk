...
type InlineResponse20027 struct {
	Datastore *ClusterDatastore `json:"datastore,omitempty"`
}
...
// SetDatastore gets a reference to the given ClusterDatastore and assigns it to the Datastore field.
