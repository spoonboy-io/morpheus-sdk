...
type CatalogItemType struct {
	...
	Workflow NullableInlineResponse20082LoadBalancerInstanceSslCert `json:"workflow,omitempty"`
...
// SetWorkflow gets a reference to the given NullableInlineResponse20082LoadBalancerInstanceSslCert and assigns it to the Workflow field.
