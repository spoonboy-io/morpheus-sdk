...
// PriceSetVolumeType struct for PriceSetVolumeType
type PriceSetVolumeType struct {
...
func (o PriceSetVolumeType) MarshalJSON() ([]byte, error) {
...
type NullablePriceSetVolumeType struct {
	value *PriceSetVolumeType
	isSet bool
}

func (v NullablePriceSetVolumeType) Get() *PriceSetVolumeType {
	return v.value
}

func (v *NullablePriceSetVolumeType) Set(val *PriceSetVolumeType) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceSetVolumeType) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceSetVolumeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceSetVolumeType(val *PriceSetVolumeType) *NullablePriceSetVolumeType {
	return &NullablePriceSetVolumeType{value: val, isSet: true}
}

func (v NullablePriceSetVolumeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceSetVolumeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
