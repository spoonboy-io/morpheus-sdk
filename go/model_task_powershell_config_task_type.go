...
// TaskPowershellConfigTaskType struct for TaskPowershellConfigTaskType
type TaskPowershellConfigTaskType struct {
...
func NewTaskPowershellConfigTaskType() *TaskPowershellConfigTaskType {
	this := TaskPowershellConfigTaskType{}
	return &this
}
...
func (o TaskPowershellConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskPowershellConfigTaskType struct {
	value *TaskPowershellConfigTaskType
	isSet bool
}

func (v NullableTaskPowershellConfigTaskType) Get() *TaskPowershellConfigTaskType {
	return v.value
}

func (v *NullableTaskPowershellConfigTaskType) Set(val *TaskPowershellConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskPowershellConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskPowershellConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskPowershellConfigTaskType(val *TaskPowershellConfigTaskType) *NullableTaskPowershellConfigTaskType {
	return &NullableTaskPowershellConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskPowershellConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskPowershellConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
