...
type InlineResponse200141 struct {
	Plans *[]ServerServicePlans `json:"plans,omitempty"`
}
...
// SetPlans gets a reference to the given []ServerServicePlans and assigns it to the Plans field.
