...
type TaskHttpConfig struct {
	...
	TaskType *TaskHttpConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskHttpConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskHttpConfig) GetTaskType() TaskHttpConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskHttpConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskHttpConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskHttpConfig) GetTaskOptions() TaskHttpConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskHttpConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskHttpConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskHttpConfig) SetFileNil() {
	o.File.Set(nil)
}
