...
// TaskWriteAttributesConfigTaskType struct for TaskWriteAttributesConfigTaskType
type TaskWriteAttributesConfigTaskType struct {
...
func NewTaskWriteAttributesConfigTaskType() *TaskWriteAttributesConfigTaskType {
	this := TaskWriteAttributesConfigTaskType{}
	return &this
}
...
func (o TaskWriteAttributesConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskWriteAttributesConfigTaskType struct {
	value *TaskWriteAttributesConfigTaskType
	isSet bool
}

func (v NullableTaskWriteAttributesConfigTaskType) Get() *TaskWriteAttributesConfigTaskType {
	return v.value
}

func (v *NullableTaskWriteAttributesConfigTaskType) Set(val *TaskWriteAttributesConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskWriteAttributesConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskWriteAttributesConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskWriteAttributesConfigTaskType(val *TaskWriteAttributesConfigTaskType) *NullableTaskWriteAttributesConfigTaskType {
	return &NullableTaskWriteAttributesConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskWriteAttributesConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskWriteAttributesConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
