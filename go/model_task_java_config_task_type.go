...
// TaskJavaConfigTaskType struct for TaskJavaConfigTaskType
type TaskJavaConfigTaskType struct {
...
func (o TaskJavaConfigTaskType) MarshalJSON() ([]byte, error) {
...
type NullableTaskJavaConfigTaskType struct {
	value *TaskJavaConfigTaskType
	isSet bool
}

func (v NullableTaskJavaConfigTaskType) Get() *TaskJavaConfigTaskType {
	return v.value
}

func (v *NullableTaskJavaConfigTaskType) Set(val *TaskJavaConfigTaskType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskJavaConfigTaskType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskJavaConfigTaskType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskJavaConfigTaskType(val *TaskJavaConfigTaskType) *NullableTaskJavaConfigTaskType {
	return &NullableTaskJavaConfigTaskType{value: val, isSet: true}
}

func (v NullableTaskJavaConfigTaskType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskJavaConfigTaskType) UnmarshalJSON(src []byte) error {
	v.isSet = true
