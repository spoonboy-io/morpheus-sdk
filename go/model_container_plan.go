...
// ContainerPlan struct for ContainerPlan
...
func (o ContainerPlan) MarshalJSON() ([]byte, error) {
...
type NullableContainerPlan struct {
	value *ContainerPlan
	isSet bool
}

func (v NullableContainerPlan) Get() *ContainerPlan {
	return v.value
}

func (v *NullableContainerPlan) Set(val *ContainerPlan) {
	v.value = val
	v.isSet = true
}

func (v NullableContainerPlan) IsSet() bool {
	return v.isSet
}

func (v *NullableContainerPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContainerPlan(val *ContainerPlan) *NullableContainerPlan {
	return &NullableContainerPlan{value: val, isSet: true}
}

func (v NullableContainerPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContainerPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
