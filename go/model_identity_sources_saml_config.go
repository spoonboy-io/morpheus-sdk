...
type IdentitySourcesSAMLConfig struct {
	...
	Config *IdentitySourcesSAMLConfigConfig `json:"config,omitempty"`
...
func (o *IdentitySourcesSAMLConfig) GetConfig() IdentitySourcesSAMLConfigConfig {
	if o == nil || o.Config == nil {
		var ret IdentitySourcesSAMLConfigConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given IdentitySourcesSAMLConfigConfig and assigns it to the Config field.
