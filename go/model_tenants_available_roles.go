...
type TenantsAvailableRoles struct {
	Roles *[]TenantsAvailableRolesRoles `json:"roles,omitempty"`
}
...
func (o *TenantsAvailableRoles) GetRoles() []TenantsAvailableRolesRoles {
	if o == nil || o.Roles == nil {
		var ret []TenantsAvailableRolesRoles
		return ret
	}
	return *o.Roles
}
...
// SetRoles gets a reference to the given []TenantsAvailableRolesRoles and assigns it to the Roles field.
