...
// TaskJrubyConfig struct for TaskJrubyConfig
type TaskJrubyConfig struct {
	Id *int64 `json:"id,omitempty"`
	AccountId *int64 `json:"accountId,omitempty"`
	Name *string `json:"name,omitempty"`
	Code NullableString `json:"code,omitempty"`
	TaskType *TaskJrubyConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskJrubyConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskJrubyConfig) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *TaskJrubyConfig) GetTaskType() TaskJrubyConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskJrubyConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskJrubyConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskJrubyConfig) GetTaskOptions() TaskJrubyConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskJrubyConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskJrubyConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskJrubyConfig) SetFileNil() {
	o.File.Set(nil)
}
...
func (o *TaskJrubyConfig) SetResultTypeNil() {
...
func (o TaskJrubyConfig) MarshalJSON() ([]byte, error) {
...
type NullableTaskJrubyConfig struct {
	value *TaskJrubyConfig
	isSet bool
}

func (v NullableTaskJrubyConfig) Get() *TaskJrubyConfig {
	return v.value
}

func (v *NullableTaskJrubyConfig) Set(val *TaskJrubyConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskJrubyConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskJrubyConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskJrubyConfig(val *TaskJrubyConfig) *NullableTaskJrubyConfig {
	return &NullableTaskJrubyConfig{value: val, isSet: true}
}

func (v NullableTaskJrubyConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskJrubyConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
