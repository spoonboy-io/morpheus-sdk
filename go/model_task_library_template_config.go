...
type TaskLibraryTemplateConfig struct {
	...
	TaskType *TaskLibraryTemplateConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskLibraryTemplateConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskLibraryTemplateConfig) GetTaskType() TaskLibraryTemplateConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskLibraryTemplateConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskLibraryTemplateConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskLibraryTemplateConfig) GetTaskOptions() TaskLibraryTemplateConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskLibraryTemplateConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskLibraryTemplateConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskLibraryTemplateConfig) SetFileNil() {
	o.File.Set(nil)
}
