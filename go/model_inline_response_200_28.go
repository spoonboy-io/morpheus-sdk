...
type InlineResponse20028 struct {
	Process *ClusterHistoryItem `json:"process,omitempty"`
}
...
func (o *InlineResponse20028) GetProcess() ClusterHistoryItem {
	if o == nil || o.Process == nil {
		var ret ClusterHistoryItem
		return ret
	}
	return *o.Process
}
...
func (o *InlineResponse20028) GetProcessOk() (*ClusterHistoryItem, bool) {
	if o == nil || o.Process == nil {
		return nil, false
	}
...
func (o *InlineResponse20028) HasProcess() bool {
	if o != nil && o.Process != nil {
		return true
	}
...
// SetProcess gets a reference to the given ClusterHistoryItem and assigns it to the Process field.
func (o *InlineResponse20028) SetProcess(v ClusterHistoryItem) {
	o.Process = &v
}
