...
type CatalogItemTypeWorkflowUpdate struct {
	...
	Workflow *UpdateBlueprintPermissionsRequestResourcePermissionSitesInner `json:"workflow,omitempty"`
...
// SetWorkflow gets a reference to the given UpdateBlueprintPermissionsRequestResourcePermissionSitesInner and assigns it to the Workflow field.
