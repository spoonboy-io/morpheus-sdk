...
type IntegrationChef struct {
	...
	Config *IntegrationChefConfig `json:"config,omitempty"`
...
// SetConfig gets a reference to the given IntegrationChefConfig and assigns it to the Config field.
