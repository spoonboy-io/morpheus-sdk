...
// ApiSecurityGroupsIdRulesRule struct for ApiSecurityGroupsIdRulesRule
type ApiSecurityGroupsIdRulesRule struct {
	// A name for the rule
...
func NewApiSecurityGroupsIdRulesRule(protocol string, ruleType string, ) *ApiSecurityGroupsIdRulesRule {
	this := ApiSecurityGroupsIdRulesRule{}
...
func (o ApiSecurityGroupsIdRulesRule) MarshalJSON() ([]byte, error) {
...
type NullableApiSecurityGroupsIdRulesRule struct {
	value *ApiSecurityGroupsIdRulesRule
	isSet bool
}

func (v NullableApiSecurityGroupsIdRulesRule) Get() *ApiSecurityGroupsIdRulesRule {
	return v.value
}

func (v *NullableApiSecurityGroupsIdRulesRule) Set(val *ApiSecurityGroupsIdRulesRule) {
	v.value = val
	v.isSet = true
}

func (v NullableApiSecurityGroupsIdRulesRule) IsSet() bool {
	return v.isSet
}

func (v *NullableApiSecurityGroupsIdRulesRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiSecurityGroupsIdRulesRule(val *ApiSecurityGroupsIdRulesRule) *NullableApiSecurityGroupsIdRulesRule {
	return &NullableApiSecurityGroupsIdRulesRule{value: val, isSet: true}
}

func (v NullableApiSecurityGroupsIdRulesRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiSecurityGroupsIdRulesRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
