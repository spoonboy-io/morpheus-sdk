...
type TaskEmailConfig struct {
	...
	TaskType *TaskEmailConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskEmailConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskEmailConfig) GetTaskType() TaskEmailConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskEmailConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskEmailConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskEmailConfig) GetTaskOptions() TaskEmailConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskEmailConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskEmailConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskEmailConfig) SetFileNil() {
	o.File.Set(nil)
}
