...
type TaskJavaConfig struct {
	...
	TaskType *TaskJavaConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskJavaConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskJavaConfig) GetTaskType() TaskJavaConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskJavaConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskJavaConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskJavaConfig) GetTaskOptions() TaskJavaConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskJavaConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskJavaConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskJavaConfig) SetFileNil() {
	o.File.Set(nil)
}
