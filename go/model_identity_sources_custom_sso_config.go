...
type IdentitySourcesCustomSSOConfig struct {
	...
	Config *IdentitySourcesCustomSSOConfigConfig `json:"config,omitempty"`
...
func (o *IdentitySourcesCustomSSOConfig) GetConfig() IdentitySourcesCustomSSOConfigConfig {
	if o == nil || o.Config == nil {
		var ret IdentitySourcesCustomSSOConfigConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given IdentitySourcesCustomSSOConfigConfig and assigns it to the Config field.
