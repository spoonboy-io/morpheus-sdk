...
// BackupBackupType struct for BackupBackupType
type BackupBackupType struct {
	// Backup Type ID
...
func (o BackupBackupType) MarshalJSON() ([]byte, error) {
...
type NullableBackupBackupType struct {
	value *BackupBackupType
	isSet bool
}

func (v NullableBackupBackupType) Get() *BackupBackupType {
	return v.value
}

func (v *NullableBackupBackupType) Set(val *BackupBackupType) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupBackupType) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupBackupType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupBackupType(val *BackupBackupType) *NullableBackupBackupType {
	return &NullableBackupBackupType{value: val, isSet: true}
}

func (v NullableBackupBackupType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupBackupType) UnmarshalJSON(src []byte) error {
	v.isSet = true
