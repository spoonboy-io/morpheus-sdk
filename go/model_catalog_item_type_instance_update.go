...
type CatalogItemTypeInstanceUpdate struct {
	...
	Config *CatalogItemTypeInstanceScribe `json:"config,omitempty"`
...
func (o *CatalogItemTypeInstanceUpdate) GetConfig() CatalogItemTypeInstanceScribe {
	if o == nil || o.Config == nil {
		var ret CatalogItemTypeInstanceScribe
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given CatalogItemTypeInstanceScribe and assigns it to the Config field.
