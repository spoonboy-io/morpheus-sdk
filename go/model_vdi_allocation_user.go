...
// VdiAllocationUser struct for VdiAllocationUser
type VdiAllocationUser struct {
...
func (o VdiAllocationUser) MarshalJSON() ([]byte, error) {
...
type NullableVdiAllocationUser struct {
	value *VdiAllocationUser
	isSet bool
}

func (v NullableVdiAllocationUser) Get() *VdiAllocationUser {
	return v.value
}

func (v *NullableVdiAllocationUser) Set(val *VdiAllocationUser) {
	v.value = val
	v.isSet = true
}

func (v NullableVdiAllocationUser) IsSet() bool {
	return v.isSet
}

func (v *NullableVdiAllocationUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVdiAllocationUser(val *VdiAllocationUser) *NullableVdiAllocationUser {
	return &NullableVdiAllocationUser{value: val, isSet: true}
}

func (v NullableVdiAllocationUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVdiAllocationUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
