...
type TaskShellConfig struct {
	...
	TaskType *TaskShellConfigTaskType `json:"taskType,omitempty"`
	Labels *[]string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *TaskShellConfigTaskOptions `json:"taskOptions,omitempty"`
...
func (o *TaskShellConfig) GetTaskType() TaskShellConfigTaskType {
	if o == nil || o.TaskType == nil {
		var ret TaskShellConfigTaskType
		return ret
	}
	return *o.TaskType
}
...
// SetTaskType gets a reference to the given TaskShellConfigTaskType and assigns it to the TaskType field.
...
func (o *TaskShellConfig) GetTaskOptions() TaskShellConfigTaskOptions {
	if o == nil || o.TaskOptions == nil {
		var ret TaskShellConfigTaskOptions
		return ret
	}
...
// SetTaskOptions gets a reference to the given TaskShellConfigTaskOptions and assigns it to the TaskOptions field.
...
func (o *TaskShellConfig) SetFileNil() {
	o.File.Set(nil)
}
