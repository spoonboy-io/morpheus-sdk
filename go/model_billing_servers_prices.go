...
// BillingServersPrices struct for BillingServersPrices
type BillingServersPrices struct {
...
func (o BillingServersPrices) MarshalJSON() ([]byte, error) {
...
type NullableBillingServersPrices struct {
	value *BillingServersPrices
	isSet bool
}

func (v NullableBillingServersPrices) Get() *BillingServersPrices {
	return v.value
}

func (v *NullableBillingServersPrices) Set(val *BillingServersPrices) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingServersPrices) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingServersPrices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingServersPrices(val *BillingServersPrices) *NullableBillingServersPrices {
	return &NullableBillingServersPrices{value: val, isSet: true}
}

func (v NullableBillingServersPrices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingServersPrices) UnmarshalJSON(src []byte) error {
	v.isSet = true
