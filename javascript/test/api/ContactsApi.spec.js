...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ContactsApi();
  });
  ...
  describe('ContactsApi', function() {
    describe('addContacts', function() {
      it('should call addContacts successfully', function(done) {
        //uncomment below and update the code to test addContacts
        //instance.addContacts(function(error) {
    ...
    describe('deleteContacts', function() {
      it('should call deleteContacts successfully', function(done) {
        //uncomment below and update the code to test deleteContacts
        //instance.deleteContacts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
