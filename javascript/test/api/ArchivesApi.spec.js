...
(function(root, factory) {
  ...
  describe('ArchivesApi', function() {
    ...
    describe('getArchivePublicFile', function() {
      it('should call getArchivePublicFile successfully', function(done) {
        //uncomment below and update the code to test getArchivePublicFile
        //instance.getArchivePublicFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getArchivePublicFileLink', function() {
      it('should call getArchivePublicFileLink successfully', function(done) {
        //uncomment below and update the code to test getArchivePublicFileLink
        //instance.getArchivePublicFileLink(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
