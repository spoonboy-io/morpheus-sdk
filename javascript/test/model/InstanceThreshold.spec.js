...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceThreshold();
  });
  ...
  describe('InstanceThreshold', function() {
    it('should create an instance of InstanceThreshold', function() {
      // uncomment below and update the code to test InstanceThreshold
      //var instane = new MorpheusApi.InstanceThreshold();
      //expect(instance).to.be.a(MorpheusApi.InstanceThreshold);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InstanceThreshold();
    ...
    it('should have the property minNetwork (base name: "minNetwork")', function() {
      // uncomment below and update the code to test the property minNetwork
      //var instance = new MorpheusApi.InstanceThreshold();
      //expect(instance).to.be();
    });

    it('should have the property networkEnabled (base name: "networkEnabled")', function() {
      // uncomment below and update the code to test the property networkEnabled
      //var instance = new MorpheusApi.InstanceThreshold();
      //expect(instance).to.be();
    });

    it('should have the property iopsEnabled (base name: "iopsEnabled")', function() {
      // uncomment below and update the code to test the property iopsEnabled
      //var instance = new MorpheusApi.InstanceThreshold();
      //expect(instance).to.be();
    });
