...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20025();
  });
  ...
  describe('InlineResponse20025', function() {
    it('should create an instance of InlineResponse20025', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20025();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20025);
    });
    ...
    it('should have the property layout (base name: "layout")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20025();
