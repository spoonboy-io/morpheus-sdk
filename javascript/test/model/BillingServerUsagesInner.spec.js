...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingServerUsagesInner();
  });
  ...
  describe('BillingServerUsagesInner', function() {
    it('should create an instance of BillingServerUsagesInner', function() {
      // uncomment below and update the code to test BillingServerUsagesInner
      //var instance = new MorpheusApi.BillingServerUsagesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingServerUsagesInner);
    });
