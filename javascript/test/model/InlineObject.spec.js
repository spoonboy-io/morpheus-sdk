...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new MorpheusApi.InlineObject();
      //expect(instance).to.be.a(MorpheusApi.InlineObject);
    });

    it('should have the property alert (base name: "alert")', function() {
      // uncomment below and update the code to test the property alert
      //var instance = new MorpheusApi.InlineObject();
