...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiServicePlansIdServicePlan();
  });
  ...
  describe('ApiServicePlansIdServicePlan', function() {
    it('should create an instance of ApiServicePlansIdServicePlan', function() {
      // uncomment below and update the code to test ApiServicePlansIdServicePlan
      //var instane = new MorpheusApi.ApiServicePlansIdServicePlan();
      //expect(instance).to.be.a(MorpheusApi.ApiServicePlansIdServicePlan);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiServicePlansIdServicePlan();
