...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterDatastoresPermissionsResourcePermissions();
  });
  ...
  describe('ClusterDatastoresPermissionsResourcePermissions', function() {
    it('should create an instance of ClusterDatastoresPermissionsResourcePermissions', function() {
      // uncomment below and update the code to test ClusterDatastoresPermissionsResourcePermissions
      //var instane = new MorpheusApi.ClusterDatastoresPermissionsResourcePermissions();
      //expect(instance).to.be.a(MorpheusApi.ClusterDatastoresPermissionsResourcePermissions);
    });
    ...
    it('should have the property defaultStore (base name: "defaultStore")', function() {
      ...
      //var instance = new MorpheusApi.ClusterDatastoresPermissionsResourcePermissions();
