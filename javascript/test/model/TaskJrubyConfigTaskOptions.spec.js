...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskJrubyConfigTaskOptions();
  });
  ...
  describe('TaskJrubyConfigTaskOptions', function() {
    it('should create an instance of TaskJrubyConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskJrubyConfigTaskOptions
      //var instane = new MorpheusApi.TaskJrubyConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskJrubyConfigTaskOptions);
    });

    it('should have the property host (base name: "host")', function() {
      // uncomment below and update the code to test the property host
      //var instance = new MorpheusApi.TaskJrubyConfigTaskOptions();
