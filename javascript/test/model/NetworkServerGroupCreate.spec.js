...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkServerGroupCreate();
  });
  ...
  describe('NetworkServerGroupCreate', function() {
    it('should create an instance of NetworkServerGroupCreate', function() {
      // uncomment below and update the code to test NetworkServerGroupCreate
      //var instane = new MorpheusApi.NetworkServerGroupCreate();
      //expect(instance).to.be.a(MorpheusApi.NetworkServerGroupCreate);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkServerGroupCreate();
