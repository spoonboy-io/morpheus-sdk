...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20010();
  });
  ...
  describe('InlineResponse20010', function() {
    it('should create an instance of InlineResponse20010', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20010();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20010);
    });
    ...
    it('should have the property backup (base name: "backup")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20010();
