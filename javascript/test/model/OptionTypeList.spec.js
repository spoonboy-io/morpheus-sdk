...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.OptionTypeList();
  });
  ...
  describe('OptionTypeList', function() {
    it('should create an instance of OptionTypeList', function() {
      // uncomment below and update the code to test OptionTypeList
      //var instane = new MorpheusApi.OptionTypeList();
      //expect(instance).to.be.a(MorpheusApi.OptionTypeList);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.OptionTypeList();
