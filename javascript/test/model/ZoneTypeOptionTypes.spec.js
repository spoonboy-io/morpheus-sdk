...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ZoneTypeOptionTypes();
  });
  ...
  describe('ZoneTypeOptionTypes', function() {
    it('should create an instance of ZoneTypeOptionTypes', function() {
      // uncomment below and update the code to test ZoneTypeOptionTypes
      //var instane = new MorpheusApi.ZoneTypeOptionTypes();
      //expect(instance).to.be.a(MorpheusApi.ZoneTypeOptionTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ZoneTypeOptionTypes();
