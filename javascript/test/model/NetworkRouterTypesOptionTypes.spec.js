...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkRouterTypesOptionTypes();
  });
  ...
  describe('NetworkRouterTypesOptionTypes', function() {
    it('should create an instance of NetworkRouterTypesOptionTypes', function() {
      // uncomment below and update the code to test NetworkRouterTypesOptionTypes
      //var instane = new MorpheusApi.NetworkRouterTypesOptionTypes();
      //expect(instance).to.be.a(MorpheusApi.NetworkRouterTypesOptionTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkRouterTypesOptionTypes();
