...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.OptionTypeCreate();
  });
  ...
  describe('OptionTypeCreate', function() {
    it('should create an instance of OptionTypeCreate', function() {
      // uncomment below and update the code to test OptionTypeCreate
      //var instane = new MorpheusApi.OptionTypeCreate();
      //expect(instance).to.be.a(MorpheusApi.OptionTypeCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.OptionTypeCreate();
