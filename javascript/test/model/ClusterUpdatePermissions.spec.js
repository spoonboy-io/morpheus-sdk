...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterUpdatePermissions();
  });
  ...
  describe('ClusterUpdatePermissions', function() {
    it('should create an instance of ClusterUpdatePermissions', function() {
      // uncomment below and update the code to test ClusterUpdatePermissions
      //var instane = new MorpheusApi.ClusterUpdatePermissions();
      //expect(instance).to.be.a(MorpheusApi.ClusterUpdatePermissions);
    });
    ...
    it('should have the property resourcePermissions (base name: "resourcePermissions")', function() {
      ...
      //var instance = new MorpheusApi.ClusterUpdatePermissions();
