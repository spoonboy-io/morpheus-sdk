...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ResetPasswordRequest();
  });
  ...
  describe('ResetPasswordRequest', function() {
    it('should create an instance of ResetPasswordRequest', function() {
      ...
      //var instance = new MorpheusApi.ResetPasswordRequest();
      //expect(instance).to.be.a(MorpheusApi.ResetPasswordRequest);
    });
