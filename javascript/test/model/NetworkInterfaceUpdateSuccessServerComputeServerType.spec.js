...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerComputeServerType();
  });
  ...
  describe('NetworkInterfaceUpdateSuccessServerComputeServerType', function() {
    it('should create an instance of NetworkInterfaceUpdateSuccessServerComputeServerType', function() {
      // uncomment below and update the code to test NetworkInterfaceUpdateSuccessServerComputeServerType
      //var instane = new MorpheusApi.NetworkInterfaceUpdateSuccessServerComputeServerType();
      //expect(instance).to.be.a(MorpheusApi.NetworkInterfaceUpdateSuccessServerComputeServerType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerComputeServerType();
