...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServicePlan();
  });
  ...
  describe('ServicePlan', function() {
    it('should create an instance of ServicePlan', function() {
      ...
      //var instane = new MorpheusApi.ServicePlan();
      //expect(instance).to.be.a(MorpheusApi.ServicePlan);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ServicePlan();
