...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiServicePlansIdServicePlanConfigRanges();
  });
  ...
  describe('ApiServicePlansIdServicePlanConfigRanges', function() {
    it('should create an instance of ApiServicePlansIdServicePlanConfigRanges', function() {
      // uncomment below and update the code to test ApiServicePlansIdServicePlanConfigRanges
      //var instane = new MorpheusApi.ApiServicePlansIdServicePlanConfigRanges();
      //expect(instance).to.be.a(MorpheusApi.ApiServicePlansIdServicePlanConfigRanges);
    });
    ...
    it('should have the property minStorage (base name: "minStorage")', function() {
      ...
      //var instance = new MorpheusApi.ApiServicePlansIdServicePlanConfigRanges();
