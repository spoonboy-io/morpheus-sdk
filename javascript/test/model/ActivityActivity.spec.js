...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ActivityActivity();
  });
  ...
  describe('ActivityActivity', function() {
    it('should create an instance of ActivityActivity', function() {
      // uncomment below and update the code to test ActivityActivity
      //var instane = new MorpheusApi.ActivityActivity();
      //expect(instance).to.be.a(MorpheusApi.ActivityActivity);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ActivityActivity();
