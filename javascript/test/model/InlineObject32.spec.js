...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject32();
  });
  ...
  describe('InlineObject32', function() {
    it('should create an instance of InlineObject32', function() {
      ...
      //var instane = new MorpheusApi.InlineObject32();
      //expect(instance).to.be.a(MorpheusApi.InlineObject32);
    });

    it('should have the property muted (base name: "muted")', function() {
      // uncomment below and update the code to test the property muted
      //var instance = new MorpheusApi.InlineObject32();
