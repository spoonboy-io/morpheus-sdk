...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.UserSourceCreateOneLogin();
  });
  ...
  describe('UserSourceCreateOneLogin', function() {
    it('should create an instance of UserSourceCreateOneLogin', function() {
      // uncomment below and update the code to test UserSourceCreateOneLogin
      //var instane = new MorpheusApi.UserSourceCreateOneLogin();
      //expect(instance).to.be.a(MorpheusApi.UserSourceCreateOneLogin);
    });
    ...
    it('should have the property subdomain (base name: "subdomain")', function() {
      ...
      //var instance = new MorpheusApi.UserSourceCreateOneLogin();
