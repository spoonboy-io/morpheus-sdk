...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServicePlanPermissionsResourcePermissions();
  });
  ...
  describe('ServicePlanPermissionsResourcePermissions', function() {
    it('should create an instance of ServicePlanPermissionsResourcePermissions', function() {
      // uncomment below and update the code to test ServicePlanPermissionsResourcePermissions
      //var instane = new MorpheusApi.ServicePlanPermissionsResourcePermissions();
      //expect(instance).to.be.a(MorpheusApi.ServicePlanPermissionsResourcePermissions);
    });
    ...
    it('should have the property defaultStore (base name: "defaultStore")', function() {
      ...
      //var instance = new MorpheusApi.ServicePlanPermissionsResourcePermissions();
