...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BlueprintARMCreateArmGit();
  });
  ...
  describe('BlueprintARMCreateArmGit', function() {
    it('should create an instance of BlueprintARMCreateArmGit', function() {
      // uncomment below and update the code to test BlueprintARMCreateArmGit
      //var instane = new MorpheusApi.BlueprintARMCreateArmGit();
      //expect(instance).to.be.a(MorpheusApi.BlueprintARMCreateArmGit);
    });
    ...
    it('should have the property repoId (base name: "repoId")', function() {
      ...
      //var instance = new MorpheusApi.BlueprintARMCreateArmGit();
