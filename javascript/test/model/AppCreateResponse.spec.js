...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.AppCreateResponse();
  });
  ...
  describe('AppCreateResponse', function() {
    it('should create an instance of AppCreateResponse', function() {
      // uncomment below and update the code to test AppCreateResponse
      //var instane = new MorpheusApi.AppCreateResponse();
      //expect(instance).to.be.a(MorpheusApi.AppCreateResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.AppCreateResponse();
