...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.UserAccess();
  });
  ...
  describe('UserAccess', function() {
    it('should create an instance of UserAccess', function() {
      ...
      //var instane = new MorpheusApi.UserAccess();
      //expect(instance).to.be.a(MorpheusApi.UserAccess);
    });

    it('should have the property features (base name: "features")', function() {
      // uncomment below and update the code to test the property features
      //var instance = new MorpheusApi.UserAccess();
