...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiPriceSetsPriceSet();
  });
  ...
  describe('ApiPriceSetsPriceSet', function() {
    it('should create an instance of ApiPriceSetsPriceSet', function() {
      // uncomment below and update the code to test ApiPriceSetsPriceSet
      //var instane = new MorpheusApi.ApiPriceSetsPriceSet();
      //expect(instance).to.be.a(MorpheusApi.ApiPriceSetsPriceSet);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiPriceSetsPriceSet();
