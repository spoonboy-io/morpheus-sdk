...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiStorageBucketsStorageBucket();
  });
  ...
  describe('ApiStorageBucketsStorageBucket', function() {
    it('should create an instance of ApiStorageBucketsStorageBucket', function() {
      // uncomment below and update the code to test ApiStorageBucketsStorageBucket
      //var instane = new MorpheusApi.ApiStorageBucketsStorageBucket();
      //expect(instance).to.be.a(MorpheusApi.ApiStorageBucketsStorageBucket);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiStorageBucketsStorageBucket();
