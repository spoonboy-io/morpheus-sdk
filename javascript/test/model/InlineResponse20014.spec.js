...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20014();
  });
  ...
  describe('InlineResponse20014', function() {
    it('should create an instance of InlineResponse20014', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20014();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20014);
    });
    ...
    it('should have the property blueprint (base name: "blueprint")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20014();
