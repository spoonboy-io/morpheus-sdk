...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.VirtualImageOsType();
  });
  ...
  describe('VirtualImageOsType', function() {
    it('should create an instance of VirtualImageOsType', function() {
      // uncomment below and update the code to test VirtualImageOsType
      //var instane = new MorpheusApi.VirtualImageOsType();
      //expect(instance).to.be.a(MorpheusApi.VirtualImageOsType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.VirtualImageOsType();
