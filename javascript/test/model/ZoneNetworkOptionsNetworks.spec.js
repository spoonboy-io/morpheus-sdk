...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ZoneNetworkOptionsNetworks();
  });
  ...
  describe('ZoneNetworkOptionsNetworks', function() {
    it('should create an instance of ZoneNetworkOptionsNetworks', function() {
      // uncomment below and update the code to test ZoneNetworkOptionsNetworks
      //var instane = new MorpheusApi.ZoneNetworkOptionsNetworks();
      //expect(instance).to.be.a(MorpheusApi.ZoneNetworkOptionsNetworks);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ZoneNetworkOptionsNetworks();
