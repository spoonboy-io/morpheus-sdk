...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationPowerDNS();
  });
  ...
  describe('IntegrationPowerDNS', function() {
    it('should create an instance of IntegrationPowerDNS', function() {
      // uncomment below and update the code to test IntegrationPowerDNS
      //var instane = new MorpheusApi.IntegrationPowerDNS();
      //expect(instance).to.be.a(MorpheusApi.IntegrationPowerDNS);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationPowerDNS();
