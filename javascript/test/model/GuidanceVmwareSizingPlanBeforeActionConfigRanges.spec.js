...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeActionConfigRanges();
  });
  ...
  describe('GuidanceVmwareSizingPlanBeforeActionConfigRanges', function() {
    it('should create an instance of GuidanceVmwareSizingPlanBeforeActionConfigRanges', function() {
      // uncomment below and update the code to test GuidanceVmwareSizingPlanBeforeActionConfigRanges
      //var instane = new MorpheusApi.GuidanceVmwareSizingPlanBeforeActionConfigRanges();
      //expect(instance).to.be.a(MorpheusApi.GuidanceVmwareSizingPlanBeforeActionConfigRanges);
    });
    ...
    it('should have the property minStorage (base name: "minStorage")', function() {
      ...
      //var instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeActionConfigRanges();
