...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20011();
  });
  ...
  describe('InlineResponse20011', function() {
    it('should create an instance of InlineResponse20011', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20011();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20011);
    });

    it('should have the property job (base name: "job")', function() {
      // uncomment below and update the code to test the property job
      //var instance = new MorpheusApi.InlineResponse20011();
