...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiMonitoringAppsIdMonitorApp();
  });
  ...
  describe('ApiMonitoringAppsIdMonitorApp', function() {
    it('should create an instance of ApiMonitoringAppsIdMonitorApp', function() {
      // uncomment below and update the code to test ApiMonitoringAppsIdMonitorApp
      //var instane = new MorpheusApi.ApiMonitoringAppsIdMonitorApp();
      //expect(instance).to.be.a(MorpheusApi.ApiMonitoringAppsIdMonitorApp);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiMonitoringAppsIdMonitorApp();
