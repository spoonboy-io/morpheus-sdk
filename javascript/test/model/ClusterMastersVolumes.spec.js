...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterMastersVolumes();
  });
  ...
  describe('ClusterMastersVolumes', function() {
    it('should create an instance of ClusterMastersVolumes', function() {
      // uncomment below and update the code to test ClusterMastersVolumes
      //var instane = new MorpheusApi.ClusterMastersVolumes();
      //expect(instance).to.be.a(MorpheusApi.ClusterMastersVolumes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterMastersVolumes();
