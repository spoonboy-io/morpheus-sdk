...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20030();
  });
  ...
  describe('InlineResponse20030', function() {
    it('should create an instance of InlineResponse20030', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20030();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20030);
    });
    ...
    it('should have the property masters (base name: "masters")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20030();
