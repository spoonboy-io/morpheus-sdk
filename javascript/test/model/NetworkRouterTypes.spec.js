...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkRouterTypes();
  });
  ...
  describe('NetworkRouterTypes', function() {
    it('should create an instance of NetworkRouterTypes', function() {
      // uncomment below and update the code to test NetworkRouterTypes
      //var instane = new MorpheusApi.NetworkRouterTypes();
      //expect(instance).to.be.a(MorpheusApi.NetworkRouterTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkRouterTypes();
