...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ProvisioningSettingsUpdate();
  });
  ...
  describe('ProvisioningSettingsUpdate', function() {
    it('should create an instance of ProvisioningSettingsUpdate', function() {
      // uncomment below and update the code to test ProvisioningSettingsUpdate
      //var instane = new MorpheusApi.ProvisioningSettingsUpdate();
      //expect(instance).to.be.a(MorpheusApi.ProvisioningSettingsUpdate);
    });
    ...
    it('should have the property allowZoneSelection (base name: "allowZoneSelection")', function() {
      ...
      //var instance = new MorpheusApi.ProvisioningSettingsUpdate();
