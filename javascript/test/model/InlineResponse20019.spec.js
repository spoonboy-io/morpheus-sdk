...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20019();
  });
  ...
  describe('InlineResponse20019', function() {
    it('should create an instance of InlineResponse20019', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20019();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20019);
    });
    ...
    it('should have the property checkGroup (base name: "checkGroup")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20019();
