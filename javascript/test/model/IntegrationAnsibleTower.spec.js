...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationAnsibleTower();
  });
  ...
  describe('IntegrationAnsibleTower', function() {
    it('should create an instance of IntegrationAnsibleTower', function() {
      // uncomment below and update the code to test IntegrationAnsibleTower
      //var instane = new MorpheusApi.IntegrationAnsibleTower();
      //expect(instance).to.be.a(MorpheusApi.IntegrationAnsibleTower);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationAnsibleTower();
