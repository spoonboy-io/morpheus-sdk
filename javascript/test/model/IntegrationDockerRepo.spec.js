...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationDockerRepo();
  });
  ...
  describe('IntegrationDockerRepo', function() {
    it('should create an instance of IntegrationDockerRepo', function() {
      // uncomment below and update the code to test IntegrationDockerRepo
      //var instane = new MorpheusApi.IntegrationDockerRepo();
      //expect(instance).to.be.a(MorpheusApi.IntegrationDockerRepo);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationDockerRepo();
