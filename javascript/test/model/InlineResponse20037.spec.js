...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20037();
  });
  ...
  describe('InlineResponse20037', function() {
    it('should create an instance of InlineResponse20037', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20037();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20037);
    });
    ...
    it('should have the property credential (base name: "credential")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20037();
