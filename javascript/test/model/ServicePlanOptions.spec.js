...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServicePlanOptions();
  });
  ...
  describe('ServicePlanOptions', function() {
    it('should create an instance of ServicePlanOptions', function() {
      // uncomment below and update the code to test ServicePlanOptions
      //var instane = new MorpheusApi.ServicePlanOptions();
      //expect(instance).to.be.a(MorpheusApi.ServicePlanOptions);
    });
    ...
    it('should have the property maxCores (base name: "maxCores")', function() {
      ...
      //var instance = new MorpheusApi.ServicePlanOptions();
