...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationRoute53();
  });
  ...
  describe('IntegrationRoute53', function() {
    it('should create an instance of IntegrationRoute53', function() {
      // uncomment below and update the code to test IntegrationRoute53
      //var instane = new MorpheusApi.IntegrationRoute53();
      //expect(instance).to.be.a(MorpheusApi.IntegrationRoute53);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationRoute53();
