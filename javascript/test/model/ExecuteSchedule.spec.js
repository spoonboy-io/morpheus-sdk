...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ExecuteSchedule();
  });
  ...
  describe('ExecuteSchedule', function() {
    it('should create an instance of ExecuteSchedule', function() {
      // uncomment below and update the code to test ExecuteSchedule
      //var instane = new MorpheusApi.ExecuteSchedule();
      //expect(instance).to.be.a(MorpheusApi.ExecuteSchedule);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ExecuteSchedule();
