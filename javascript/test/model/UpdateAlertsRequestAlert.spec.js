...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.UpdateAlertsRequestAlert();
  });
  ...
  describe('UpdateAlertsRequestAlert', function() {
    it('should create an instance of UpdateAlertsRequestAlert', function() {
      // uncomment below and update the code to test UpdateAlertsRequestAlert
      //var instance = new MorpheusApi.UpdateAlertsRequestAlert();
      //expect(instance).to.be.a(MorpheusApi.UpdateAlertsRequestAlert);
    });
