...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskRestartConfig();
  });
  ...
  describe('TaskRestartConfig', function() {
    it('should create an instance of TaskRestartConfig', function() {
      // uncomment below and update the code to test TaskRestartConfig
      //var instane = new MorpheusApi.TaskRestartConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskRestartConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskRestartConfig();
