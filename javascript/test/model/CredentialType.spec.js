...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CredentialType();
  });
  ...
  describe('CredentialType', function() {
    it('should create an instance of CredentialType', function() {
      ...
      //var instane = new MorpheusApi.CredentialType();
      //expect(instance).to.be.a(MorpheusApi.CredentialType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.CredentialType();
