...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceResize();
  });
  ...
  describe('InstanceResize', function() {
    it('should create an instance of InstanceResize', function() {
      // uncomment below and update the code to test InstanceResize
      //var instane = new MorpheusApi.InstanceResize();
      //expect(instance).to.be.a(MorpheusApi.InstanceResize);
    });
    ...
    it('should have the property instance (base name: "instance")', function() {
      ...
      //var instance = new MorpheusApi.InstanceResize();
