...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiMonitoringAlertsAlert();
  });
  ...
  describe('ApiMonitoringAlertsAlert', function() {
    it('should create an instance of ApiMonitoringAlertsAlert', function() {
      // uncomment below and update the code to test ApiMonitoringAlertsAlert
      //var instane = new MorpheusApi.ApiMonitoringAlertsAlert();
      //expect(instance).to.be.a(MorpheusApi.ApiMonitoringAlertsAlert);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiMonitoringAlertsAlert();
