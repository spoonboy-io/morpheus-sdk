...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationAnsibleConfigIntegration();
  });
  ...
  describe('IntegrationAnsibleConfigIntegration', function() {
    it('should create an instance of IntegrationAnsibleConfigIntegration', function() {
      // uncomment below and update the code to test IntegrationAnsibleConfigIntegration
      //var instane = new MorpheusApi.IntegrationAnsibleConfigIntegration();
      //expect(instance).to.be.a(MorpheusApi.IntegrationAnsibleConfigIntegration);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.IntegrationAnsibleConfigIntegration();
