...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationSNOW();
  });
  ...
  describe('IntegrationSNOW', function() {
    it('should create an instance of IntegrationSNOW', function() {
      // uncomment below and update the code to test IntegrationSNOW
      //var instane = new MorpheusApi.IntegrationSNOW();
      //expect(instance).to.be.a(MorpheusApi.IntegrationSNOW);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationSNOW();
