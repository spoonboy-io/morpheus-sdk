...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20017();
  });
  ...
  describe('InlineResponse20017', function() {
    it('should create an instance of InlineResponse20017', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20017();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20017);
    });

    it('should have the property check (base name: "check")', function() {
      // uncomment below and update the code to test the property check
      //var instance = new MorpheusApi.InlineResponse20017();
