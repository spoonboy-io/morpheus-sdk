...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20024();
  });
  ...
  describe('InlineResponse20024', function() {
    it('should create an instance of InlineResponse20024', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20024();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20024);
    });
    ...
    it('should have the property resourcePool (base name: "resourcePool")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20024();
