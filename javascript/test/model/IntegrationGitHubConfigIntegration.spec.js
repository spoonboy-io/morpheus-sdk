...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationGitHubConfigIntegration();
  });
  ...
  describe('IntegrationGitHubConfigIntegration', function() {
    it('should create an instance of IntegrationGitHubConfigIntegration', function() {
      // uncomment below and update the code to test IntegrationGitHubConfigIntegration
      //var instane = new MorpheusApi.IntegrationGitHubConfigIntegration();
      //expect(instance).to.be.a(MorpheusApi.IntegrationGitHubConfigIntegration);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.IntegrationGitHubConfigIntegration();
