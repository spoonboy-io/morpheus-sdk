...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceCreateSuccessInstance();
  });
  ...
  describe('InstanceCreateSuccessInstance', function() {
    it('should create an instance of InstanceCreateSuccessInstance', function() {
      // uncomment below and update the code to test InstanceCreateSuccessInstance
      //var instane = new MorpheusApi.InstanceCreateSuccessInstance();
      //expect(instance).to.be.a(MorpheusApi.InstanceCreateSuccessInstance);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.InstanceCreateSuccessInstance();
