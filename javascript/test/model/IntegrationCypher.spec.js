...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationCypher();
  });
  ...
  describe('IntegrationCypher', function() {
    it('should create an instance of IntegrationCypher', function() {
      // uncomment below and update the code to test IntegrationCypher
      //var instane = new MorpheusApi.IntegrationCypher();
      //expect(instance).to.be.a(MorpheusApi.IntegrationCypher);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationCypher();
