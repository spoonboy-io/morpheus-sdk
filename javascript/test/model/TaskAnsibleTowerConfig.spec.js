...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskAnsibleTowerConfig();
  });
  ...
  describe('TaskAnsibleTowerConfig', function() {
    it('should create an instance of TaskAnsibleTowerConfig', function() {
      // uncomment below and update the code to test TaskAnsibleTowerConfig
      //var instane = new MorpheusApi.TaskAnsibleTowerConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskAnsibleTowerConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskAnsibleTowerConfig();
