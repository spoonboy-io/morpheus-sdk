...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterCreate();
  });
  ...
  describe('ClusterCreate', function() {
    it('should create an instance of ClusterCreate', function() {
      ...
      //var instane = new MorpheusApi.ClusterCreate();
      //expect(instance).to.be.a(MorpheusApi.ClusterCreate);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new MorpheusApi.ClusterCreate();
