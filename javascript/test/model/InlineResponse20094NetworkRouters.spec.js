...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20094NetworkRouters();
  });
  ...
  describe('InlineResponse20094NetworkRouters', function() {
    it('should create an instance of InlineResponse20094NetworkRouters', function() {
      // uncomment below and update the code to test InlineResponse20094NetworkRouters
      //var instane = new MorpheusApi.InlineResponse20094NetworkRouters();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20094NetworkRouters);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse20094NetworkRouters();
