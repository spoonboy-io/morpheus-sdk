...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.WorkflowTaskFile();
  });
  ...
  describe('WorkflowTaskFile', function() {
    it('should create an instance of WorkflowTaskFile', function() {
      // uncomment below and update the code to test WorkflowTaskFile
      //var instane = new MorpheusApi.WorkflowTaskFile();
      //expect(instance).to.be.a(MorpheusApi.WorkflowTaskFile);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.WorkflowTaskFile();
