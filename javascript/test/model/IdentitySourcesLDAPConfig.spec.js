...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesLDAPConfig();
  });
  ...
  describe('IdentitySourcesLDAPConfig', function() {
    it('should create an instance of IdentitySourcesLDAPConfig', function() {
      // uncomment below and update the code to test IdentitySourcesLDAPConfig
      //var instane = new MorpheusApi.IdentitySourcesLDAPConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesLDAPConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesLDAPConfig();
