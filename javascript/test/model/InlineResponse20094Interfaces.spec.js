...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20094Interfaces();
  });
  ...
  describe('InlineResponse20094Interfaces', function() {
    it('should create an instance of InlineResponse20094Interfaces', function() {
      // uncomment below and update the code to test InlineResponse20094Interfaces
      //var instane = new MorpheusApi.InlineResponse20094Interfaces();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20094Interfaces);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse20094Interfaces();
