...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ProvisionTypes();
  });
  ...
  describe('ProvisionTypes', function() {
    it('should create an instance of ProvisionTypes', function() {
      // uncomment below and update the code to test ProvisionTypes
      //var instane = new MorpheusApi.ProvisionTypes();
      //expect(instance).to.be.a(MorpheusApi.ProvisionTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ProvisionTypes();
