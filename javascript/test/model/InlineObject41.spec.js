...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject41();
  });
  ...
  describe('InlineObject41', function() {
    it('should create an instance of InlineObject41', function() {
      ...
      //var instane = new MorpheusApi.InlineObject41();
      //expect(instance).to.be.a(MorpheusApi.InlineObject41);
    });

    it('should have the property zone (base name: "zone")', function() {
      // uncomment below and update the code to test the property zone
      //var instance = new MorpheusApi.InlineObject41();
