...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskAnsiblePlaybookConfig();
  });
  ...
  describe('TaskAnsiblePlaybookConfig', function() {
    it('should create an instance of TaskAnsiblePlaybookConfig', function() {
      // uncomment below and update the code to test TaskAnsiblePlaybookConfig
      //var instane = new MorpheusApi.TaskAnsiblePlaybookConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskAnsiblePlaybookConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskAnsiblePlaybookConfig();
