...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesOneLoginConfig();
  });
  ...
  describe('IdentitySourcesOneLoginConfig', function() {
    it('should create an instance of IdentitySourcesOneLoginConfig', function() {
      // uncomment below and update the code to test IdentitySourcesOneLoginConfig
      //var instane = new MorpheusApi.IdentitySourcesOneLoginConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesOneLoginConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesOneLoginConfig();
