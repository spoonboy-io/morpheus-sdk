...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterDatastorePermissionsResourcePermissions();
  });
  ...
  describe('ClusterDatastorePermissionsResourcePermissions', function() {
    it('should create an instance of ClusterDatastorePermissionsResourcePermissions', function() {
      // uncomment below and update the code to test ClusterDatastorePermissionsResourcePermissions
      //var instane = new MorpheusApi.ClusterDatastorePermissionsResourcePermissions();
      //expect(instance).to.be.a(MorpheusApi.ClusterDatastorePermissionsResourcePermissions);
    });
    ...
    it('should have the property allGroups (base name: "allGroups")', function() {
      ...
      //var instance = new MorpheusApi.ClusterDatastorePermissionsResourcePermissions();
    ...
    it('should have the property morpheusResourceType (base name: "morpheusResourceType")', function() {
      // uncomment below and update the code to test the property morpheusResourceType
      //var instance = new MorpheusApi.ClusterDatastorePermissionsResourcePermissions();
      //expect(instance).to.be();
    });

    it('should have the property morpheusResourceId (base name: "morpheusResourceId")', function() {
      // uncomment below and update the code to test the property morpheusResourceId
      //var instance = new MorpheusApi.ClusterDatastorePermissionsResourcePermissions();
      //expect(instance).to.be();
    });
