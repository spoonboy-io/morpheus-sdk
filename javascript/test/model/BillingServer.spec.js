...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingServer();
  });
  ...
  describe('BillingServer', function() {
    it('should create an instance of BillingServer', function() {
      // uncomment below and update the code to test BillingServer
      //var instane = new MorpheusApi.BillingServer();
      //expect(instance).to.be.a(MorpheusApi.BillingServer);
    });
    ...
    it('should have the property refType (base name: "refType")', function() {
      ...
      //var instance = new MorpheusApi.BillingServer();
