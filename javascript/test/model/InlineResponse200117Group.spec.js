...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse200117Group();
  });
  ...
  describe('InlineResponse200117Group', function() {
    it('should create an instance of InlineResponse200117Group', function() {
      // uncomment below and update the code to test InlineResponse200117Group
      //var instane = new MorpheusApi.InlineResponse200117Group();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse200117Group);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse200117Group();
