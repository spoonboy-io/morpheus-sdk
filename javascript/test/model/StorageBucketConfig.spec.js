...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.StorageBucketConfig();
  });
  ...
  describe('StorageBucketConfig', function() {
    it('should create an instance of StorageBucketConfig', function() {
      // uncomment below and update the code to test StorageBucketConfig
      //var instane = new MorpheusApi.StorageBucketConfig();
      //expect(instance).to.be.a(MorpheusApi.StorageBucketConfig);
    });
    ...
    it('should have the property accessKey (base name: "accessKey")', function() {
      ...
      //var instance = new MorpheusApi.StorageBucketConfig();
    ...
    it('should have the property useHostCredentials (base name: "useHostCredentials")', function() {
