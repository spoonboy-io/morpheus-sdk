...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstancesInstancesInner();
  });
  ...
  describe('BillingInstancesInstancesInner', function() {
    it('should create an instance of BillingInstancesInstancesInner', function() {
      // uncomment below and update the code to test BillingInstancesInstancesInner
      //var instance = new MorpheusApi.BillingInstancesInstancesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingInstancesInstancesInner);
    });
