...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject34();
  });
  ...
  describe('InlineObject34', function() {
    it('should create an instance of InlineObject34', function() {
      ...
      //var instane = new MorpheusApi.InlineObject34();
      //expect(instance).to.be.a(MorpheusApi.InlineObject34);
    });

    it('should have the property muted (base name: "muted")', function() {
      // uncomment below and update the code to test the property muted
      //var instance = new MorpheusApi.InlineObject34();
