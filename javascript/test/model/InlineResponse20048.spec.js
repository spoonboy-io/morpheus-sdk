...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20048();
  });
  ...
  describe('InlineResponse20048', function() {
    it('should create an instance of InlineResponse20048', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20048();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20048);
    });
    ...
    it('should have the property process (base name: "process")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20048();
