...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceScheduleUpdateThreshold();
  });
  ...
  describe('InstanceScheduleUpdateThreshold', function() {
    it('should create an instance of InstanceScheduleUpdateThreshold', function() {
      // uncomment below and update the code to test InstanceScheduleUpdateThreshold
      //var instane = new MorpheusApi.InstanceScheduleUpdateThreshold();
      //expect(instance).to.be.a(MorpheusApi.InstanceScheduleUpdateThreshold);
    });
    ...
    it('should have the property sourceThresholdId (base name: "sourceThresholdId")', function() {
      ...
      //var instance = new MorpheusApi.InstanceScheduleUpdateThreshold();
