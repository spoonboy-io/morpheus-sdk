...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationSNOWConfigIntegration();
  });
  ...
  describe('IntegrationSNOWConfigIntegration', function() {
    it('should create an instance of IntegrationSNOWConfigIntegration', function() {
      // uncomment below and update the code to test IntegrationSNOWConfigIntegration
      //var instane = new MorpheusApi.IntegrationSNOWConfigIntegration();
      //expect(instance).to.be.a(MorpheusApi.IntegrationSNOWConfigIntegration);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.IntegrationSNOWConfigIntegration();
