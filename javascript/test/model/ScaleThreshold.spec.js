...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ScaleThreshold();
  });
  ...
  describe('ScaleThreshold', function() {
    it('should create an instance of ScaleThreshold', function() {
      // uncomment below and update the code to test ScaleThreshold
      //var instane = new MorpheusApi.ScaleThreshold();
      //expect(instance).to.be.a(MorpheusApi.ScaleThreshold);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ScaleThreshold();
