...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskJavaConfig();
  });
  ...
  describe('TaskJavaConfig', function() {
    it('should create an instance of TaskJavaConfig', function() {
      // uncomment below and update the code to test TaskJavaConfig
      //var instane = new MorpheusApi.TaskJavaConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskJavaConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskJavaConfig();
