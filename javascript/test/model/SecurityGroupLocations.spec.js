...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.SecurityGroupLocations();
  });
  ...
  describe('SecurityGroupLocations', function() {
    it('should create an instance of SecurityGroupLocations', function() {
      // uncomment below and update the code to test SecurityGroupLocations
      //var instane = new MorpheusApi.SecurityGroupLocations();
      //expect(instance).to.be.a(MorpheusApi.SecurityGroupLocations);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.SecurityGroupLocations();
