...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.HealthLogs();
  });
  ...
  describe('HealthLogs', function() {
    it('should create an instance of HealthLogs', function() {
      // uncomment below and update the code to test HealthLogs
      //var instane = new MorpheusApi.HealthLogs();
      //expect(instance).to.be.a(MorpheusApi.HealthLogs);
    });
    ...
    it('should have the property typeCode (base name: "typeCode")', function() {
      ...
      //var instance = new MorpheusApi.HealthLogs();
