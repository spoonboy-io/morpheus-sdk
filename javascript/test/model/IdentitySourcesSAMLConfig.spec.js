...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesSAMLConfig();
  });
  ...
  describe('IdentitySourcesSAMLConfig', function() {
    it('should create an instance of IdentitySourcesSAMLConfig', function() {
      // uncomment below and update the code to test IdentitySourcesSAMLConfig
      //var instane = new MorpheusApi.IdentitySourcesSAMLConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesSAMLConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesSAMLConfig();
