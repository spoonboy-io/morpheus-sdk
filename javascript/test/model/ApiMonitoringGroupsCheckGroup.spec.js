...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiMonitoringGroupsCheckGroup();
  });
  ...
  describe('ApiMonitoringGroupsCheckGroup', function() {
    it('should create an instance of ApiMonitoringGroupsCheckGroup', function() {
      // uncomment below and update the code to test ApiMonitoringGroupsCheckGroup
      //var instane = new MorpheusApi.ApiMonitoringGroupsCheckGroup();
      //expect(instance).to.be.a(MorpheusApi.ApiMonitoringGroupsCheckGroup);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiMonitoringGroupsCheckGroup();
