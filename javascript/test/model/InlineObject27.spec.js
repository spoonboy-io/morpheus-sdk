...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject27();
  });
  ...
  describe('InlineObject27', function() {
    it('should create an instance of InlineObject27', function() {
      ...
      //var instane = new MorpheusApi.InlineObject27();
      //expect(instance).to.be.a(MorpheusApi.InlineObject27);
    });
    ...
    it('should have the property client (base name: "client")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject27();
