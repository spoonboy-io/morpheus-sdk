...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceNetwork();
  });
  ...
  describe('InstanceNetwork', function() {
    it('should create an instance of InstanceNetwork', function() {
      // uncomment below and update the code to test InstanceNetwork
      //var instane = new MorpheusApi.InstanceNetwork();
      //expect(instance).to.be.a(MorpheusApi.InstanceNetwork);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InstanceNetwork();
