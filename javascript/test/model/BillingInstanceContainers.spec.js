...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstanceContainers();
  });
  ...
  describe('BillingInstanceContainers', function() {
    it('should create an instance of BillingInstanceContainers', function() {
      // uncomment below and update the code to test BillingInstanceContainers
      //var instane = new MorpheusApi.BillingInstanceContainers();
      //expect(instance).to.be.a(MorpheusApi.BillingInstanceContainers);
    });
    ...
    it('should have the property refType (base name: "refType")', function() {
      ...
      //var instance = new MorpheusApi.BillingInstanceContainers();
