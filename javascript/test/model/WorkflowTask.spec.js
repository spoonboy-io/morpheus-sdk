...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.WorkflowTask();
  });
  ...
  describe('WorkflowTask', function() {
    it('should create an instance of WorkflowTask', function() {
      ...
      //var instane = new MorpheusApi.WorkflowTask();
      //expect(instance).to.be.a(MorpheusApi.WorkflowTask);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.WorkflowTask();
