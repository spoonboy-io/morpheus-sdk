...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GuidanceVmwareSizingPlanAfterAction();
  });
  ...
  describe('GuidanceVmwareSizingPlanAfterAction', function() {
    it('should create an instance of GuidanceVmwareSizingPlanAfterAction', function() {
      // uncomment below and update the code to test GuidanceVmwareSizingPlanAfterAction
      //var instane = new MorpheusApi.GuidanceVmwareSizingPlanAfterAction();
      //expect(instance).to.be.a(MorpheusApi.GuidanceVmwareSizingPlanAfterAction);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.GuidanceVmwareSizingPlanAfterAction();
