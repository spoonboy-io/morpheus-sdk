...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.Script();
  });
  ...
  describe('Script', function() {
    it('should create an instance of Script', function() {
      ...
      //var instane = new MorpheusApi.Script();
      //expect(instance).to.be.a(MorpheusApi.Script);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.Script();
    ...
    it('should have the property scriptService (base name: "scriptService")', function() {
      // uncomment below and update the code to test the property scriptService
      //var instance = new MorpheusApi.Script();
      //expect(instance).to.be();
    });

    it('should have the property scriptMethod (base name: "scriptMethod")', function() {
      // uncomment below and update the code to test the property scriptMethod
      //var instance = new MorpheusApi.Script();
      //expect(instance).to.be();
    });
    ...
    it('should have the property runAsPassword (base name: "runAsPassword")', function() {
      // uncomment below and update the code to test the property runAsPassword
      //var instance = new MorpheusApi.Script();
      //expect(instance).to.be();
    });
