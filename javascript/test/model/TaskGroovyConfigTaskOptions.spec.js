...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskGroovyConfigTaskOptions();
  });
  ...
  describe('TaskGroovyConfigTaskOptions', function() {
    it('should create an instance of TaskGroovyConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskGroovyConfigTaskOptions
      //var instane = new MorpheusApi.TaskGroovyConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskGroovyConfigTaskOptions);
    });
    ...
    it('should have the property localScriptGitRef (base name: "localScriptGitRef")', function() {
      ...
      //var instance = new MorpheusApi.TaskGroovyConfigTaskOptions();
