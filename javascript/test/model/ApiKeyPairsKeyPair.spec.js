...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiKeyPairsKeyPair();
  });
  ...
  describe('ApiKeyPairsKeyPair', function() {
    it('should create an instance of ApiKeyPairsKeyPair', function() {
      // uncomment below and update the code to test ApiKeyPairsKeyPair
      //var instane = new MorpheusApi.ApiKeyPairsKeyPair();
      //expect(instance).to.be.a(MorpheusApi.ApiKeyPairsKeyPair);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiKeyPairsKeyPair();
