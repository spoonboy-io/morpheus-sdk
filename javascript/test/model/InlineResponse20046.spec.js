...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20046();
  });
  ...
  describe('InlineResponse20046', function() {
    it('should create an instance of InlineResponse20046', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20046();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20046);
    });

    it('should have the property types (base name: "types")', function() {
      // uncomment below and update the code to test the property types
      //var instance = new MorpheusApi.InlineResponse20046();
