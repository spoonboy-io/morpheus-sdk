...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskPythonConfig();
  });
  ...
  describe('TaskPythonConfig', function() {
    it('should create an instance of TaskPythonConfig', function() {
      // uncomment below and update the code to test TaskPythonConfig
      //var instane = new MorpheusApi.TaskPythonConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskPythonConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskPythonConfig();
