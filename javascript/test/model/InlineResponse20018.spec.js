...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20018();
  });
  ...
  describe('InlineResponse20018', function() {
    it('should create an instance of InlineResponse20018', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20018();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20018);
    });
    ...
    it('should have the property checkType (base name: "checkType")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20018();
