...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.UserSourceCreateSaml();
  });
  ...
  describe('UserSourceCreateSaml', function() {
    it('should create an instance of UserSourceCreateSaml', function() {
      // uncomment below and update the code to test UserSourceCreateSaml
      //var instane = new MorpheusApi.UserSourceCreateSaml();
      //expect(instance).to.be.a(MorpheusApi.UserSourceCreateSaml);
    });

    it('should have the property url (base name: "url")', function() {
      // uncomment below and update the code to test the property url
      //var instance = new MorpheusApi.UserSourceCreateSaml();
    ...
    it('should have the property request509Certificate (base name: "request509Certificate")', function() {
      // uncomment below and update the code to test the property request509Certificate
      //var instance = new MorpheusApi.UserSourceCreateSaml();
      //expect(instance).to.be();
    });

    it('should have the property requestPrivateKey (base name: "requestPrivateKey")', function() {
      // uncomment below and update the code to test the property requestPrivateKey
      //var instance = new MorpheusApi.UserSourceCreateSaml();
      //expect(instance).to.be();
    });
