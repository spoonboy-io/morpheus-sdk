...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskAnsiblePlaybookConfigFile();
  });
  ...
  describe('TaskAnsiblePlaybookConfigFile', function() {
    it('should create an instance of TaskAnsiblePlaybookConfigFile', function() {
      // uncomment below and update the code to test TaskAnsiblePlaybookConfigFile
      //var instane = new MorpheusApi.TaskAnsiblePlaybookConfigFile();
      //expect(instance).to.be.a(MorpheusApi.TaskAnsiblePlaybookConfigFile);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskAnsiblePlaybookConfigFile();
