...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20095NetworkRouterNetworkServerIntegration();
  });
  ...
  describe('InlineResponse20095NetworkRouterNetworkServerIntegration', function() {
    it('should create an instance of InlineResponse20095NetworkRouterNetworkServerIntegration', function() {
      // uncomment below and update the code to test InlineResponse20095NetworkRouterNetworkServerIntegration
      //var instane = new MorpheusApi.InlineResponse20095NetworkRouterNetworkServerIntegration();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20095NetworkRouterNetworkServerIntegration);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse20095NetworkRouterNetworkServerIntegration();
