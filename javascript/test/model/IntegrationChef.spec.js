...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationChef();
  });
  ...
  describe('IntegrationChef', function() {
    it('should create an instance of IntegrationChef', function() {
      // uncomment below and update the code to test IntegrationChef
      //var instane = new MorpheusApi.IntegrationChef();
      //expect(instance).to.be.a(MorpheusApi.IntegrationChef);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationChef();
