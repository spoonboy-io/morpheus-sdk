...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CatalogItemTypeInstanceCreate();
  });
  ...
  describe('CatalogItemTypeInstanceCreate', function() {
    it('should create an instance of CatalogItemTypeInstanceCreate', function() {
      // uncomment below and update the code to test CatalogItemTypeInstanceCreate
      //var instane = new MorpheusApi.CatalogItemTypeInstanceCreate();
      //expect(instance).to.be.a(MorpheusApi.CatalogItemTypeInstanceCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CatalogItemTypeInstanceCreate();
