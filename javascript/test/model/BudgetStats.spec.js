...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BudgetStats();
  });
  ...
  describe('BudgetStats', function() {
    it('should create an instance of BudgetStats', function() {
      // uncomment below and update the code to test BudgetStats
      //var instane = new MorpheusApi.BudgetStats();
      //expect(instance).to.be.a(MorpheusApi.BudgetStats);
    });

    it('should have the property currency (base name: "currency")', function() {
      // uncomment below and update the code to test the property currency
      //var instance = new MorpheusApi.BudgetStats();
