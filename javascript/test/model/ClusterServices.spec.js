...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterServices();
  });
  ...
  describe('ClusterServices', function() {
    it('should create an instance of ClusterServices', function() {
      // uncomment below and update the code to test ClusterServices
      //var instane = new MorpheusApi.ClusterServices();
      //expect(instance).to.be.a(MorpheusApi.ClusterServices);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterServices();
    ...
    it('should have the property internalPort (base name: "internalPort")', function() {
