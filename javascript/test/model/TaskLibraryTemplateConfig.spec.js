...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskLibraryTemplateConfig();
  });
  ...
  describe('TaskLibraryTemplateConfig', function() {
    it('should create an instance of TaskLibraryTemplateConfig', function() {
      // uncomment below and update the code to test TaskLibraryTemplateConfig
      //var instane = new MorpheusApi.TaskLibraryTemplateConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskLibraryTemplateConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskLibraryTemplateConfig();
