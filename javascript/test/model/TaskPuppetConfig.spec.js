...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskPuppetConfig();
  });
  ...
  describe('TaskPuppetConfig', function() {
    it('should create an instance of TaskPuppetConfig', function() {
      // uncomment below and update the code to test TaskPuppetConfig
      //var instane = new MorpheusApi.TaskPuppetConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskPuppetConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskPuppetConfig();
