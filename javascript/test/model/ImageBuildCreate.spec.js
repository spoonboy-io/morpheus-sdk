...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ImageBuildCreate();
  });
  ...
  describe('ImageBuildCreate', function() {
    it('should create an instance of ImageBuildCreate', function() {
      // uncomment below and update the code to test ImageBuildCreate
      //var instane = new MorpheusApi.ImageBuildCreate();
      //expect(instance).to.be.a(MorpheusApi.ImageBuildCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ImageBuildCreate();
