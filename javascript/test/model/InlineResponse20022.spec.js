...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20022();
  });
  ...
  describe('InlineResponse20022', function() {
    it('should create an instance of InlineResponse20022', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20022();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20022);
    });
    ...
    it('should have the property datastore (base name: "datastore")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20022();
