...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20036();
  });
  ...
  describe('InlineResponse20036', function() {
    it('should create an instance of InlineResponse20036', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20036();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20036);
    });
    ...
    it('should have the property credentialType (base name: "credentialType")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20036();
