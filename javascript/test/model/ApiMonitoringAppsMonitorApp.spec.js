...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiMonitoringAppsMonitorApp();
  });
  ...
  describe('ApiMonitoringAppsMonitorApp', function() {
    it('should create an instance of ApiMonitoringAppsMonitorApp', function() {
      // uncomment below and update the code to test ApiMonitoringAppsMonitorApp
      //var instane = new MorpheusApi.ApiMonitoringAppsMonitorApp();
      //expect(instance).to.be.a(MorpheusApi.ApiMonitoringAppsMonitorApp);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiMonitoringAppsMonitorApp();
