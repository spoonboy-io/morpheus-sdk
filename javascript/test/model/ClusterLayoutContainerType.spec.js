...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterLayoutContainerType();
  });
  ...
  describe('ClusterLayoutContainerType', function() {
    it('should create an instance of ClusterLayoutContainerType', function() {
      // uncomment below and update the code to test ClusterLayoutContainerType
      //var instane = new MorpheusApi.ClusterLayoutContainerType();
      //expect(instance).to.be.a(MorpheusApi.ClusterLayoutContainerType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterLayoutContainerType();
