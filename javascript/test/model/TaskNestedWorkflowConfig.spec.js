...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskNestedWorkflowConfig();
  });
  ...
  describe('TaskNestedWorkflowConfig', function() {
    it('should create an instance of TaskNestedWorkflowConfig', function() {
      // uncomment below and update the code to test TaskNestedWorkflowConfig
      //var instane = new MorpheusApi.TaskNestedWorkflowConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskNestedWorkflowConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskNestedWorkflowConfig();
