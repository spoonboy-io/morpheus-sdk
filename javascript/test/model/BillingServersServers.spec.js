...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingServersServers();
  });
  ...
  describe('BillingServersServers', function() {
    it('should create an instance of BillingServersServers', function() {
      // uncomment below and update the code to test BillingServersServers
      //var instane = new MorpheusApi.BillingServersServers();
      //expect(instance).to.be.a(MorpheusApi.BillingServersServers);
    });
    ...
    it('should have the property refType (base name: "refType")', function() {
      ...
      //var instance = new MorpheusApi.BillingServersServers();
