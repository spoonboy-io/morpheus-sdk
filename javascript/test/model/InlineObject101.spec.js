...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject101();
  });
  ...
  describe('InlineObject101', function() {
    it('should create an instance of InlineObject101', function() {
      ...
      //var instane = new MorpheusApi.InlineObject101();
      //expect(instance).to.be.a(MorpheusApi.InlineObject101);
    });
    ...
    it('should have the property inventory (base name: "inventory")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject101();
