...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskEmailConfig();
  });
  ...
  describe('TaskEmailConfig', function() {
    it('should create an instance of TaskEmailConfig', function() {
      // uncomment below and update the code to test TaskEmailConfig
      //var instane = new MorpheusApi.TaskEmailConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskEmailConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskEmailConfig();
