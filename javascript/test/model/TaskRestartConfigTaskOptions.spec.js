...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskRestartConfigTaskOptions();
  });
  ...
  describe('TaskRestartConfigTaskOptions', function() {
    it('should create an instance of TaskRestartConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskRestartConfigTaskOptions
      //var instane = new MorpheusApi.TaskRestartConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskRestartConfigTaskOptions);
    });

    it('should have the property password (base name: "password")', function() {
      // uncomment below and update the code to test the property password
      //var instance = new MorpheusApi.TaskRestartConfigTaskOptions();
