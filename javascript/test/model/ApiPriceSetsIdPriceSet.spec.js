...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiPriceSetsIdPriceSet();
  });
  ...
  describe('ApiPriceSetsIdPriceSet', function() {
    it('should create an instance of ApiPriceSetsIdPriceSet', function() {
      // uncomment below and update the code to test ApiPriceSetsIdPriceSet
      //var instane = new MorpheusApi.ApiPriceSetsIdPriceSet();
      //expect(instance).to.be.a(MorpheusApi.ApiPriceSetsIdPriceSet);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiPriceSetsIdPriceSet();
