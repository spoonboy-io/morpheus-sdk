...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject14();
  });
  ...
  describe('InlineObject14', function() {
    it('should create an instance of InlineObject14', function() {
      ...
      //var instane = new MorpheusApi.InlineObject14();
      //expect(instance).to.be.a(MorpheusApi.InlineObject14);
    });
    ...
    it('should have the property script (base name: "script")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject14();
