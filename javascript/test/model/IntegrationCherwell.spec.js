...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationCherwell();
  });
  ...
  describe('IntegrationCherwell', function() {
    it('should create an instance of IntegrationCherwell', function() {
      // uncomment below and update the code to test IntegrationCherwell
      //var instane = new MorpheusApi.IntegrationCherwell();
      //expect(instance).to.be.a(MorpheusApi.IntegrationCherwell);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationCherwell();
