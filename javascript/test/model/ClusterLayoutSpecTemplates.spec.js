...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterLayoutSpecTemplates();
  });
  ...
  describe('ClusterLayoutSpecTemplates', function() {
    it('should create an instance of ClusterLayoutSpecTemplates', function() {
      // uncomment below and update the code to test ClusterLayoutSpecTemplates
      //var instane = new MorpheusApi.ClusterLayoutSpecTemplates();
      //expect(instance).to.be.a(MorpheusApi.ClusterLayoutSpecTemplates);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterLayoutSpecTemplates();
