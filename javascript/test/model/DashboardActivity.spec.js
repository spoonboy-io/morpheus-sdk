...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.DashboardActivity();
  });
  ...
  describe('DashboardActivity', function() {
    it('should create an instance of DashboardActivity', function() {
      // uncomment below and update the code to test DashboardActivity
      //var instane = new MorpheusApi.DashboardActivity();
      //expect(instance).to.be.a(MorpheusApi.DashboardActivity);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.DashboardActivity();
