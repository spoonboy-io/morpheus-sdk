...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject224();
  });
  ...
  describe('InlineObject224', function() {
    it('should create an instance of InlineObject224', function() {
      // uncomment below and update the code to test InlineObject224
      //var instane = new MorpheusApi.InlineObject224();
      //expect(instance).to.be.a(MorpheusApi.InlineObject224);
    });
    ...
    it('should have the property server (base name: "server")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject224();
    ...
    it('should have the property deleteOriginalVolumes (base name: "deleteOriginalVolumes")', function() {
      // uncomment below and update the code to test the property deleteOriginalVolumes
      //var instance = new MorpheusApi.InlineObject224();
      //expect(instance).to.be();
    });
