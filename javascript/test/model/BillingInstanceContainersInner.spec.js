...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstanceContainersInner();
  });
  ...
  describe('BillingInstanceContainersInner', function() {
    it('should create an instance of BillingInstanceContainersInner', function() {
      // uncomment below and update the code to test BillingInstanceContainersInner
      //var instance = new MorpheusApi.BillingInstanceContainersInner();
      //expect(instance).to.be.a(MorpheusApi.BillingInstanceContainersInner);
    });
