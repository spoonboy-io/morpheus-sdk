...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces();
  });
  ...
  describe('NetworkInterfaceUpdateSuccessServerInterfaces', function() {
    it('should create an instance of NetworkInterfaceUpdateSuccessServerInterfaces', function() {
      // uncomment below and update the code to test NetworkInterfaceUpdateSuccessServerInterfaces
      //var instane = new MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces();
      //expect(instance).to.be.a(MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces();
    ...
    it('should have the property replaceHostRecord (base name: "replaceHostRecord")', function() {
      // uncomment below and update the code to test the property replaceHostRecord
      //var instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces();
      //expect(instance).to.be();
    });
    ...
    it('should have the property networkPoolIPv6 (base name: "networkPoolIPv6")', function() {
      // uncomment below and update the code to test the property networkPoolIPv6
      //var instance = new MorpheusApi.NetworkInterfaceUpdateSuccessServerInterfaces();
      //expect(instance).to.be();
    });
