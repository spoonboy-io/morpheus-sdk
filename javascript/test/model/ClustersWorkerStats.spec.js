...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClustersWorkerStats();
  });
  ...
  describe('ClustersWorkerStats', function() {
    it('should create an instance of ClustersWorkerStats', function() {
      // uncomment below and update the code to test ClustersWorkerStats
      //var instane = new MorpheusApi.ClustersWorkerStats();
      //expect(instance).to.be.a(MorpheusApi.ClustersWorkerStats);
    });
    ...
    it('should have the property usedStorage (base name: "usedStorage")', function() {
      ...
      //var instance = new MorpheusApi.ClustersWorkerStats();
    ...
    it('should have the property usedCpu (base name: "usedCpu")', function() {
      // uncomment below and update the code to test the property usedCpu
      //var instance = new MorpheusApi.ClustersWorkerStats();
      //expect(instance).to.be();
    });
