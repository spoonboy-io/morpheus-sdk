...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.AppStateWorkloadsInner();
  });
  ...
  describe('AppStateWorkloadsInner', function() {
    it('should create an instance of AppStateWorkloadsInner', function() {
      // uncomment below and update the code to test AppStateWorkloadsInner
      //var instance = new MorpheusApi.AppStateWorkloadsInner();
      //expect(instance).to.be.a(MorpheusApi.AppStateWorkloadsInner);
    });
