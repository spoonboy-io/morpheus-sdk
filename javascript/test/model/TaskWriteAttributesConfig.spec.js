...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskWriteAttributesConfig();
  });
  ...
  describe('TaskWriteAttributesConfig', function() {
    it('should create an instance of TaskWriteAttributesConfig', function() {
      // uncomment below and update the code to test TaskWriteAttributesConfig
      //var instane = new MorpheusApi.TaskWriteAttributesConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskWriteAttributesConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskWriteAttributesConfig();
