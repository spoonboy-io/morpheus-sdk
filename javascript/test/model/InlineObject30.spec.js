...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject30();
  });
  ...
  describe('InlineObject30', function() {
    it('should create an instance of InlineObject30', function() {
      ...
      //var instane = new MorpheusApi.InlineObject30();
      //expect(instance).to.be.a(MorpheusApi.InlineObject30);
    });

    it('should have the property muted (base name: "muted")', function() {
      // uncomment below and update the code to test the property muted
      //var instance = new MorpheusApi.InlineObject30();
