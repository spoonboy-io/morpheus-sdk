...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.RouteOptionType();
  });
  ...
  describe('RouteOptionType', function() {
    it('should create an instance of RouteOptionType', function() {
      // uncomment below and update the code to test RouteOptionType
      //var instane = new MorpheusApi.RouteOptionType();
      //expect(instance).to.be.a(MorpheusApi.RouteOptionType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.RouteOptionType();
