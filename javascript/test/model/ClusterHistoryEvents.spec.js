...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterHistoryEvents();
  });
  ...
  describe('ClusterHistoryEvents', function() {
    it('should create an instance of ClusterHistoryEvents', function() {
      // uncomment below and update the code to test ClusterHistoryEvents
      //var instane = new MorpheusApi.ClusterHistoryEvents();
      //expect(instance).to.be.a(MorpheusApi.ClusterHistoryEvents);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterHistoryEvents();
