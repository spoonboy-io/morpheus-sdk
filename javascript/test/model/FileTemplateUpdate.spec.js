...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.FileTemplateUpdate();
  });
  ...
  describe('FileTemplateUpdate', function() {
    it('should create an instance of FileTemplateUpdate', function() {
      // uncomment below and update the code to test FileTemplateUpdate
      //var instane = new MorpheusApi.FileTemplateUpdate();
      //expect(instance).to.be.a(MorpheusApi.FileTemplateUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.FileTemplateUpdate();
