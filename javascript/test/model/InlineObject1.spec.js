...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new MorpheusApi.InlineObject1();
      //expect(instance).to.be.a(MorpheusApi.InlineObject1);
    });

    it('should have the property alert (base name: "alert")', function() {
      // uncomment below and update the code to test the property alert
      //var instance = new MorpheusApi.InlineObject1();
