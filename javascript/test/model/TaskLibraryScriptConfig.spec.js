...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskLibraryScriptConfig();
  });
  ...
  describe('TaskLibraryScriptConfig', function() {
    it('should create an instance of TaskLibraryScriptConfig', function() {
      // uncomment below and update the code to test TaskLibraryScriptConfig
      //var instane = new MorpheusApi.TaskLibraryScriptConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskLibraryScriptConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskLibraryScriptConfig();
