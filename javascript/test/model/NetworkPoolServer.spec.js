...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkPoolServer();
  });
  ...
  describe('NetworkPoolServer', function() {
    it('should create an instance of NetworkPoolServer', function() {
      // uncomment below and update the code to test NetworkPoolServer
      //var instane = new MorpheusApi.NetworkPoolServer();
      //expect(instance).to.be.a(MorpheusApi.NetworkPoolServer);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkPoolServer();
