...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ControllerType();
  });
  ...
  describe('ControllerType', function() {
    it('should create an instance of ControllerType', function() {
      // uncomment below and update the code to test ControllerType
      //var instane = new MorpheusApi.ControllerType();
      //expect(instance).to.be.a(MorpheusApi.ControllerType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ControllerType();
