...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServerInterfaces();
  });
  ...
  describe('ServerInterfaces', function() {
    it('should create an instance of ServerInterfaces', function() {
      // uncomment below and update the code to test ServerInterfaces
      //var instane = new MorpheusApi.ServerInterfaces();
      //expect(instance).to.be.a(MorpheusApi.ServerInterfaces);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ServerInterfaces();
