...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiTasksTaskFile();
  });
  ...
  describe('ApiTasksTaskFile', function() {
    it('should create an instance of ApiTasksTaskFile', function() {
      // uncomment below and update the code to test ApiTasksTaskFile
      //var instane = new MorpheusApi.ApiTasksTaskFile();
      //expect(instance).to.be.a(MorpheusApi.ApiTasksTaskFile);
    });
    ...
    it('should have the property sourceType (base name: "sourceType")', function() {
      ...
      //var instance = new MorpheusApi.ApiTasksTaskFile();
