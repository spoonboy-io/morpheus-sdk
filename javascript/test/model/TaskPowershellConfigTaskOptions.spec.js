...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskPowershellConfigTaskOptions();
  });
  ...
  describe('TaskPowershellConfigTaskOptions', function() {
    it('should create an instance of TaskPowershellConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskPowershellConfigTaskOptions
      //var instane = new MorpheusApi.TaskPowershellConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskPowershellConfigTaskOptions);
    });

    it('should have the property host (base name: "host")', function() {
      // uncomment below and update the code to test the property host
      //var instance = new MorpheusApi.TaskPowershellConfigTaskOptions();
