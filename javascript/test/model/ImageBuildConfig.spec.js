...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ImageBuildConfig();
  });
  ...
  describe('ImageBuildConfig', function() {
    it('should create an instance of ImageBuildConfig', function() {
      // uncomment below and update the code to test ImageBuildConfig
      //var instane = new MorpheusApi.ImageBuildConfig();
      //expect(instance).to.be.a(MorpheusApi.ImageBuildConfig);
    });
    ...
    it('should have the property instance (base name: "instance")', function() {
      ...
      //var instance = new MorpheusApi.ImageBuildConfig();
