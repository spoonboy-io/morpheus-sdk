...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject16();
  });
  ...
  describe('InlineObject16', function() {
    it('should create an instance of InlineObject16', function() {
      ...
      //var instane = new MorpheusApi.InlineObject16();
      //expect(instance).to.be.a(MorpheusApi.InlineObject16);
    });
    ...
    it('should have the property backup (base name: "backup")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject16();
