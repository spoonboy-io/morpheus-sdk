...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterWorkers();
  });
  ...
  describe('ClusterWorkers', function() {
    it('should create an instance of ClusterWorkers', function() {
      ...
      //var instane = new MorpheusApi.ClusterWorkers();
      //expect(instance).to.be.a(MorpheusApi.ClusterWorkers);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterWorkers();
