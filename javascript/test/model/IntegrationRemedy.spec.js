...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationRemedy();
  });
  ...
  describe('IntegrationRemedy', function() {
    it('should create an instance of IntegrationRemedy', function() {
      // uncomment below and update the code to test IntegrationRemedy
      //var instane = new MorpheusApi.IntegrationRemedy();
      //expect(instance).to.be.a(MorpheusApi.IntegrationRemedy);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationRemedy();
