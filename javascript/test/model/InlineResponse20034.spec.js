...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20034();
  });
  ...
  describe('InlineResponse20034', function() {
    it('should create an instance of InlineResponse20034', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse20034();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20034);
    });
    ...
    it('should have the property container (base name: "container")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse20034();
