...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstancesInstancesInnerContainersInnerUsagesInner();
  });
  ...
  describe('BillingInstancesInstancesInnerContainersInnerUsagesInner', function() {
    it('should create an instance of BillingInstancesInstancesInnerContainersInnerUsagesInner', function() {
      // uncomment below and update the code to test BillingInstancesInstancesInnerContainersInnerUsagesInner
      //var instance = new MorpheusApi.BillingInstancesInstancesInnerContainersInnerUsagesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingInstancesInstancesInnerContainersInnerUsagesInner);
    });
