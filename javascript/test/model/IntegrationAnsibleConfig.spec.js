...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationAnsibleConfig();
  });
  ...
  describe('IntegrationAnsibleConfig', function() {
    it('should create an instance of IntegrationAnsibleConfig', function() {
      // uncomment below and update the code to test IntegrationAnsibleConfig
      //var instane = new MorpheusApi.IntegrationAnsibleConfig();
      //expect(instance).to.be.a(MorpheusApi.IntegrationAnsibleConfig);
    });
    ...
    it('should have the property inventory (base name: "inventory")', function() {
      ...
      //var instance = new MorpheusApi.IntegrationAnsibleConfig();
    ...
    it('should have the property ansibleDefaultBranch (base name: "ansibleDefaultBranch")', function() {
      // uncomment below and update the code to test the property ansibleDefaultBranch
      //var instance = new MorpheusApi.IntegrationAnsibleConfig();
      //expect(instance).to.be();
    });
