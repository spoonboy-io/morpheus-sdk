...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.WorkflowTaskTaskOptions();
  });
  ...
  describe('WorkflowTaskTaskOptions', function() {
    it('should create an instance of WorkflowTaskTaskOptions', function() {
      // uncomment below and update the code to test WorkflowTaskTaskOptions
      //var instane = new MorpheusApi.WorkflowTaskTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.WorkflowTaskTaskOptions);
    });
    ...
    it('should have the property localScriptGitRef (base name: "localScriptGitRef")', function() {
      ...
      //var instance = new MorpheusApi.WorkflowTaskTaskOptions();
    ...
    it('should have the property shellSudo (base name: "shell.sudo")', function() {
      // uncomment below and update the code to test the property shellSudo
      //var instance = new MorpheusApi.WorkflowTaskTaskOptions();
      //expect(instance).to.be();
    });
