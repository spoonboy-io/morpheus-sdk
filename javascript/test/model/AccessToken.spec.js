...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.AccessToken();
  });
  ...
  describe('AccessToken', function() {
    it('should create an instance of AccessToken', function() {
      ...
      //var instane = new MorpheusApi.AccessToken();
      //expect(instance).to.be.a(MorpheusApi.AccessToken);
    });
    ...
    it('should have the property accessToken (base name: "access_token")', function() {
      ...
      //var instance = new MorpheusApi.AccessToken();
