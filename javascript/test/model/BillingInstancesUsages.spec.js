...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstancesUsages();
  });
  ...
  describe('BillingInstancesUsages', function() {
    it('should create an instance of BillingInstancesUsages', function() {
      // uncomment below and update the code to test BillingInstancesUsages
      //var instane = new MorpheusApi.BillingInstancesUsages();
      //expect(instance).to.be.a(MorpheusApi.BillingInstancesUsages);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.BillingInstancesUsages();
