...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiSecurityGroupsIdRulesRule();
  });
  ...
  describe('ApiSecurityGroupsIdRulesRule', function() {
    it('should create an instance of ApiSecurityGroupsIdRulesRule', function() {
      // uncomment below and update the code to test ApiSecurityGroupsIdRulesRule
      //var instane = new MorpheusApi.ApiSecurityGroupsIdRulesRule();
      //expect(instance).to.be.a(MorpheusApi.ApiSecurityGroupsIdRulesRule);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiSecurityGroupsIdRulesRule();
