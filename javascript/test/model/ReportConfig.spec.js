...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ReportConfig();
  });
  ...
  describe('ReportConfig', function() {
    it('should create an instance of ReportConfig', function() {
      ...
      //var instane = new MorpheusApi.ReportConfig();
      //expect(instance).to.be.a(MorpheusApi.ReportConfig);
    });
    ...
    it('should have the property reportType (base name: "reportType")', function() {
      ...
      //var instance = new MorpheusApi.ReportConfig();
