...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiVdiPoolsIdVdiPool();
  });
  ...
  describe('ApiVdiPoolsIdVdiPool', function() {
    it('should create an instance of ApiVdiPoolsIdVdiPool', function() {
      // uncomment below and update the code to test ApiVdiPoolsIdVdiPool
      //var instane = new MorpheusApi.ApiVdiPoolsIdVdiPool();
      //expect(instance).to.be.a(MorpheusApi.ApiVdiPoolsIdVdiPool);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiVdiPoolsIdVdiPool();
