...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.HealthDatabaseScans();
  });
  ...
  describe('HealthDatabaseScans', function() {
    it('should create an instance of HealthDatabaseScans', function() {
      // uncomment below and update the code to test HealthDatabaseScans
      //var instane = new MorpheusApi.HealthDatabaseScans();
      //expect(instance).to.be.a(MorpheusApi.HealthDatabaseScans);
    });
    ...
    it('should have the property handlerReadFirst (base name: "Handler_read_first")', function() {
      ...
      //var instance = new MorpheusApi.HealthDatabaseScans();
