...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject12();
  });
  ...
  describe('InlineObject12', function() {
    it('should create an instance of InlineObject12', function() {
      ...
      //var instane = new MorpheusApi.InlineObject12();
      //expect(instance).to.be.a(MorpheusApi.InlineObject12);
    });
    ...
    it('should have the property schedule (base name: "schedule")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject12();
