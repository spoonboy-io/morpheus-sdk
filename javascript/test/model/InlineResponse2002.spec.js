...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse2002();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse2002);
    });

    it('should have the property app (base name: "app")', function() {
      // uncomment below and update the code to test the property app
      //var instance = new MorpheusApi.InlineResponse2002();
