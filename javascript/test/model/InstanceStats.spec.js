...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceStats();
  });
  ...
  describe('InstanceStats', function() {
    it('should create an instance of InstanceStats', function() {
      // uncomment below and update the code to test InstanceStats
      //var instane = new MorpheusApi.InstanceStats();
      //expect(instance).to.be.a(MorpheusApi.InstanceStats);
    });
    ...
    it('should have the property usedStorage (base name: "usedStorage")', function() {
      ...
      //var instance = new MorpheusApi.InstanceStats();
