...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterContainers();
  });
  ...
  describe('ClusterContainers', function() {
    it('should create an instance of ClusterContainers', function() {
      // uncomment below and update the code to test ClusterContainers
      //var instane = new MorpheusApi.ClusterContainers();
      //expect(instance).to.be.a(MorpheusApi.ClusterContainers);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterContainers();
