...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstanceContainersInnerUsagesInner();
  });
  ...
  describe('BillingInstanceContainersInnerUsagesInner', function() {
    it('should create an instance of BillingInstanceContainersInnerUsagesInner', function() {
      // uncomment below and update the code to test BillingInstanceContainersInnerUsagesInner
      //var instance = new MorpheusApi.BillingInstanceContainersInnerUsagesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingInstanceContainersInnerUsagesInner);
    });
