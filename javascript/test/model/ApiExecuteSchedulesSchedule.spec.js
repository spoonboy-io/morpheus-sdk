...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiExecuteSchedulesSchedule();
  });
  ...
  describe('ApiExecuteSchedulesSchedule', function() {
    it('should create an instance of ApiExecuteSchedulesSchedule', function() {
      // uncomment below and update the code to test ApiExecuteSchedulesSchedule
      //var instane = new MorpheusApi.ApiExecuteSchedulesSchedule();
      //expect(instance).to.be.a(MorpheusApi.ApiExecuteSchedulesSchedule);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiExecuteSchedulesSchedule();
