...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiPricesPrice();
  });
  ...
  describe('ApiPricesPrice', function() {
    it('should create an instance of ApiPricesPrice', function() {
      // uncomment below and update the code to test ApiPricesPrice
      //var instane = new MorpheusApi.ApiPricesPrice();
      //expect(instance).to.be.a(MorpheusApi.ApiPricesPrice);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiPricesPrice();
