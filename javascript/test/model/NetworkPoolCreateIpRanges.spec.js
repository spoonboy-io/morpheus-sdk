...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkPoolCreateIpRanges();
  });
  ...
  describe('NetworkPoolCreateIpRanges', function() {
    it('should create an instance of NetworkPoolCreateIpRanges', function() {
      // uncomment below and update the code to test NetworkPoolCreateIpRanges
      //var instane = new MorpheusApi.NetworkPoolCreateIpRanges();
      //expect(instance).to.be.a(MorpheusApi.NetworkPoolCreateIpRanges);
    });
    ...
    it('should have the property startAddress (base name: "startAddress")', function() {
      ...
      //var instance = new MorpheusApi.NetworkPoolCreateIpRanges();
