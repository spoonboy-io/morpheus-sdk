...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstancesInstances();
  });
  ...
  describe('BillingInstancesInstances', function() {
    it('should create an instance of BillingInstancesInstances', function() {
      // uncomment below and update the code to test BillingInstancesInstances
      //var instane = new MorpheusApi.BillingInstancesInstances();
      //expect(instance).to.be.a(MorpheusApi.BillingInstancesInstances);
    });
    ...
    it('should have the property instanceId (base name: "instanceId")', function() {
      ...
      //var instance = new MorpheusApi.BillingInstancesInstances();
