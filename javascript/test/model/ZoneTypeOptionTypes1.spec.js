...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ZoneTypeOptionTypes1();
  });
  ...
  describe('ZoneTypeOptionTypes1', function() {
    it('should create an instance of ZoneTypeOptionTypes1', function() {
      // uncomment below and update the code to test ZoneTypeOptionTypes1
      //var instane = new MorpheusApi.ZoneTypeOptionTypes1();
      //expect(instance).to.be.a(MorpheusApi.ZoneTypeOptionTypes1);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ZoneTypeOptionTypes1();
