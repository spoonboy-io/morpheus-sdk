...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.AddBudgetsRequestBudget();
  });
  ...
  describe('AddBudgetsRequestBudget', function() {
    it('should create an instance of AddBudgetsRequestBudget', function() {
      // uncomment below and update the code to test AddBudgetsRequestBudget
      //var instance = new MorpheusApi.AddBudgetsRequestBudget();
      //expect(instance).to.be.a(MorpheusApi.AddBudgetsRequestBudget);
    });
