...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskJrubyConfig();
  });
  ...
  describe('TaskJrubyConfig', function() {
    it('should create an instance of TaskJrubyConfig', function() {
      // uncomment below and update the code to test TaskJrubyConfig
      //var instane = new MorpheusApi.TaskJrubyConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskJrubyConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskJrubyConfig();
