...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServerStats();
  });
  ...
  describe('ServerStats', function() {
    it('should create an instance of ServerStats', function() {
      ...
      //var instane = new MorpheusApi.ServerStats();
      //expect(instance).to.be.a(MorpheusApi.ServerStats);
    });

    it('should have the property ts (base name: "ts")', function() {
      // uncomment below and update the code to test the property ts
      //var instance = new MorpheusApi.ServerStats();
