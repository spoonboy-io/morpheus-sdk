...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskChefBootstrapConfig();
  });
  ...
  describe('TaskChefBootstrapConfig', function() {
    it('should create an instance of TaskChefBootstrapConfig', function() {
      // uncomment below and update the code to test TaskChefBootstrapConfig
      //var instane = new MorpheusApi.TaskChefBootstrapConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskChefBootstrapConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskChefBootstrapConfig();
