...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingZonesInner();
  });
  ...
  describe('BillingZonesInner', function() {
    it('should create an instance of BillingZonesInner', function() {
      // uncomment below and update the code to test BillingZonesInner
      //var instance = new MorpheusApi.BillingZonesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingZonesInner);
    });
