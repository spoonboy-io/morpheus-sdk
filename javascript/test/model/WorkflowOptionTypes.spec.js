...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.WorkflowOptionTypes();
  });
  ...
  describe('WorkflowOptionTypes', function() {
    it('should create an instance of WorkflowOptionTypes', function() {
      // uncomment below and update the code to test WorkflowOptionTypes
      //var instane = new MorpheusApi.WorkflowOptionTypes();
      //expect(instance).to.be.a(MorpheusApi.WorkflowOptionTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.WorkflowOptionTypes();
