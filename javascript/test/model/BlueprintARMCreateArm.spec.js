...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BlueprintARMCreateArm();
  });
  ...
  describe('BlueprintARMCreateArm', function() {
    it('should create an instance of BlueprintARMCreateArm', function() {
      // uncomment below and update the code to test BlueprintARMCreateArm
      //var instane = new MorpheusApi.BlueprintARMCreateArm();
      //expect(instance).to.be.a(MorpheusApi.BlueprintARMCreateArm);
    });
    ...
    it('should have the property configType (base name: "configType")', function() {
      ...
      //var instance = new MorpheusApi.BlueprintARMCreateArm();
