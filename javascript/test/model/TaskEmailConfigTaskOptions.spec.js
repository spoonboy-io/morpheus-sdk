...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskEmailConfigTaskOptions();
  });
  ...
  describe('TaskEmailConfigTaskOptions', function() {
    it('should create an instance of TaskEmailConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskEmailConfigTaskOptions
      //var instane = new MorpheusApi.TaskEmailConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskEmailConfigTaskOptions);
    });
    ...
    it('should have the property localScriptGitId (base name: "localScriptGitId")', function() {
      ...
      //var instance = new MorpheusApi.TaskEmailConfigTaskOptions();
      //expect(instance).to.be();
    });

    it('should have the property emailSkipTemplate (base name: "emailSkipTemplate")', function() {
      // uncomment below and update the code to test the property emailSkipTemplate
      //var instance = new MorpheusApi.TaskEmailConfigTaskOptions();
      //expect(instance).to.be();
    });
