...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeAction();
  });
  ...
  describe('GuidanceVmwareSizingPlanBeforeAction', function() {
    it('should create an instance of GuidanceVmwareSizingPlanBeforeAction', function() {
      // uncomment below and update the code to test GuidanceVmwareSizingPlanBeforeAction
      //var instane = new MorpheusApi.GuidanceVmwareSizingPlanBeforeAction();
      //expect(instance).to.be.a(MorpheusApi.GuidanceVmwareSizingPlanBeforeAction);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeAction();
    ...
    it('should have the property memoryOptionSource (base name: "memoryOptionSource")', function() {
      // uncomment below and update the code to test the property memoryOptionSource
      //var instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeAction();
      //expect(instance).to.be();
    });

    it('should have the property cpuOptionSource (base name: "cpuOptionSource")', function() {
      // uncomment below and update the code to test the property cpuOptionSource
      //var instance = new MorpheusApi.GuidanceVmwareSizingPlanBeforeAction();
      //expect(instance).to.be();
    });
