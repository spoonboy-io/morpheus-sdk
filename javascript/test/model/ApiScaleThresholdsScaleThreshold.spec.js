...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiScaleThresholdsScaleThreshold();
  });
  ...
  describe('ApiScaleThresholdsScaleThreshold', function() {
    it('should create an instance of ApiScaleThresholdsScaleThreshold', function() {
      // uncomment below and update the code to test ApiScaleThresholdsScaleThreshold
      //var instane = new MorpheusApi.ApiScaleThresholdsScaleThreshold();
      //expect(instance).to.be.a(MorpheusApi.ApiScaleThresholdsScaleThreshold);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiScaleThresholdsScaleThreshold();
