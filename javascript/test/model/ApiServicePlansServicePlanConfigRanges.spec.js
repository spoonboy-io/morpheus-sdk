...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiServicePlansServicePlanConfigRanges();
  });
  ...
  describe('ApiServicePlansServicePlanConfigRanges', function() {
    it('should create an instance of ApiServicePlansServicePlanConfigRanges', function() {
      // uncomment below and update the code to test ApiServicePlansServicePlanConfigRanges
      //var instane = new MorpheusApi.ApiServicePlansServicePlanConfigRanges();
      //expect(instance).to.be.a(MorpheusApi.ApiServicePlansServicePlanConfigRanges);
    });
    ...
    it('should have the property minStorage (base name: "minStorage")', function() {
      ...
      //var instance = new MorpheusApi.ApiServicePlansServicePlanConfigRanges();
