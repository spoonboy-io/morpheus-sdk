...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiCertificatesCertificate();
  });
  ...
  describe('ApiCertificatesCertificate', function() {
    it('should create an instance of ApiCertificatesCertificate', function() {
      // uncomment below and update the code to test ApiCertificatesCertificate
      //var instane = new MorpheusApi.ApiCertificatesCertificate();
      //expect(instance).to.be.a(MorpheusApi.ApiCertificatesCertificate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiCertificatesCertificate();
