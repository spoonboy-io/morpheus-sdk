...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterHistoryEventItem();
  });
  ...
  describe('ClusterHistoryEventItem', function() {
    it('should create an instance of ClusterHistoryEventItem', function() {
      // uncomment below and update the code to test ClusterHistoryEventItem
      //var instane = new MorpheusApi.ClusterHistoryEventItem();
      //expect(instance).to.be.a(MorpheusApi.ClusterHistoryEventItem);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterHistoryEventItem();
