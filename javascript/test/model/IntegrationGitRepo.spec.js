...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationGitRepo();
  });
  ...
  describe('IntegrationGitRepo', function() {
    it('should create an instance of IntegrationGitRepo', function() {
      // uncomment below and update the code to test IntegrationGitRepo
      //var instane = new MorpheusApi.IntegrationGitRepo();
      //expect(instance).to.be.a(MorpheusApi.IntegrationGitRepo);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationGitRepo();
