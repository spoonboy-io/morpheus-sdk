...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterLayoutFile();
  });
  ...
  describe('ClusterLayoutFile', function() {
    it('should create an instance of ClusterLayoutFile', function() {
      // uncomment below and update the code to test ClusterLayoutFile
      //var instane = new MorpheusApi.ClusterLayoutFile();
      //expect(instance).to.be.a(MorpheusApi.ClusterLayoutFile);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterLayoutFile();
