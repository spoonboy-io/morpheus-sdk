...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.Environment();
  });
  ...
  describe('Environment', function() {
    it('should create an instance of Environment', function() {
      ...
      //var instane = new MorpheusApi.Environment();
      //expect(instance).to.be.a(MorpheusApi.Environment);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.Environment();
