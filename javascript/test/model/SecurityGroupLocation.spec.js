...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.SecurityGroupLocation();
  });
  ...
  describe('SecurityGroupLocation', function() {
    it('should create an instance of SecurityGroupLocation', function() {
      // uncomment below and update the code to test SecurityGroupLocation
      //var instane = new MorpheusApi.SecurityGroupLocation();
      //expect(instance).to.be.a(MorpheusApi.SecurityGroupLocation);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.SecurityGroupLocation();
