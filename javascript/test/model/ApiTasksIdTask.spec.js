...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiTasksIdTask();
  });
  ...
  describe('ApiTasksIdTask', function() {
    it('should create an instance of ApiTasksIdTask', function() {
      // uncomment below and update the code to test ApiTasksIdTask
      //var instane = new MorpheusApi.ApiTasksIdTask();
      //expect(instance).to.be.a(MorpheusApi.ApiTasksIdTask);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiTasksIdTask();
