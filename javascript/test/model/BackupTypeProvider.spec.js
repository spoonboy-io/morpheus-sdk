...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BackupTypeProvider();
  });
  ...
  describe('BackupTypeProvider', function() {
    it('should create an instance of BackupTypeProvider', function() {
      // uncomment below and update the code to test BackupTypeProvider
      //var instane = new MorpheusApi.BackupTypeProvider();
      //expect(instance).to.be.a(MorpheusApi.BackupTypeProvider);
    });
    ...
    it('should have the property locationType (base name: "locationType")', function() {
      ...
      //var instance = new MorpheusApi.BackupTypeProvider();
    ...
    it('should have the property sourceProviderId (base name: "sourceProviderId")', function() {
      // uncomment below and update the code to test the property sourceProviderId
      //var instance = new MorpheusApi.BackupTypeProvider();
      //expect(instance).to.be();
    });

    it('should have the property storageProviderId (base name: "storageProviderId")', function() {
      // uncomment below and update the code to test the property storageProviderId
      //var instance = new MorpheusApi.BackupTypeProvider();
      //expect(instance).to.be();
    });
