...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse2001();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse2001);
    });
    ...
    it('should have the property approval (base name: "approval")', function() {
      ...
      //var instance = new MorpheusApi.InlineResponse2001();
