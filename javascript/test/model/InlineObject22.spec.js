...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject22();
  });
  ...
  describe('InlineObject22', function() {
    it('should create an instance of InlineObject22', function() {
      ...
      //var instane = new MorpheusApi.InlineObject22();
      //expect(instance).to.be.a(MorpheusApi.InlineObject22);
    });
    ...
    it('should have the property budget (base name: "budget")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject22();
