...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesOktaConfig();
  });
  ...
  describe('IdentitySourcesOktaConfig', function() {
    it('should create an instance of IdentitySourcesOktaConfig', function() {
      // uncomment below and update the code to test IdentitySourcesOktaConfig
      //var instane = new MorpheusApi.IdentitySourcesOktaConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesOktaConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesOktaConfig();
