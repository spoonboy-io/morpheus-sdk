...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject5();
  });
  ...
  describe('InlineObject5', function() {
    it('should create an instance of InlineObject5', function() {
      ...
      //var instane = new MorpheusApi.InlineObject5();
      //expect(instance).to.be.a(MorpheusApi.InlineObject5);
    });
    ...
    it('should have the property instanceId (base name: "instanceId")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject5();
