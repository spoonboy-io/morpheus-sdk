...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse2003();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse2003);
    });

    it('should have the property app (base name: "app")', function() {
      // uncomment below and update the code to test the property app
      //var instance = new MorpheusApi.InlineResponse2003();
