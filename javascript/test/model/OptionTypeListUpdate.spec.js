...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.OptionTypeListUpdate();
  });
  ...
  describe('OptionTypeListUpdate', function() {
    it('should create an instance of OptionTypeListUpdate', function() {
      // uncomment below and update the code to test OptionTypeListUpdate
      //var instane = new MorpheusApi.OptionTypeListUpdate();
      //expect(instance).to.be.a(MorpheusApi.OptionTypeListUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.OptionTypeListUpdate();
