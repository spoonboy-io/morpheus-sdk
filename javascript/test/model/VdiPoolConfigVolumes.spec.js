...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.VdiPoolConfigVolumes();
  });
  ...
  describe('VdiPoolConfigVolumes', function() {
    it('should create an instance of VdiPoolConfigVolumes', function() {
      // uncomment below and update the code to test VdiPoolConfigVolumes
      //var instane = new MorpheusApi.VdiPoolConfigVolumes();
      //expect(instance).to.be.a(MorpheusApi.VdiPoolConfigVolumes);
    });
    ...
    it('should have the property rootVolume (base name: "rootVolume")', function() {
      ...
      //var instance = new MorpheusApi.VdiPoolConfigVolumes();
