...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject28();
  });
  ...
  describe('InlineObject28', function() {
    it('should create an instance of InlineObject28', function() {
      ...
      //var instane = new MorpheusApi.InlineObject28();
      //expect(instance).to.be.a(MorpheusApi.InlineObject28);
    });
    ...
    it('should have the property client (base name: "client")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject28();
