...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterHistoryItem();
  });
  ...
  describe('ClusterHistoryItem', function() {
    it('should create an instance of ClusterHistoryItem', function() {
      // uncomment below and update the code to test ClusterHistoryItem
      //var instane = new MorpheusApi.ClusterHistoryItem();
      //expect(instance).to.be.a(MorpheusApi.ClusterHistoryItem);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ClusterHistoryItem();
