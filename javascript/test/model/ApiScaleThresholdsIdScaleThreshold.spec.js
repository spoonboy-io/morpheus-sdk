...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiScaleThresholdsIdScaleThreshold();
  });
  ...
  describe('ApiScaleThresholdsIdScaleThreshold', function() {
    it('should create an instance of ApiScaleThresholdsIdScaleThreshold', function() {
      // uncomment below and update the code to test ApiScaleThresholdsIdScaleThreshold
      //var instane = new MorpheusApi.ApiScaleThresholdsIdScaleThreshold();
      //expect(instance).to.be.a(MorpheusApi.ApiScaleThresholdsIdScaleThreshold);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiScaleThresholdsIdScaleThreshold();
