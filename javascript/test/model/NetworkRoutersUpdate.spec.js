...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkRoutersUpdate();
  });
  ...
  describe('NetworkRoutersUpdate', function() {
    it('should create an instance of NetworkRoutersUpdate', function() {
      // uncomment below and update the code to test NetworkRoutersUpdate
      //var instane = new MorpheusApi.NetworkRoutersUpdate();
      //expect(instance).to.be.a(MorpheusApi.NetworkRoutersUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.NetworkRoutersUpdate();
