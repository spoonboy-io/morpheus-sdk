...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ResourcePermissions();
  });
  ...
  describe('ResourcePermissions', function() {
    it('should create an instance of ResourcePermissions', function() {
      ...
      //var instane = new MorpheusApi.ResourcePermissions();
      //expect(instance).to.be.a(MorpheusApi.ResourcePermissions);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new MorpheusApi.ResourcePermissions();
