...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CheckPush();
  });
  ...
  describe('CheckPush', function() {
    it('should create an instance of CheckPush', function() {
      // uncomment below and update the code to test CheckPush
      //var instane = new MorpheusApi.CheckPush();
      //expect(instance).to.be.a(MorpheusApi.CheckPush);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CheckPush();
