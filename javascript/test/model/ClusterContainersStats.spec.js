...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ClusterContainersStats();
  });
  ...
  describe('ClusterContainersStats', function() {
    it('should create an instance of ClusterContainersStats', function() {
      // uncomment below and update the code to test ClusterContainersStats
      //var instane = new MorpheusApi.ClusterContainersStats();
      //expect(instance).to.be.a(MorpheusApi.ClusterContainersStats);
    });

    it('should have the property ts (base name: "ts")', function() {
      // uncomment below and update the code to test the property ts
      //var instance = new MorpheusApi.ClusterContainersStats();
