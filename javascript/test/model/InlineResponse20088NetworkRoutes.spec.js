...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20088NetworkRoutes();
  });
  ...
  describe('InlineResponse20088NetworkRoutes', function() {
    it('should create an instance of InlineResponse20088NetworkRoutes', function() {
      // uncomment below and update the code to test InlineResponse20088NetworkRoutes
      //var instane = new MorpheusApi.InlineResponse20088NetworkRoutes();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20088NetworkRoutes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse20088NetworkRoutes();
