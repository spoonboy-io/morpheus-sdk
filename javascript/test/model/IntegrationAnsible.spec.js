...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationAnsible();
  });
  ...
  describe('IntegrationAnsible', function() {
    it('should create an instance of IntegrationAnsible', function() {
      // uncomment below and update the code to test IntegrationAnsible
      //var instane = new MorpheusApi.IntegrationAnsible();
      //expect(instance).to.be.a(MorpheusApi.IntegrationAnsible);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationAnsible();
