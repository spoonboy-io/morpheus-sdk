...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.Permissions();
  });
  ...
  describe('Permissions', function() {
    it('should create an instance of Permissions', function() {
      ...
      //var instane = new MorpheusApi.Permissions();
      //expect(instance).to.be.a(MorpheusApi.Permissions);
    });
    ...
    it('should have the property resourcePool (base name: "resourcePool")', function() {
      ...
      //var instance = new MorpheusApi.Permissions();
