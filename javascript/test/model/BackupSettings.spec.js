...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BackupSettings();
  });
  ...
  describe('BackupSettings', function() {
    it('should create an instance of BackupSettings', function() {
      ...
      //var instane = new MorpheusApi.BackupSettings();
      //expect(instance).to.be.a(MorpheusApi.BackupSettings);
    });
    ...
    it('should have the property backupsEnabled (base name: "backupsEnabled")', function() {
      ...
      //var instance = new MorpheusApi.BackupSettings();
