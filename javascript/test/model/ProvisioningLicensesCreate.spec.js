...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ProvisioningLicensesCreate();
  });
  ...
  describe('ProvisioningLicensesCreate', function() {
    it('should create an instance of ProvisioningLicensesCreate', function() {
      // uncomment below and update the code to test ProvisioningLicensesCreate
      //var instane = new MorpheusApi.ProvisioningLicensesCreate();
      //expect(instance).to.be.a(MorpheusApi.ProvisioningLicensesCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ProvisioningLicensesCreate();
