...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingServersServersInnerUsagesInner();
  });
  ...
  describe('BillingServersServersInnerUsagesInner', function() {
    it('should create an instance of BillingServersServersInnerUsagesInner', function() {
      // uncomment below and update the code to test BillingServersServersInnerUsagesInner
      //var instance = new MorpheusApi.BillingServersServersInnerUsagesInner();
      //expect(instance).to.be.a(MorpheusApi.BillingServersServersInnerUsagesInner);
    });
