...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiMonitoringGroupsIdCheckGroup();
  });
  ...
  describe('ApiMonitoringGroupsIdCheckGroup', function() {
    it('should create an instance of ApiMonitoringGroupsIdCheckGroup', function() {
      // uncomment below and update the code to test ApiMonitoringGroupsIdCheckGroup
      //var instane = new MorpheusApi.ApiMonitoringGroupsIdCheckGroup();
      //expect(instance).to.be.a(MorpheusApi.ApiMonitoringGroupsIdCheckGroup);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiMonitoringGroupsIdCheckGroup();
