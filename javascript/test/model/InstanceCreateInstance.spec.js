...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceCreateInstance();
  });
  ...
  describe('InstanceCreateInstance', function() {
    it('should create an instance of InstanceCreateInstance', function() {
      // uncomment below and update the code to test InstanceCreateInstance
      //var instane = new MorpheusApi.InstanceCreateInstance();
      //expect(instance).to.be.a(MorpheusApi.InstanceCreateInstance);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.InstanceCreateInstance();
