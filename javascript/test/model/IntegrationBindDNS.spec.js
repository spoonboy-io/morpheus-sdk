...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationBindDNS();
  });
  ...
  describe('IntegrationBindDNS', function() {
    it('should create an instance of IntegrationBindDNS', function() {
      // uncomment below and update the code to test IntegrationBindDNS
      //var instane = new MorpheusApi.IntegrationBindDNS();
      //expect(instance).to.be.a(MorpheusApi.IntegrationBindDNS);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationBindDNS();
