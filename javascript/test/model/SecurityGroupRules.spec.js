...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.SecurityGroupRules();
  });
  ...
  describe('SecurityGroupRules', function() {
    it('should create an instance of SecurityGroupRules', function() {
      // uncomment below and update the code to test SecurityGroupRules
      //var instane = new MorpheusApi.SecurityGroupRules();
      //expect(instance).to.be.a(MorpheusApi.SecurityGroupRules);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.SecurityGroupRules();
