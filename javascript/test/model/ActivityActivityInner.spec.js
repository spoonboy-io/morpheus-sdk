...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ActivityActivityInner();
  });
  ...
  describe('ActivityActivityInner', function() {
    it('should create an instance of ActivityActivityInner', function() {
      // uncomment below and update the code to test ActivityActivityInner
      //var instance = new MorpheusApi.ActivityActivityInner();
      //expect(instance).to.be.a(MorpheusApi.ActivityActivityInner);
    });
