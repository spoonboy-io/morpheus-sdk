...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesADConfig();
  });
  ...
  describe('IdentitySourcesADConfig', function() {
    it('should create an instance of IdentitySourcesADConfig', function() {
      // uncomment below and update the code to test IdentitySourcesADConfig
      //var instane = new MorpheusApi.IdentitySourcesADConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesADConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesADConfig();
