...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse200110NetworkProxy();
  });
  ...
  describe('InlineResponse200110NetworkProxy', function() {
    it('should create an instance of InlineResponse200110NetworkProxy', function() {
      // uncomment below and update the code to test InlineResponse200110NetworkProxy
      //var instane = new MorpheusApi.InlineResponse200110NetworkProxy();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse200110NetworkProxy);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse200110NetworkProxy();
