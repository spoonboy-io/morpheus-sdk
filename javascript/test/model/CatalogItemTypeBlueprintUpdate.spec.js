...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CatalogItemTypeBlueprintUpdate();
  });
  ...
  describe('CatalogItemTypeBlueprintUpdate', function() {
    it('should create an instance of CatalogItemTypeBlueprintUpdate', function() {
      // uncomment below and update the code to test CatalogItemTypeBlueprintUpdate
      //var instane = new MorpheusApi.CatalogItemTypeBlueprintUpdate();
      //expect(instance).to.be.a(MorpheusApi.CatalogItemTypeBlueprintUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CatalogItemTypeBlueprintUpdate();
