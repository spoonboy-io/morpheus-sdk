...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationObject();
  });
  ...
  describe('IntegrationObject', function() {
    it('should create an instance of IntegrationObject', function() {
      // uncomment below and update the code to test IntegrationObject
      //var instane = new MorpheusApi.IntegrationObject();
      //expect(instance).to.be.a(MorpheusApi.IntegrationObject);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationObject();
