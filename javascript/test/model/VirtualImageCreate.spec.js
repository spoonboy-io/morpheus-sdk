...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.VirtualImageCreate();
  });
  ...
  describe('VirtualImageCreate', function() {
    it('should create an instance of VirtualImageCreate', function() {
      // uncomment below and update the code to test VirtualImageCreate
      //var instane = new MorpheusApi.VirtualImageCreate();
      //expect(instance).to.be.a(MorpheusApi.VirtualImageCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.VirtualImageCreate();
