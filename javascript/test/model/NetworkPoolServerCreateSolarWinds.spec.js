...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkPoolServerCreateSolarWinds();
  });
  ...
  describe('NetworkPoolServerCreateSolarWinds', function() {
    it('should create an instance of NetworkPoolServerCreateSolarWinds', function() {
      // uncomment below and update the code to test NetworkPoolServerCreateSolarWinds
      //var instane = new MorpheusApi.NetworkPoolServerCreateSolarWinds();
      //expect(instance).to.be.a(MorpheusApi.NetworkPoolServerCreateSolarWinds);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new MorpheusApi.NetworkPoolServerCreateSolarWinds();
