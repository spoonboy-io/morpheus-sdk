...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.StorageServerTypeOptionTypes();
  });
  ...
  describe('StorageServerTypeOptionTypes', function() {
    it('should create an instance of StorageServerTypeOptionTypes', function() {
      // uncomment below and update the code to test StorageServerTypeOptionTypes
      //var instane = new MorpheusApi.StorageServerTypeOptionTypes();
      //expect(instance).to.be.a(MorpheusApi.StorageServerTypeOptionTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.StorageServerTypeOptionTypes();
