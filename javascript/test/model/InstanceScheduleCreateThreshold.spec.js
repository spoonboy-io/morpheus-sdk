...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceScheduleCreateThreshold();
  });
  ...
  describe('InstanceScheduleCreateThreshold', function() {
    it('should create an instance of InstanceScheduleCreateThreshold', function() {
      // uncomment below and update the code to test InstanceScheduleCreateThreshold
      //var instane = new MorpheusApi.InstanceScheduleCreateThreshold();
      //expect(instance).to.be.a(MorpheusApi.InstanceScheduleCreateThreshold);
    });

    it('should have the property sourceThresholdId (base name: "sourceThresholdId")', function() {
      // uncomment below and update the code to test the property sourceThresholdId
      //var instance = new MorpheusApi.InstanceScheduleCreateThreshold();
