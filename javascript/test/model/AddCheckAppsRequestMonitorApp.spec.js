...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.AddCheckAppsRequestMonitorApp();
  });
  ...
  describe('AddCheckAppsRequestMonitorApp', function() {
    it('should create an instance of AddCheckAppsRequestMonitorApp', function() {
      // uncomment below and update the code to test AddCheckAppsRequestMonitorApp
      //var instance = new MorpheusApi.AddCheckAppsRequestMonitorApp();
      //expect(instance).to.be.a(MorpheusApi.AddCheckAppsRequestMonitorApp);
    });
