...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject13();
  });
  ...
  describe('InlineObject13', function() {
    it('should create an instance of InlineObject13', function() {
      ...
      //var instane = new MorpheusApi.InlineObject13();
      //expect(instance).to.be.a(MorpheusApi.InlineObject13);
    });
    ...
    it('should have the property schedule (base name: "schedule")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject13();
