...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceScheduleThreshold();
  });
  ...
  describe('InstanceScheduleThreshold', function() {
    it('should create an instance of InstanceScheduleThreshold', function() {
      // uncomment below and update the code to test InstanceScheduleThreshold
      //var instane = new MorpheusApi.InstanceScheduleThreshold();
      //expect(instance).to.be.a(MorpheusApi.InstanceScheduleThreshold);
    });
    ...
    it('should have the property autoUp (base name: "autoUp")', function() {
      ...
      //var instance = new MorpheusApi.InstanceScheduleThreshold();
