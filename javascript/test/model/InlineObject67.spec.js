...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject67();
  });
  ...
  describe('InlineObject67', function() {
    it('should create an instance of InlineObject67', function() {
      ...
      //var instane = new MorpheusApi.InlineObject67();
      //expect(instance).to.be.a(MorpheusApi.InlineObject67);
    });
    ...
    it('should have the property deployment (base name: "deployment")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject67();
