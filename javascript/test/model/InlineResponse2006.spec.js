...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse2006();
  });
  ...
  describe('InlineResponse2006', function() {
    it('should create an instance of InlineResponse2006', function() {
      ...
      //var instane = new MorpheusApi.InlineResponse2006();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse2006);
    });

    it('should have the property success (base name: "success")', function() {
      // uncomment below and update the code to test the property success
      //var instance = new MorpheusApi.InlineResponse2006();
