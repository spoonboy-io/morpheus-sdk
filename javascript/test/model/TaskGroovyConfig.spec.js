...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskGroovyConfig();
  });
  ...
  describe('TaskGroovyConfig', function() {
    it('should create an instance of TaskGroovyConfig', function() {
      // uncomment below and update the code to test TaskGroovyConfig
      //var instane = new MorpheusApi.TaskGroovyConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskGroovyConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskGroovyConfig();
