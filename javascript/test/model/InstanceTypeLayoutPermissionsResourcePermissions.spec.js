...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceTypeLayoutPermissionsResourcePermissions();
  });
  ...
  describe('InstanceTypeLayoutPermissionsResourcePermissions', function() {
    it('should create an instance of InstanceTypeLayoutPermissionsResourcePermissions', function() {
      // uncomment below and update the code to test InstanceTypeLayoutPermissionsResourcePermissions
      //var instane = new MorpheusApi.InstanceTypeLayoutPermissionsResourcePermissions();
      //expect(instance).to.be.a(MorpheusApi.InstanceTypeLayoutPermissionsResourcePermissions);
    });
    ...
    it('should have the property defaultStore (base name: "defaultStore")', function() {
      ...
      //var instance = new MorpheusApi.InstanceTypeLayoutPermissionsResourcePermissions();
