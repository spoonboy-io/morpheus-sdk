...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject17();
  });
  ...
  describe('InlineObject17', function() {
    it('should create an instance of InlineObject17', function() {
      ...
      //var instane = new MorpheusApi.InlineObject17();
      //expect(instance).to.be.a(MorpheusApi.InlineObject17);
    });
    ...
    it('should have the property backup (base name: "backup")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject17();
