...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServerServerOs();
  });
  ...
  describe('ServerServerOs', function() {
    it('should create an instance of ServerServerOs', function() {
      // uncomment below and update the code to test ServerServerOs
      //var instane = new MorpheusApi.ServerServerOs();
      //expect(instance).to.be.a(MorpheusApi.ServerServerOs);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ServerServerOs();
