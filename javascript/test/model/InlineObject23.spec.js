...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject23();
  });
  ...
  describe('InlineObject23', function() {
    it('should create an instance of InlineObject23', function() {
      ...
      //var instane = new MorpheusApi.InlineObject23();
      //expect(instance).to.be.a(MorpheusApi.InlineObject23);
    });
    ...
    it('should have the property budget (base name: "budget")', function() {
      ...
      //var instance = new MorpheusApi.InlineObject23();
