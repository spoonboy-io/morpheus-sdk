...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkInterfaceUpdateSuccessNetworkInterface();
  });
  ...
  describe('NetworkInterfaceUpdateSuccessNetworkInterface', function() {
    it('should create an instance of NetworkInterfaceUpdateSuccessNetworkInterface', function() {
      // uncomment below and update the code to test NetworkInterfaceUpdateSuccessNetworkInterface
      //var instane = new MorpheusApi.NetworkInterfaceUpdateSuccessNetworkInterface();
      //expect(instance).to.be.a(MorpheusApi.NetworkInterfaceUpdateSuccessNetworkInterface);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.NetworkInterfaceUpdateSuccessNetworkInterface();
