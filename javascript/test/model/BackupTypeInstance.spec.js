...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BackupTypeInstance();
  });
  ...
  describe('BackupTypeInstance', function() {
    it('should create an instance of BackupTypeInstance', function() {
      // uncomment below and update the code to test BackupTypeInstance
      //var instane = new MorpheusApi.BackupTypeInstance();
      //expect(instance).to.be.a(MorpheusApi.BackupTypeInstance);
    });
    ...
    it('should have the property locationType (base name: "locationType")', function() {
      ...
      //var instance = new MorpheusApi.BackupTypeInstance();
