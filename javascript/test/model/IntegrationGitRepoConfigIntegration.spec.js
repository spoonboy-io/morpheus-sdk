...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationGitRepoConfigIntegration();
  });
  ...
  describe('IntegrationGitRepoConfigIntegration', function() {
    it('should create an instance of IntegrationGitRepoConfigIntegration', function() {
      // uncomment below and update the code to test IntegrationGitRepoConfigIntegration
      //var instane = new MorpheusApi.IntegrationGitRepoConfigIntegration();
      //expect(instance).to.be.a(MorpheusApi.IntegrationGitRepoConfigIntegration);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.IntegrationGitRepoConfigIntegration();
