...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationObjectLayout();
  });
  ...
  describe('IntegrationObjectLayout', function() {
    it('should create an instance of IntegrationObjectLayout', function() {
      // uncomment below and update the code to test IntegrationObjectLayout
      //var instane = new MorpheusApi.IntegrationObjectLayout();
      //expect(instance).to.be.a(MorpheusApi.IntegrationObjectLayout);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationObjectLayout();
