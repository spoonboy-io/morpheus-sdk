...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceTypeCreate();
  });
  ...
  describe('InstanceTypeCreate', function() {
    it('should create an instance of InstanceTypeCreate', function() {
      // uncomment below and update the code to test InstanceTypeCreate
      //var instane = new MorpheusApi.InstanceTypeCreate();
      //expect(instance).to.be.a(MorpheusApi.InstanceTypeCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.InstanceTypeCreate();
