...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GuidanceVmwareSizingResourceServerOs();
  });
  ...
  describe('GuidanceVmwareSizingResourceServerOs', function() {
    it('should create an instance of GuidanceVmwareSizingResourceServerOs', function() {
      // uncomment below and update the code to test GuidanceVmwareSizingResourceServerOs
      //var instane = new MorpheusApi.GuidanceVmwareSizingResourceServerOs();
      //expect(instance).to.be.a(MorpheusApi.GuidanceVmwareSizingResourceServerOs);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.GuidanceVmwareSizingResourceServerOs();
