...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskShellConfigTaskOptions();
  });
  ...
  describe('TaskShellConfigTaskOptions', function() {
    it('should create an instance of TaskShellConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskShellConfigTaskOptions
      //var instane = new MorpheusApi.TaskShellConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskShellConfigTaskOptions);
    });
    ...
    it('should have the property localScriptGitRef (base name: "localScriptGitRef")', function() {
      ...
      //var instance = new MorpheusApi.TaskShellConfigTaskOptions();
