...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskShellConfig();
  });
  ...
  describe('TaskShellConfig', function() {
    it('should create an instance of TaskShellConfig', function() {
      // uncomment below and update the code to test TaskShellConfig
      //var instane = new MorpheusApi.TaskShellConfig();
      //expect(instance).to.be.a(MorpheusApi.TaskShellConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TaskShellConfig();
