...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ContainerTypeUpdate();
  });
  ...
  describe('ContainerTypeUpdate', function() {
    it('should create an instance of ContainerTypeUpdate', function() {
      // uncomment below and update the code to test ContainerTypeUpdate
      //var instane = new MorpheusApi.ContainerTypeUpdate();
      //expect(instance).to.be.a(MorpheusApi.ContainerTypeUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ContainerTypeUpdate();
