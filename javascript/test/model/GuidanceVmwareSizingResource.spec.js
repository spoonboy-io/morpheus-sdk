...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GuidanceVmwareSizingResource();
  });
  ...
  describe('GuidanceVmwareSizingResource', function() {
    it('should create an instance of GuidanceVmwareSizingResource', function() {
      // uncomment below and update the code to test GuidanceVmwareSizingResource
      //var instane = new MorpheusApi.GuidanceVmwareSizingResource();
      //expect(instance).to.be.a(MorpheusApi.GuidanceVmwareSizingResource);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.GuidanceVmwareSizingResource();
    ...
    it('should have the property parentServer (base name: "parentServer")', function() {
      // uncomment below and update the code to test the property parentServer
      //var instance = new MorpheusApi.GuidanceVmwareSizingResource();
      //expect(instance).to.be();
    });
