...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiRolesRole();
  });
  ...
  describe('ApiRolesRole', function() {
    it('should create an instance of ApiRolesRole', function() {
      // uncomment below and update the code to test ApiRolesRole
      //var instane = new MorpheusApi.ApiRolesRole();
      //expect(instance).to.be.a(MorpheusApi.ApiRolesRole);
    });
    ...
    it('should have the property authority (base name: "authority")', function() {
      ...
      //var instance = new MorpheusApi.ApiRolesRole();
    ...
    it('should have the property baseRoleId (base name: "baseRoleId")', function() {
      // uncomment below and update the code to test the property baseRoleId
      //var instance = new MorpheusApi.ApiRolesRole();
      //expect(instance).to.be();
    });
