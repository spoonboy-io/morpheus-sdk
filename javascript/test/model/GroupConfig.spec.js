...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.GroupConfig();
  });
  ...
  describe('GroupConfig', function() {
    it('should create an instance of GroupConfig', function() {
      // uncomment below and update the code to test GroupConfig
      //var instane = new MorpheusApi.GroupConfig();
      //expect(instance).to.be.a(MorpheusApi.GroupConfig);
    });
    ...
    it('should have the property dnsIntegrationId (base name: "dnsIntegrationId")', function() {
      ...
      //var instance = new MorpheusApi.GroupConfig();
