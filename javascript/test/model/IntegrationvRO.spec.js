...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IntegrationvRO();
  });
  ...
  describe('IntegrationvRO', function() {
    it('should create an instance of IntegrationvRO', function() {
      // uncomment below and update the code to test IntegrationvRO
      //var instane = new MorpheusApi.IntegrationvRO();
      //expect(instance).to.be.a(MorpheusApi.IntegrationvRO);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IntegrationvRO();
