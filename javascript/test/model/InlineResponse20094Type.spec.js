...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineResponse20094Type();
  });
  ...
  describe('InlineResponse20094Type', function() {
    it('should create an instance of InlineResponse20094Type', function() {
      // uncomment below and update the code to test InlineResponse20094Type
      //var instane = new MorpheusApi.InlineResponse20094Type();
      //expect(instance).to.be.a(MorpheusApi.InlineResponse20094Type);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.InlineResponse20094Type();
