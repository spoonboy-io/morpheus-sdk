...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.UserCreate();
  });
  ...
  describe('UserCreate', function() {
    it('should create an instance of UserCreate', function() {
      ...
      //var instane = new MorpheusApi.UserCreate();
      //expect(instance).to.be.a(MorpheusApi.UserCreate);
    });

    it('should have the property firstName (base name: "firstName")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new MorpheusApi.UserCreate();
