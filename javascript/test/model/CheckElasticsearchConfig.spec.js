...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CheckElasticsearchConfig();
  });
  ...
  describe('CheckElasticsearchConfig', function() {
    it('should create an instance of CheckElasticsearchConfig', function() {
      // uncomment below and update the code to test CheckElasticsearchConfig
      //var instane = new MorpheusApi.CheckElasticsearchConfig();
      //expect(instance).to.be.a(MorpheusApi.CheckElasticsearchConfig);
    });

    it('should have the property esHost (base name: "esHost")', function() {
      // uncomment below and update the code to test the property esHost
      //var instance = new MorpheusApi.CheckElasticsearchConfig();
      //expect(instance).to.be();
    });

    it('should have the property esPort (base name: "esPort")', function() {
      // uncomment below and update the code to test the property esPort
      //var instance = new MorpheusApi.CheckElasticsearchConfig();
      //expect(instance).to.be();
    });
