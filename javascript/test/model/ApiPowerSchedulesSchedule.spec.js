...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiPowerSchedulesSchedule();
  });
  ...
  describe('ApiPowerSchedulesSchedule', function() {
    it('should create an instance of ApiPowerSchedulesSchedule', function() {
      // uncomment below and update the code to test ApiPowerSchedulesSchedule
      //var instane = new MorpheusApi.ApiPowerSchedulesSchedule();
      //expect(instance).to.be.a(MorpheusApi.ApiPowerSchedulesSchedule);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.ApiPowerSchedulesSchedule();
