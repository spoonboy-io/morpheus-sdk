...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.IdentitySourcesAzureADConfig();
  });
  ...
  describe('IdentitySourcesAzureADConfig', function() {
    it('should create an instance of IdentitySourcesAzureADConfig', function() {
      // uncomment below and update the code to test IdentitySourcesAzureADConfig
      //var instane = new MorpheusApi.IdentitySourcesAzureADConfig();
      //expect(instance).to.be.a(MorpheusApi.IdentitySourcesAzureADConfig);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.IdentitySourcesAzureADConfig();
