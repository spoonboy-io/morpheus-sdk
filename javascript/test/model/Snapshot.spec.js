...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.Snapshot();
  });
  ...
  describe('Snapshot', function() {
    it('should create an instance of Snapshot', function() {
      ...
      //var instane = new MorpheusApi.Snapshot();
      //expect(instance).to.be.a(MorpheusApi.Snapshot);
    });
    ...
    it('should have the property snapshot (base name: "snapshot")', function() {
      ...
      //var instance = new MorpheusApi.Snapshot();
