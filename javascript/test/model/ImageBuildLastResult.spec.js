...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ImageBuildLastResult();
  });
  ...
  describe('ImageBuildLastResult', function() {
    it('should create an instance of ImageBuildLastResult', function() {
      // uncomment below and update the code to test ImageBuildLastResult
      //var instane = new MorpheusApi.ImageBuildLastResult();
      //expect(instance).to.be.a(MorpheusApi.ImageBuildLastResult);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ImageBuildLastResult();
