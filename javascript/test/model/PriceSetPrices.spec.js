...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.PriceSetPrices();
  });
  ...
  describe('PriceSetPrices', function() {
    it('should create an instance of PriceSetPrices', function() {
      // uncomment below and update the code to test PriceSetPrices
      //var instane = new MorpheusApi.PriceSetPrices();
      //expect(instance).to.be.a(MorpheusApi.PriceSetPrices);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.PriceSetPrices();
