...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingServersServersInner();
  });
  ...
  describe('BillingServersServersInner', function() {
    it('should create an instance of BillingServersServersInner', function() {
      // uncomment below and update the code to test BillingServersServersInner
      //var instance = new MorpheusApi.BillingServersServersInner();
      //expect(instance).to.be.a(MorpheusApi.BillingServersServersInner);
    });
