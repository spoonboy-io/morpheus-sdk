...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TenantGroup();
  });
  ...
  describe('TenantGroup', function() {
    it('should create an instance of TenantGroup', function() {
      ...
      //var instane = new MorpheusApi.TenantGroup();
      //expect(instance).to.be.a(MorpheusApi.TenantGroup);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.TenantGroup();
