...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CatalogItemTypeWorkflowUpdate();
  });
  ...
  describe('CatalogItemTypeWorkflowUpdate', function() {
    it('should create an instance of CatalogItemTypeWorkflowUpdate', function() {
      // uncomment below and update the code to test CatalogItemTypeWorkflowUpdate
      //var instane = new MorpheusApi.CatalogItemTypeWorkflowUpdate();
      //expect(instance).to.be.a(MorpheusApi.CatalogItemTypeWorkflowUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CatalogItemTypeWorkflowUpdate();
