...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ServerServicePlans();
  });
  ...
  describe('ServerServicePlans', function() {
    it('should create an instance of ServerServicePlans', function() {
      // uncomment below and update the code to test ServerServicePlans
      //var instane = new MorpheusApi.ServerServicePlans();
      //expect(instance).to.be.a(MorpheusApi.ServerServicePlans);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ServerServicePlans();
    ...
    it('should have the property maxDataStorage (base name: "maxDataStorage")', function() {
      // uncomment below and update the code to test the property maxDataStorage
      //var instance = new MorpheusApi.ServerServicePlans();
      //expect(instance).to.be();
    });
