...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.NetworkRoutersCreate();
  });
  ...
  describe('NetworkRoutersCreate', function() {
    it('should create an instance of NetworkRoutersCreate', function() {
      // uncomment below and update the code to test NetworkRoutersCreate
      //var instane = new MorpheusApi.NetworkRoutersCreate();
      //expect(instance).to.be.a(MorpheusApi.NetworkRoutersCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.NetworkRoutersCreate();
