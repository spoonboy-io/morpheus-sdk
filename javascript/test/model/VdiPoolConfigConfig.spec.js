...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.VdiPoolConfigConfig();
  });
  ...
  describe('VdiPoolConfigConfig', function() {
    it('should create an instance of VdiPoolConfigConfig', function() {
      // uncomment below and update the code to test VdiPoolConfigConfig
      //var instane = new MorpheusApi.VdiPoolConfigConfig();
      //expect(instance).to.be.a(MorpheusApi.VdiPoolConfigConfig);
    });
    ...
    it('should have the property createUser (base name: "createUser")', function() {
      ...
      //var instance = new MorpheusApi.VdiPoolConfigConfig();
