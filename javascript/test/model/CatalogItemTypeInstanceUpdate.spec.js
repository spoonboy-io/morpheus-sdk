...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CatalogItemTypeInstanceUpdate();
  });
  ...
  describe('CatalogItemTypeInstanceUpdate', function() {
    it('should create an instance of CatalogItemTypeInstanceUpdate', function() {
      // uncomment below and update the code to test CatalogItemTypeInstanceUpdate
      //var instane = new MorpheusApi.CatalogItemTypeInstanceUpdate();
      //expect(instance).to.be.a(MorpheusApi.CatalogItemTypeInstanceUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CatalogItemTypeInstanceUpdate();
