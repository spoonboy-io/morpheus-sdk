...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ImageBuildConfigVolumes();
  });
  ...
  describe('ImageBuildConfigVolumes', function() {
    it('should create an instance of ImageBuildConfigVolumes', function() {
      // uncomment below and update the code to test ImageBuildConfigVolumes
      //var instane = new MorpheusApi.ImageBuildConfigVolumes();
      //expect(instance).to.be.a(MorpheusApi.ImageBuildConfigVolumes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ImageBuildConfigVolumes();
