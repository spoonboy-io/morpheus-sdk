...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.TaskVroConfigTaskOptions();
  });
  ...
  describe('TaskVroConfigTaskOptions', function() {
    it('should create an instance of TaskVroConfigTaskOptions', function() {
      // uncomment below and update the code to test TaskVroConfigTaskOptions
      //var instane = new MorpheusApi.TaskVroConfigTaskOptions();
      //expect(instance).to.be.a(MorpheusApi.TaskVroConfigTaskOptions);
    });
    ...
    it('should have the property sshKey (base name: "sshKey")', function() {
      ...
      //var instance = new MorpheusApi.TaskVroConfigTaskOptions();
    ...
    it('should have the property vroBody (base name: "vroBody")', function() {
      // uncomment below and update the code to test the property vroBody
      //var instance = new MorpheusApi.TaskVroConfigTaskOptions();
      //expect(instance).to.be();
    });
