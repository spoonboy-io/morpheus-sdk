...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ApiSubnetsResourcePermission();
  });
  ...
  describe('ApiSubnetsResourcePermission', function() {
    it('should create an instance of ApiSubnetsResourcePermission', function() {
      // uncomment below and update the code to test ApiSubnetsResourcePermission
      //var instane = new MorpheusApi.ApiSubnetsResourcePermission();
      //expect(instance).to.be.a(MorpheusApi.ApiSubnetsResourcePermission);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new MorpheusApi.ApiSubnetsResourcePermission();
