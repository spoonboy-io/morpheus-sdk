...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject42();
  });
  ...
  describe('InlineObject42', function() {
    it('should create an instance of InlineObject42', function() {
      ...
      //var instane = new MorpheusApi.InlineObject42();
      //expect(instance).to.be.a(MorpheusApi.InlineObject42);
    });

    it('should have the property zone (base name: "zone")', function() {
      // uncomment below and update the code to test the property zone
      //var instance = new MorpheusApi.InlineObject42();
