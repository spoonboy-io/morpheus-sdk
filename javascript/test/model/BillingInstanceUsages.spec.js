...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.BillingInstanceUsages();
  });
  ...
  describe('BillingInstanceUsages', function() {
    it('should create an instance of BillingInstanceUsages', function() {
      // uncomment below and update the code to test BillingInstanceUsages
      //var instane = new MorpheusApi.BillingInstanceUsages();
      //expect(instance).to.be.a(MorpheusApi.BillingInstanceUsages);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.BillingInstanceUsages();
