...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.ZoneTypeServerTypes();
  });
  ...
  describe('ZoneTypeServerTypes', function() {
    it('should create an instance of ZoneTypeServerTypes', function() {
      // uncomment below and update the code to test ZoneTypeServerTypes
      //var instane = new MorpheusApi.ZoneTypeServerTypes();
      //expect(instance).to.be.a(MorpheusApi.ZoneTypeServerTypes);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MorpheusApi.ZoneTypeServerTypes();
