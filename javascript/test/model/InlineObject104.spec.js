...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InlineObject104();
  });
  ...
  describe('InlineObject104', function() {
    it('should create an instance of InlineObject104', function() {
      ...
      //var instane = new MorpheusApi.InlineObject104();
      //expect(instance).to.be.a(MorpheusApi.InlineObject104);
    });

    it('should have the property job (base name: "job")', function() {
      // uncomment below and update the code to test the property job
      //var instance = new MorpheusApi.InlineObject104();
