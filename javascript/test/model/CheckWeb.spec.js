...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.CheckWeb();
  });
  ...
  describe('CheckWeb', function() {
    it('should create an instance of CheckWeb', function() {
      // uncomment below and update the code to test CheckWeb
      //var instane = new MorpheusApi.CheckWeb();
      //expect(instance).to.be.a(MorpheusApi.CheckWeb);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.CheckWeb();
