...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MorpheusApi.InstanceTypeLayoutUpdate();
  });
  ...
  describe('InstanceTypeLayoutUpdate', function() {
    it('should create an instance of InstanceTypeLayoutUpdate', function() {
      // uncomment below and update the code to test InstanceTypeLayoutUpdate
      //var instane = new MorpheusApi.InstanceTypeLayoutUpdate();
      //expect(instance).to.be.a(MorpheusApi.InstanceTypeLayoutUpdate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MorpheusApi.InstanceTypeLayoutUpdate();
