...
export default class ClientsApi {
    ...
    */
     ...
     * @param {String} opts.sort Sort order, the name of the property to sort by (default to 'clientId')
     * @param {module:model/String} opts.direction Sort direction, use 'desc' to reverse sort (default to 'asc')
     * @param {String} opts.phrase Search phrase for partial matches on clientId
     * @param {String} opts.clientId Search phrase for partial matches on clientId
