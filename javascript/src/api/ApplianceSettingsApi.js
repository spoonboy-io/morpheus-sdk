...
export default class ApplianceSettingsApi {
    ...
    */
     ...
     * @param {module:model/ListApplianceSettings200Response} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ListApplianceSettings200Response}
     */
    listApplianceSettings(callback) {
      ...
      let returnType = ListApplianceSettings200Response;
     ...
     * @param {Boolean} [enabled] Pass true to turn on maintenance mode, or false to turn it off. If no value is given then it will be toggled from off to on or vice versa.
     ...
     * Update Appliance Settings
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateApplianceSettingsRequest} [updateApplianceSettingsRequest] 
    ...
    updateApplianceSettings(opts, callback) {
      opts = opts || {};
      let postBody = opts['updateApplianceSettingsRequest'];
