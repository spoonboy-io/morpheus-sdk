...
import InlineResponse20094NetworkRouters from './InlineResponse20094NetworkRouters';
...
class InlineResponse20094 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkRouters')) {
                obj['networkRouters'] = ApiClient.convertToType(data['networkRouters'], [InlineResponse20094NetworkRouters]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/InlineResponse20094NetworkRouters>} networkRouters
 */
InlineResponse20094.prototype['networkRouters'] = undefined;
