...
import SecurityPackageType from './SecurityPackageType';
...
class InlineResponse200136 {
    ...
    constructor() { 
        ...
        InlineResponse200136.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('securityPackageType')) {
                obj['securityPackageType'] = SecurityPackageType.constructFromObject(data['securityPackageType']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/SecurityPackageType} securityPackageType
 */
InlineResponse200136.prototype['securityPackageType'] = undefined;
...
export default InlineResponse200136;
