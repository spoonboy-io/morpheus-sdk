...
import ZoneResourcePool from './ZoneResourcePool';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resourcePool')) {
                obj['resourcePool'] = ApiClient.convertToType(data['resourcePool'], ZoneResourcePool);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ZoneResourcePool} resourcePool
 */
InlineResponse20024.prototype['resourcePool'] = undefined;
