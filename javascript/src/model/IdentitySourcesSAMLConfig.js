...
import IdentitySourcesSAMLConfigConfig from './IdentitySourcesSAMLConfigConfig';
...
/**
 * The IdentitySourcesSAMLConfig model module.
 * @module model/IdentitySourcesSAMLConfig
 * @version 6.2.1
 */
class IdentitySourcesSAMLConfig {
    /**
     * Constructs a new <code>IdentitySourcesSAMLConfig</code>.
     * @alias module:model/IdentitySourcesSAMLConfig
     */
    constructor() { 
        
        IdentitySourcesSAMLConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IdentitySourcesSAMLConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentitySourcesSAMLConfig} obj Optional instance to populate.
     * @return {module:model/IdentitySourcesSAMLConfig} The populated <code>IdentitySourcesSAMLConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentitySourcesSAMLConfig();
            ...
            if (data.hasOwnProperty('config')) {
                obj['config'] = IdentitySourcesSAMLConfigConfig.constructFromObject(data['config']);
            }
 ...
 * @member {Number} id
 */
IdentitySourcesSAMLConfig.prototype['id'] = undefined;

/**
 * @member {String} name
 */
IdentitySourcesSAMLConfig.prototype['name'] = undefined;

/**
 * @member {String} description
 */
IdentitySourcesSAMLConfig.prototype['description'] = undefined;

/**
 * @member {String} code
 */
IdentitySourcesSAMLConfig.prototype['code'] = undefined;

/**
 * @member {String} type
 */
IdentitySourcesSAMLConfig.prototype['type'] = undefined;

/**
 * @member {Boolean} active
 */
IdentitySourcesSAMLConfig.prototype['active'] = undefined;

/**
 * @member {Boolean} deleted
 */
IdentitySourcesSAMLConfig.prototype['deleted'] = undefined;

/**
 * @member {Boolean} autoSyncOnLogin
 */
IdentitySourcesSAMLConfig.prototype['autoSyncOnLogin'] = undefined;

/**
 * @member {Boolean} externalLogin
 */
IdentitySourcesSAMLConfig.prototype['externalLogin'] = undefined;

/**
 * @member {Boolean} allowCustomMappings
 */
IdentitySourcesSAMLConfig.prototype['allowCustomMappings'] = undefined;

/**
 * @member {Boolean} manualRoleAssignment
 */
IdentitySourcesSAMLConfig.prototype['manualRoleAssignment'] = undefined;

/**
 * @member {module:model/InlineResponse20040AppDeployInstance} account
 */
IdentitySourcesSAMLConfig.prototype['account'] = undefined;

/**
 * @member {module:model/IdentitySourcesLDAPConfigDefaultAccountRole} defaultAccountRole
 */
IdentitySourcesSAMLConfig.prototype['defaultAccountRole'] = undefined;

/**
 * @member {module:model/IdentitySourcesSAMLConfigConfig} config
 */
IdentitySourcesSAMLConfig.prototype['config'] = undefined;

/**
 * @member {Array.<module:model/IdentitySourcesSAMLConfigRoleMappings>} roleMappings
 */
IdentitySourcesSAMLConfig.prototype['roleMappings'] = undefined;

/**
 * @member {String} subdomain
 */
IdentitySourcesSAMLConfig.prototype['subdomain'] = undefined;

/**
 * @member {String} loginURL
 */
IdentitySourcesSAMLConfig.prototype['loginURL'] = undefined;

/**
 * @member {module:model/IdentitySourcesSAMLConfigProviderSettings} providerSettings
 */
IdentitySourcesSAMLConfig.prototype['providerSettings'] = undefined;

/**
 * @member {Date} dateCreated
 */
IdentitySourcesSAMLConfig.prototype['dateCreated'] = undefined;

/**
 * @member {Date} lastUpdated
 */
IdentitySourcesSAMLConfig.prototype['lastUpdated'] = undefined;
...
export default IdentitySourcesSAMLConfig;
