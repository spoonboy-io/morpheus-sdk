...
import InlineResponse200106NetworkPool from './InlineResponse200106NetworkPool';
...
class InlineResponse200106 {
    ...
    constructor() { 
        ...
        InlineResponse200106.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkPool')) {
                obj['networkPool'] = InlineResponse200106NetworkPool.constructFromObject(data['networkPool']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse200106NetworkPool} networkPool
 */
InlineResponse200106.prototype['networkPool'] = undefined;
