...
/**
 * The ZoneTypeOptionTypes model module.
 * @module model/ZoneTypeOptionTypes
 * @version 6.2.1
 */
class ZoneTypeOptionTypes {
    /**
     * Constructs a new <code>ZoneTypeOptionTypes</code>.
     * @alias module:model/ZoneTypeOptionTypes
     */
    constructor() { 
        
        ZoneTypeOptionTypes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ZoneTypeOptionTypes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ZoneTypeOptionTypes} obj Optional instance to populate.
     * @return {module:model/ZoneTypeOptionTypes} The populated <code>ZoneTypeOptionTypes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ZoneTypeOptionTypes();
 ...
 * @member {Number} id
 */
ZoneTypeOptionTypes.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ZoneTypeOptionTypes.prototype['name'] = undefined;

/**
 * @member {String} description
 */
ZoneTypeOptionTypes.prototype['description'] = undefined;

/**
 * @member {String} code
 */
ZoneTypeOptionTypes.prototype['code'] = undefined;

/**
 * @member {String} fieldName
 */
ZoneTypeOptionTypes.prototype['fieldName'] = undefined;

/**
 * @member {String} fieldLabel
 */
ZoneTypeOptionTypes.prototype['fieldLabel'] = undefined;

/**
 * @member {String} fieldCode
 */
ZoneTypeOptionTypes.prototype['fieldCode'] = undefined;

/**
 * @member {String} fieldContext
 */
ZoneTypeOptionTypes.prototype['fieldContext'] = undefined;

/**
 * @member {String} fieldGroup
 */
ZoneTypeOptionTypes.prototype['fieldGroup'] = undefined;

/**
 * @member {String} fieldClass
 */
ZoneTypeOptionTypes.prototype['fieldClass'] = undefined;

/**
 * @member {String} fieldAddOn
 */
ZoneTypeOptionTypes.prototype['fieldAddOn'] = undefined;

/**
 * @member {String} fieldComponent
 */
ZoneTypeOptionTypes.prototype['fieldComponent'] = undefined;

/**
 * @member {String} fieldInput
 */
ZoneTypeOptionTypes.prototype['fieldInput'] = undefined;

/**
 * @member {String} placeHolder
 */
ZoneTypeOptionTypes.prototype['placeHolder'] = undefined;

/**
 * @member {String} verifyPattern
 */
ZoneTypeOptionTypes.prototype['verifyPattern'] = undefined;

/**
 * @member {String} helpBlock
 */
ZoneTypeOptionTypes.prototype['helpBlock'] = undefined;

/**
 * @member {String} helpBlockFieldCode
 */
ZoneTypeOptionTypes.prototype['helpBlockFieldCode'] = undefined;

/**
 * @member {String} defaultValue
 */
ZoneTypeOptionTypes.prototype['defaultValue'] = undefined;

/**
 * @member {String} optionSource
 */
ZoneTypeOptionTypes.prototype['optionSource'] = undefined;

/**
 * @member {String} optionSourceType
 */
ZoneTypeOptionTypes.prototype['optionSourceType'] = undefined;

/**
 * @member {String} optionList
 */
ZoneTypeOptionTypes.prototype['optionList'] = undefined;

/**
 * @member {String} type
 */
ZoneTypeOptionTypes.prototype['type'] = undefined;

/**
 * @member {Boolean} advanced
 */
ZoneTypeOptionTypes.prototype['advanced'] = undefined;

/**
 * @member {Boolean} required
 */
ZoneTypeOptionTypes.prototype['required'] = undefined;

/**
 * @member {Boolean} exportMeta
 */
ZoneTypeOptionTypes.prototype['exportMeta'] = undefined;

/**
 * @member {Boolean} editable
 */
ZoneTypeOptionTypes.prototype['editable'] = undefined;

/**
 * @member {Boolean} creatable
 */
ZoneTypeOptionTypes.prototype['creatable'] = undefined;

/**
 * @member {Object} config
 */
ZoneTypeOptionTypes.prototype['config'] = undefined;

/**
 * @member {Number} displayOrder
 */
ZoneTypeOptionTypes.prototype['displayOrder'] = undefined;

/**
 * @member {String} wrapperClass
 */
ZoneTypeOptionTypes.prototype['wrapperClass'] = undefined;

/**
 * @member {Boolean} enabled
 */
ZoneTypeOptionTypes.prototype['enabled'] = undefined;

/**
 * @member {Boolean} noBlank
 */
ZoneTypeOptionTypes.prototype['noBlank'] = undefined;

/**
 * @member {String} dependsOnCode
 */
ZoneTypeOptionTypes.prototype['dependsOnCode'] = undefined;

/**
 * @member {String} visibleOnCode
 */
ZoneTypeOptionTypes.prototype['visibleOnCode'] = undefined;

/**
 * @member {String} requireOnCode
 */
ZoneTypeOptionTypes.prototype['requireOnCode'] = undefined;

/**
 * @member {Boolean} contextualDefault
 */
ZoneTypeOptionTypes.prototype['contextualDefault'] = undefined;

/**
 * @member {Boolean} displayValueOnDetails
 */
ZoneTypeOptionTypes.prototype['displayValueOnDetails'] = undefined;

/**
 * @member {Boolean} showOnCreate
 */
ZoneTypeOptionTypes.prototype['showOnCreate'] = undefined;

/**
 * @member {Boolean} showOnEdit
 */
ZoneTypeOptionTypes.prototype['showOnEdit'] = undefined;

/**
 * @member {Boolean} localCredential
 */
ZoneTypeOptionTypes.prototype['localCredential'] = undefined;
...
export default ZoneTypeOptionTypes;
