...
/**
 * The ServerInterfaces model module.
 * @module model/ServerInterfaces
 * @version 6.2.1
 */
class ServerInterfaces {
    /**
     * Constructs a new <code>ServerInterfaces</code>.
     * @alias module:model/ServerInterfaces
     */
    constructor() { 
        
        ServerInterfaces.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerInterfaces</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerInterfaces} obj Optional instance to populate.
     * @return {module:model/ServerInterfaces} The populated <code>ServerInterfaces</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerInterfaces();
            ...
            if (data.hasOwnProperty('networkPool')) {
                obj['networkPool'] = InlineResponse20082LoadBalancerInstanceSslCert.constructFromObject(data['networkPool']);
            }
            if (data.hasOwnProperty('networkDomain')) {
                obj['networkDomain'] = ApiClient.convertToType(data['networkDomain'], 'String');
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = PriceSetVolumeType.constructFromObject(data['type']);
            }
 ...
 * @member {Number} id
 */
ServerInterfaces.prototype['id'] = undefined;

/**
 * @member {String} refType
 */
ServerInterfaces.prototype['refType'] = undefined;

/**
 * @member {String} refId
 */
ServerInterfaces.prototype['refId'] = undefined;

/**
 * @member {String} name
 */
ServerInterfaces.prototype['name'] = undefined;

/**
 * @member {String} internalId
 */
ServerInterfaces.prototype['internalId'] = undefined;

/**
 * @member {String} externalId
 */
ServerInterfaces.prototype['externalId'] = undefined;

/**
 * @member {String} uniqueId
 */
ServerInterfaces.prototype['uniqueId'] = undefined;

/**
 * @member {String} publicIpAddress
 */
ServerInterfaces.prototype['publicIpAddress'] = undefined;

/**
 * @member {String} publicIpv6Address
 */
ServerInterfaces.prototype['publicIpv6Address'] = undefined;

/**
 * @member {String} ipAddress
 */
ServerInterfaces.prototype['ipAddress'] = undefined;

/**
 * @member {String} ipv6Address
 */
ServerInterfaces.prototype['ipv6Address'] = undefined;

/**
 * @member {String} ipSubnet
 */
ServerInterfaces.prototype['ipSubnet'] = undefined;

/**
 * @member {String} ipv6Subnet
 */
ServerInterfaces.prototype['ipv6Subnet'] = undefined;

/**
 * @member {String} description
 */
ServerInterfaces.prototype['description'] = undefined;

/**
 * @member {Boolean} dhcp
 */
ServerInterfaces.prototype['dhcp'] = undefined;

/**
 * @member {Boolean} active
 */
ServerInterfaces.prototype['active'] = undefined;

/**
 * @member {Boolean} poolAssigned
 */
ServerInterfaces.prototype['poolAssigned'] = undefined;

/**
 * @member {Boolean} primaryInterface
 */
ServerInterfaces.prototype['primaryInterface'] = undefined;

/**
 * @member {module:model/InlineResponse20040AppDeployInstance} network
 */
ServerInterfaces.prototype['network'] = undefined;

/**
 * @member {String} subnet
 */
ServerInterfaces.prototype['subnet'] = undefined;

/**
 * @member {String} networkGroup
 */
ServerInterfaces.prototype['networkGroup'] = undefined;

/**
 * @member {String} networkPosition
 */
ServerInterfaces.prototype['networkPosition'] = undefined;

/**
 * @member {module:model/InlineResponse20082LoadBalancerInstanceSslCert} networkPool
 */
ServerInterfaces.prototype['networkPool'] = undefined;

/**
 * @member {String} networkDomain
 */
ServerInterfaces.prototype['networkDomain'] = undefined;

/**
 * @member {module:model/PriceSetVolumeType} type
 */
ServerInterfaces.prototype['type'] = undefined;

/**
 * @member {String} ipMode
 */
ServerInterfaces.prototype['ipMode'] = undefined;

/**
 * @member {String} macAddress
 */
ServerInterfaces.prototype['macAddress'] = undefined;
