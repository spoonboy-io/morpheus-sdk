 ...
 */
NetworkUpdate.prototype['displayName'] = undefined;

/**
 * Array of label strings, can be used for filtering.
 * @member {Array.<String>} labels
 */
NetworkUpdate.prototype['labels'] = undefined;

/**
 * Description
 * @member {String} description
 */
NetworkUpdate.prototype['description'] = undefined;

/**
 * CIDR Network
 * @member {String} cidr
 */
NetworkUpdate.prototype['cidr'] = undefined;
 ...
 */
NetworkUpdate.prototype['dnsPrimary'] = undefined;

/**
 * Secondary DNS Server
 * @member {String} dnsSecondary
 */
NetworkUpdate.prototype['dnsSecondary'] = undefined;

/**
 * @member {Number} vlanId
 */
NetworkUpdate.prototype['vlanId'] = undefined;

/**
 * Network Pool ID
 * @member {Number} pool
 */
NetworkUpdate.prototype['pool'] = undefined;

/**
 * Allow IP Override
 * @member {Boolean} allowStaticOverride
 */
NetworkUpdate.prototype['allowStaticOverride'] = undefined;

/**
 * Assign Public IP
 * @member {Boolean} assignPublicIp
 */
NetworkUpdate.prototype['assignPublicIp'] = undefined;

/**
 * Activate (true) or disable (false) the network
 * @member {Boolean} active
 */
NetworkUpdate.prototype['active'] = undefined;

/**
 * DHCP Server enabled network
 * @member {Boolean} dhcpServer
 */
NetworkUpdate.prototype['dhcpServer'] = undefined;

/**
 * @member {module:model/NetworkCreateNetworkDomain} networkDomain
 */
NetworkUpdate.prototype['networkDomain'] = undefined;

/**
 * Search Domains
 * @member {String} searchDomains
 */
NetworkUpdate.prototype['searchDomains'] = undefined;

/**
 * @member {module:model/NetworkCreateNetworkProxy} networkProxy
 */
NetworkUpdate.prototype['networkProxy'] = undefined;

/**
 * Bypass Proxy for Appliance URL
 * @member {Boolean} applianceUrlProxyBypass
 */
NetworkUpdate.prototype['applianceUrlProxyBypass'] = undefined;
 ...
 */
NetworkUpdate.prototype['noProxy'] = undefined;

/**
 * Visibility, private or public.
 * @member {module:model/NetworkUpdate.VisibilityEnum} visibility
 * @default 'private'
 */
NetworkUpdate.prototype['visibility'] = 'private';

/**
 * Configuration object. Settings vary by type.
 * @member {Object} config
 */
NetworkUpdate.prototype['config'] = undefined;

/**
 * Array of tenant account ids that are allowed access
 * @member {Array.<module:model/ApiBlueprintsIdUpdatePermissionsResourcePermissionSites>} tenants
 */
NetworkUpdate.prototype['tenants'] = undefined;

/**
 * @member {module:model/NetworkCreateResourcePermissions} resourcePermissions
 */
NetworkUpdate.prototype['resourcePermissions'] = undefined;
