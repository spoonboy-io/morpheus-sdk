...
/**
 * The BackupTypeServer model module.
 * @module model/BackupTypeServer
 * @version 6.2.1
 */
class BackupTypeServer {
    /**
     * Constructs a new <code>BackupTypeServer</code>.
     * @alias module:model/BackupTypeServer
     * @param locationType {module:model/BackupTypeServer.LocationTypeEnum} 
     * @param name {String} A name for the backup
     * @param backupType {module:model/BackupTypeServer.BackupTypeEnum} The backup type code, options vary by the type of cloud and source
     * @param jobAction {module:model/BackupTypeServer.JobActionEnum} Create a new backup job, clone an existing job or add the new backup to an existing job
     */
    constructor(locationType, name, backupType, jobAction) { 
        
        BackupTypeServer.initialize(this, locationType, name, backupType, jobAction);
    }
    ...
    /**
     * Constructs a <code>BackupTypeServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BackupTypeServer} obj Optional instance to populate.
     * @return {module:model/BackupTypeServer} The populated <code>BackupTypeServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BackupTypeServer();
...
/**
 * @member {module:model/BackupTypeServer.LocationTypeEnum} locationType
 */
BackupTypeServer.prototype['locationType'] = undefined;

/**
 * A name for the backup
 * @member {String} name
 */
BackupTypeServer.prototype['name'] = undefined;

/**
 * The ID of the server to backup
 * @member {Number} serverId
 */
BackupTypeServer.prototype['serverId'] = undefined;

/**
 * The backup type code, options vary by the type of cloud and source
 * @member {module:model/BackupTypeServer.BackupTypeEnum} backupType
 */
BackupTypeServer.prototype['backupType'] = undefined;

/**
 * Create a new backup job, clone an existing job or add the new backup to an existing job
 * @member {module:model/BackupTypeServer.JobActionEnum} jobAction
 */
BackupTypeServer.prototype['jobAction'] = undefined;

/**
 * The ID of the job to clone or add to. Only applies to jobAction `clone` and `addTo`.
 * @member {Number} jobId
 */
BackupTypeServer.prototype['jobId'] = undefined;

/**
 * Name for new job. Only applies to jobAction `new` and `clone`.
 * @member {String} jobName
 */
BackupTypeServer.prototype['jobName'] = undefined;
 ...
 */
BackupTypeServer.prototype['jobSchedule'] = undefined;
 ...
 */
BackupTypeServer.prototype['retentionCount'] = undefined;
 ...
 * @readonly
 */
BackupTypeServer['LocationTypeEnum'] = {
 ...
 * @readonly
 */
BackupTypeServer['BackupTypeEnum'] = {
 ...
 * @readonly
 */
BackupTypeServer['JobActionEnum'] = {
...
export default BackupTypeServer;
