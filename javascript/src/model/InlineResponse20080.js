...
import InlineResponse20080LoadBalancerPool from './InlineResponse20080LoadBalancerPool';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('loadBalancerPool')) {
                obj['loadBalancerPool'] = InlineResponse20080LoadBalancerPool.constructFromObject(data['loadBalancerPool']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20080LoadBalancerPool} loadBalancerPool
 */
InlineResponse20080.prototype['loadBalancerPool'] = undefined;
