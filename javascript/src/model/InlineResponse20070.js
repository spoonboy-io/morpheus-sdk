    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('containerTemplate')) {
                obj['containerTemplate'] = FileTemplate.constructFromObject(data['containerTemplate']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/FileTemplate} containerTemplate
 */
InlineResponse20070.prototype['containerTemplate'] = undefined;
