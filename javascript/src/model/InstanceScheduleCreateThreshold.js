...
/**
 * The InstanceScheduleCreateThreshold model module.
 * @module model/InstanceScheduleCreateThreshold
 * @version 6.2.1
 */
class InstanceScheduleCreateThreshold {
    /**
     * Constructs a new <code>InstanceScheduleCreateThreshold</code>.
     * @alias module:model/InstanceScheduleCreateThreshold
     */
    constructor() { 
        
        InstanceScheduleCreateThreshold.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InstanceScheduleCreateThreshold</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceScheduleCreateThreshold} obj Optional instance to populate.
     * @return {module:model/InstanceScheduleCreateThreshold} The populated <code>InstanceScheduleCreateThreshold</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceScheduleCreateThreshold();
 ...
 */
InstanceScheduleCreateThreshold.prototype['sourceThresholdId'] = undefined;
 ...
 * @default false
 */
InstanceScheduleCreateThreshold.prototype['autoUp'] = false;
 ...
 * @default false
 */
InstanceScheduleCreateThreshold.prototype['autoDown'] = false;

/**
 * The minimum number of nodes to scale down to
 * @member {Number} minCount
 */
InstanceScheduleCreateThreshold.prototype['minCount'] = undefined;

/**
 * The maximum number of nodes to scale up to
 * @member {Number} maxCount
 */
InstanceScheduleCreateThreshold.prototype['maxCount'] = undefined;
 ...
 * @default false
 */
InstanceScheduleCreateThreshold.prototype['cpuEnabled'] = false;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['minCpu'] = 0;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['maxCpu'] = 0;
 ...
 * @default false
 */
InstanceScheduleCreateThreshold.prototype['memoryEnabled'] = false;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['minMemory'] = 0;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['maxMemory'] = 0;
 ...
 * @default false
 */
InstanceScheduleCreateThreshold.prototype['diskEnabled'] = false;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['minDisk'] = 0;
 ...
 * @default 0
 */
InstanceScheduleCreateThreshold.prototype['maxDisk'] = 0;
...
export default InstanceScheduleCreateThreshold;
