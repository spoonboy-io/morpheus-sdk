    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('optionTypes')) {
                obj['optionTypes'] = ApiClient.convertToType(data['optionTypes'], [OptionTypeList]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/OptionTypeList>} optionTypes
 */
InlineResponse20073.prototype['optionTypes'] = undefined;
