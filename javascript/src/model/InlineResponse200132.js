...
class InlineResponse200132 {
    ...
    constructor() { 
        ...
        InlineResponse200132.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resourcePoolGroup')) {
                obj['resourcePoolGroup'] = ApiClient.convertToType(data['resourcePoolGroup'], Object);
            }
        }
        return obj;
    }
...
/**
 * @member {Object} resourcePoolGroup
 */
InlineResponse200132.prototype['resourcePoolGroup'] = undefined;
...
export default InlineResponse200132;
