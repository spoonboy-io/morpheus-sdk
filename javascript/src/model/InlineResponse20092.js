...
import NetworkRouterTypes from './NetworkRouterTypes';
...
class InlineResponse20092 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkRouterTypes')) {
                obj['networkRouterTypes'] = ApiClient.convertToType(data['networkRouterTypes'], [NetworkRouterTypes]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/NetworkRouterTypes>} networkRouterTypes
 */
InlineResponse20092.prototype['networkRouterTypes'] = undefined;
