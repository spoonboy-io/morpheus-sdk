...
class InlineResponse200160 {
    ...
    constructor() { 
        ...
        InlineResponse200160.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vdiApp')) {
                obj['vdiApp'] = VdiApp.constructFromObject(data['vdiApp']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/VdiApp} vdiApp
 */
InlineResponse200160.prototype['vdiApp'] = undefined;
...
export default InlineResponse200160;
