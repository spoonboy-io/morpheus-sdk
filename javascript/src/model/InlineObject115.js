...
import InstanceTypeLayoutCreate from './InstanceTypeLayoutCreate';
...
class InlineObject115 {
    ...
    constructor() { 
        ...
        InlineObject115.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('instanceTypeLayout')) {
                obj['instanceTypeLayout'] = InstanceTypeLayoutCreate.constructFromObject(data['instanceTypeLayout']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InstanceTypeLayoutCreate} instanceTypeLayout
 */
InlineObject115.prototype['instanceTypeLayout'] = undefined;
