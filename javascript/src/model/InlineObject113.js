...
import InstanceTypeCreate from './InstanceTypeCreate';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('instanceType')) {
                obj['instanceType'] = InstanceTypeCreate.constructFromObject(data['instanceType']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InstanceTypeCreate} instanceType
 */
InlineObject113.prototype['instanceType'] = undefined;
