...
import ApiExecuteSchedulesSchedule from './ApiExecuteSchedulesSchedule';
...
class InlineObject12 {
     ...
     * @param schedule {module:model/ApiExecuteSchedulesSchedule} 
     */
    constructor(schedule) { 
        
        InlineObject12.initialize(this, schedule);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('schedule')) {
                obj['schedule'] = ApiExecuteSchedulesSchedule.constructFromObject(data['schedule']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ApiExecuteSchedulesSchedule} schedule
 */
InlineObject12.prototype['schedule'] = undefined;
