...
import InlineResponse20081LoadBalancerProfile from './InlineResponse20081LoadBalancerProfile';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('loadBalancerProfile')) {
                obj['loadBalancerProfile'] = InlineResponse20081LoadBalancerProfile.constructFromObject(data['loadBalancerProfile']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20081LoadBalancerProfile} loadBalancerProfile
 */
InlineResponse20081.prototype['loadBalancerProfile'] = undefined;
