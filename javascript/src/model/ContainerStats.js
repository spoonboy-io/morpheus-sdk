...
/**
 * The ContainerStats model module.
 * @module model/ContainerStats
 * @version 6.2.1
 */
class ContainerStats {
    /**
     * Constructs a new <code>ContainerStats</code>.
     * @alias module:model/ContainerStats
     */
    constructor() { 
        
        ContainerStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContainerStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContainerStats} obj Optional instance to populate.
     * @return {module:model/ContainerStats} The populated <code>ContainerStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContainerStats();
 ...
 * @member {String} ts
 */
ContainerStats.prototype['ts'] = undefined;

/**
 * @member {Boolean} running
 */
ContainerStats.prototype['running'] = undefined;

/**
 * @member {Number} userCpuUsage
 */
ContainerStats.prototype['userCpuUsage'] = undefined;

/**
 * @member {Number} systemCpuUsage
 */
ContainerStats.prototype['systemCpuUsage'] = undefined;

/**
 * @member {Number} usedMemory
 */
ContainerStats.prototype['usedMemory'] = undefined;

/**
 * @member {Number} maxMemory
 */
ContainerStats.prototype['maxMemory'] = undefined;

/**
 * @member {Number} cacheMemory
 */
ContainerStats.prototype['cacheMemory'] = undefined;

/**
 * @member {Number} maxStorage
 */
ContainerStats.prototype['maxStorage'] = undefined;

/**
 * @member {Number} usedStorage
 */
ContainerStats.prototype['usedStorage'] = undefined;

/**
 * @member {Number} readIOPS
 */
ContainerStats.prototype['readIOPS'] = undefined;

/**
 * @member {Number} writeIOPS
 */
ContainerStats.prototype['writeIOPS'] = undefined;

/**
 * @member {Number} totalIOPS
 */
ContainerStats.prototype['totalIOPS'] = undefined;

/**
 * @member {Number} netTxUsage
 */
ContainerStats.prototype['netTxUsage'] = undefined;

/**
 * @member {Number} netRxUsage
 */
ContainerStats.prototype['netRxUsage'] = undefined;
