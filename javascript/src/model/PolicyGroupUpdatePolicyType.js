...
/**
 * The PolicyGroupUpdatePolicyType model module.
 * @module model/PolicyGroupUpdatePolicyType
 * @version 6.2.1
 */
class PolicyGroupUpdatePolicyType {
    /**
     * Constructs a new <code>PolicyGroupUpdatePolicyType</code>.
     * @alias module:model/PolicyGroupUpdatePolicyType
     */
    constructor() { 
        
        PolicyGroupUpdatePolicyType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyGroupUpdatePolicyType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyGroupUpdatePolicyType} obj Optional instance to populate.
     * @return {module:model/PolicyGroupUpdatePolicyType} The populated <code>PolicyGroupUpdatePolicyType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyGroupUpdatePolicyType();
...
/**
 * The policy type
 * @member {module:model/PolicyGroupUpdatePolicyType.CodeEnum} code
 */
PolicyGroupUpdatePolicyType.prototype['code'] = undefined;
 ...
 */
PolicyGroupUpdatePolicyType.prototype['config'] = undefined;
 ...
 * @default true
 */
PolicyGroupUpdatePolicyType.prototype['enabled'] = true;

/**
 * Scope object type
 * @member {module:model/PolicyGroupUpdatePolicyType.RefTypeEnum} refType
 */
PolicyGroupUpdatePolicyType.prototype['refType'] = undefined;

/**
 * Scope object ID (`group`)
 * @member {Number} refId
 */
PolicyGroupUpdatePolicyType.prototype['refId'] = undefined;

/**
 * Array of tenants to scope the policy to
 * @member {Array.<Number>} accounts
 */
PolicyGroupUpdatePolicyType.prototype['accounts'] = undefined;

/**
 * Apply individually to each user in role.  Only when `refType` equals `Role`
 * @member {Boolean} eachUser
 */
PolicyGroupUpdatePolicyType.prototype['eachUser'] = undefined;
 ...
 * @readonly
 */
PolicyGroupUpdatePolicyType['CodeEnum'] = {
 ...
 * @readonly
 */
PolicyGroupUpdatePolicyType['RefTypeEnum'] = {
...
export default PolicyGroupUpdatePolicyType;
