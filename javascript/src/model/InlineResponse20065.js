...
import IntegrationInventory from './IntegrationInventory';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inventory')) {
                obj['inventory'] = IntegrationInventory.constructFromObject(data['inventory']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/IntegrationInventory} inventory
 */
InlineResponse20065.prototype['inventory'] = undefined;
