...
import ApiBackupsIdBackup from './ApiBackupsIdBackup';
...
class InlineObject17 {
     ...
     * @param backup {module:model/ApiBackupsIdBackup} 
     */
    constructor(backup) { 
        
        InlineObject17.initialize(this, backup);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('backup')) {
                obj['backup'] = ApiBackupsIdBackup.constructFromObject(data['backup']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ApiBackupsIdBackup} backup
 */
InlineObject17.prototype['backup'] = undefined;
