...
import ApiInstancesIdDeploysAppDeploy from './ApiInstancesIdDeploysAppDeploy';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('appDeploy')) {
                obj['appDeploy'] = ApiInstancesIdDeploysAppDeploy.constructFromObject(data['appDeploy']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ApiInstancesIdDeploysAppDeploy} appDeploy
 */
InlineObject92.prototype['appDeploy'] = undefined;
