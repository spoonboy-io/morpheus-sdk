...
/**
 * The ApiSecurityGroupsIdRulesRule model module.
 * @module model/ApiSecurityGroupsIdRulesRule
 * @version 6.2.1
 */
class ApiSecurityGroupsIdRulesRule {
    /**
     * Constructs a new <code>ApiSecurityGroupsIdRulesRule</code>.
     * @alias module:model/ApiSecurityGroupsIdRulesRule
     * @param protocol {module:model/ApiSecurityGroupsIdRulesRule.ProtocolEnum} Either tcp, udp, icmp. Required if customRule is true, otherwise, ignored.
     * @param ruleType {String} Either `customRule` or an `instance type` code.
     */
    constructor(protocol, ruleType) { 
        
        ApiSecurityGroupsIdRulesRule.initialize(this, protocol, ruleType);
    }
    ...
    /**
     * Constructs a <code>ApiSecurityGroupsIdRulesRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiSecurityGroupsIdRulesRule} obj Optional instance to populate.
     * @return {module:model/ApiSecurityGroupsIdRulesRule} The populated <code>ApiSecurityGroupsIdRulesRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiSecurityGroupsIdRulesRule();
 ...
 * @member {String} name
 */
ApiSecurityGroupsIdRulesRule.prototype['name'] = undefined;

/**
 * Either `ingress` or `egress`
 * @member {module:model/ApiSecurityGroupsIdRulesRule.DirectionEnum} direction
 * @default 'ingress'
 */
ApiSecurityGroupsIdRulesRule.prototype['direction'] = 'ingress';

/**
 * Either `cidr`, `group`, `tier`, `all`
 * @member {module:model/ApiSecurityGroupsIdRulesRule.SourceTypeEnum} sourceType
 * @default 'cidr'
 */
ApiSecurityGroupsIdRulesRule.prototype['sourceType'] = 'cidr';

/**
 * CIDR representing the source IP(s) which should receive access. Required for `sourceType`=cidr
 * @member {String} source
 */
ApiSecurityGroupsIdRulesRule.prototype['source'] = undefined;

/**
 * @member {module:model/ApiSecurityGroupsIdRulesRuleSourceGroup} sourceGroup
 */
ApiSecurityGroupsIdRulesRule.prototype['sourceGroup'] = undefined;

/**
 * @member {module:model/ApiSecurityGroupsIdRulesRuleSourceTier} sourceTier
 */
ApiSecurityGroupsIdRulesRule.prototype['sourceTier'] = undefined;
 ...
 */
ApiSecurityGroupsIdRulesRule.prototype['portRange'] = undefined;

/**
 * Either tcp, udp, icmp. Required if customRule is true, otherwise, ignored.
 * @member {module:model/ApiSecurityGroupsIdRulesRule.ProtocolEnum} protocol
 */
ApiSecurityGroupsIdRulesRule.prototype['protocol'] = undefined;

/**
 * Either cidr, group, tier, instance.
 * @member {module:model/ApiSecurityGroupsIdRulesRule.DestinationTypeEnum} destinationType
 * @default 'cidr'
 */
ApiSecurityGroupsIdRulesRule.prototype['destinationType'] = 'cidr';

/**
 * CIDR representing the destination IP(s) which should receive access. Required for `destinationType`=cidr.
 * @member {String} destination
 */
ApiSecurityGroupsIdRulesRule.prototype['destination'] = undefined;

/**
 * @member {module:model/ApiSecurityGroupsIdRulesRuleDestinationGroup} destinationGroup
 */
ApiSecurityGroupsIdRulesRule.prototype['destinationGroup'] = undefined;

/**
 * @member {module:model/ApiSecurityGroupsIdRulesRuleDestinationTier} destinationTier
 */
ApiSecurityGroupsIdRulesRule.prototype['destinationTier'] = undefined;
 ...
 * @default 'customRule'
 */
ApiSecurityGroupsIdRulesRule.prototype['ruleType'] = 'customRule';

/**
 * Either `accept` or `deny`.
 * @member {module:model/ApiSecurityGroupsIdRulesRule.PolicyEnum} policy
 */
ApiSecurityGroupsIdRulesRule.prototype['policy'] = undefined;
 ...
 */
ApiSecurityGroupsIdRulesRule.prototype['instanceTypeId'] = undefined;
 ...
 * @readonly
 */
ApiSecurityGroupsIdRulesRule['DirectionEnum'] = {
 ...
 * @readonly
 */
ApiSecurityGroupsIdRulesRule['SourceTypeEnum'] = {
 ...
 * @readonly
 */
ApiSecurityGroupsIdRulesRule['ProtocolEnum'] = {
 ...
 * @readonly
 */
ApiSecurityGroupsIdRulesRule['DestinationTypeEnum'] = {
 ...
 * @readonly
 */
ApiSecurityGroupsIdRulesRule['PolicyEnum'] = {
...
export default ApiSecurityGroupsIdRulesRule;
