...
import LoadBalancerCreate from './LoadBalancerCreate';
...
class InlineObject127 {
    ...
    constructor() { 
        ...
        InlineObject127.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('loadBalancer')) {
                obj['loadBalancer'] = LoadBalancerCreate.constructFromObject(data['loadBalancer']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/LoadBalancerCreate} loadBalancer
 */
InlineObject127.prototype['loadBalancer'] = undefined;
