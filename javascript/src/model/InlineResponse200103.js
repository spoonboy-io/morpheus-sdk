...
class InlineResponse200103 {
    ...
    constructor() { 
        ...
        InlineResponse200103.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkRouterNAT')) {
                obj['networkRouterNAT'] = NetworkRouterNat.constructFromObject(data['networkRouterNAT']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/NetworkRouterNat} networkRouterNAT
 */
InlineResponse200103.prototype['networkRouterNAT'] = undefined;
