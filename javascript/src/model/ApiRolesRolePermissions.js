...
/**
 * The ApiRolesRolePermissions model module.
 * @module model/ApiRolesRolePermissions
 * @version 6.2.1
 */
class ApiRolesRolePermissions {
    /**
     * Constructs a new <code>ApiRolesRolePermissions</code>.
     * @alias module:model/ApiRolesRolePermissions
     * @param code {module:model/ApiRolesRolePermissions.CodeEnum} `code` of the feature permission
     * @param access {module:model/ApiRolesRolePermissions.AccessEnum} The new access level.
     */
    constructor(code, access) { 
        
        ApiRolesRolePermissions.initialize(this, code, access);
    }
    ...
    /**
     * Constructs a <code>ApiRolesRolePermissions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiRolesRolePermissions} obj Optional instance to populate.
     * @return {module:model/ApiRolesRolePermissions} The populated <code>ApiRolesRolePermissions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiRolesRolePermissions();
 ...
 * @member {module:model/ApiRolesRolePermissions.CodeEnum} code
 */
ApiRolesRolePermissions.prototype['code'] = undefined;

/**
 * The new access level.
 * @member {module:model/ApiRolesRolePermissions.AccessEnum} access
 */
ApiRolesRolePermissions.prototype['access'] = undefined;
 ...
 * @readonly
 */
ApiRolesRolePermissions['CodeEnum'] = {
 ...
 * @readonly
 */
ApiRolesRolePermissions['AccessEnum'] = {
...
export default ApiRolesRolePermissions;
