...
/**
 * The PolicyCloudCreatePolicyType model module.
 * @module model/PolicyCloudCreatePolicyType
 * @version 6.2.1
 */
class PolicyCloudCreatePolicyType {
    /**
     * Constructs a new <code>PolicyCloudCreatePolicyType</code>.
     * @alias module:model/PolicyCloudCreatePolicyType
     */
    constructor() { 
        
        PolicyCloudCreatePolicyType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyCloudCreatePolicyType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyCloudCreatePolicyType} obj Optional instance to populate.
     * @return {module:model/PolicyCloudCreatePolicyType} The populated <code>PolicyCloudCreatePolicyType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyCloudCreatePolicyType();
...
/**
 * The policy type
 * @member {module:model/PolicyCloudCreatePolicyType.CodeEnum} code
 */
PolicyCloudCreatePolicyType.prototype['code'] = undefined;
 ...
 */
PolicyCloudCreatePolicyType.prototype['config'] = undefined;
 ...
 * @default true
 */
PolicyCloudCreatePolicyType.prototype['enabled'] = true;

/**
 * Scope object type
 * @member {module:model/PolicyCloudCreatePolicyType.RefTypeEnum} refType
 */
PolicyCloudCreatePolicyType.prototype['refType'] = undefined;

/**
 * Scope object ID (`cloud`)
 * @member {Number} refId
 */
PolicyCloudCreatePolicyType.prototype['refId'] = undefined;

/**
 * Array of tenants to scope the policy to
 * @member {Array.<Number>} accounts
 */
PolicyCloudCreatePolicyType.prototype['accounts'] = undefined;

/**
 * Apply individually to each user in role.  Only when `refType` equals `Role`
 * @member {Boolean} eachUser
 */
PolicyCloudCreatePolicyType.prototype['eachUser'] = undefined;
 ...
 * @readonly
 */
PolicyCloudCreatePolicyType['CodeEnum'] = {
 ...
 * @readonly
 */
PolicyCloudCreatePolicyType['RefTypeEnum'] = {
...
export default PolicyCloudCreatePolicyType;
