...
/**
 * The BackupTypeProvider model module.
 * @module model/BackupTypeProvider
 * @version 6.2.1
 */
class BackupTypeProvider {
    /**
     * Constructs a new <code>BackupTypeProvider</code>.
     * @alias module:model/BackupTypeProvider
     * @param locationType {module:model/BackupTypeProvider.LocationTypeEnum} 
     * @param name {String} A name for the backup
     * @param backupType {module:model/BackupTypeProvider.BackupTypeEnum} The backup type code, options vary by the type of cloud and source
     * @param jobAction {module:model/BackupTypeProvider.JobActionEnum} Create a new backup job, clone an existing job or add the new backup to an existing job
     */
    constructor(locationType, name, backupType, jobAction) { 
        
        BackupTypeProvider.initialize(this, locationType, name, backupType, jobAction);
    }
     ...
     */
    static initialize(obj, locationType, name, backupType, jobAction) { 
    ...
    /**
     * Constructs a <code>BackupTypeProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BackupTypeProvider} obj Optional instance to populate.
     * @return {module:model/BackupTypeProvider} The populated <code>BackupTypeProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BackupTypeProvider();
            ...
            if (data.hasOwnProperty('sourceProviderId')) {
                obj['sourceProviderId'] = ApiClient.convertToType(data['sourceProviderId'], 'Number');
            }
...
/**
 * @member {module:model/BackupTypeProvider.LocationTypeEnum} locationType
 */
BackupTypeProvider.prototype['locationType'] = undefined;

/**
 * A name for the backup
 * @member {String} name
 */
BackupTypeProvider.prototype['name'] = undefined;

/**
 * Source Object Store. The ID of the storage provider (bucket) to be backed up.
 * @member {Number} sourceProviderId
 */
BackupTypeProvider.prototype['sourceProviderId'] = undefined;

/**
 * Target Object Store. The ID of the storage provider (bucket) the backup will be copied to.
 * @member {Number} storageProviderId
 */
BackupTypeProvider.prototype['storageProviderId'] = undefined;

/**
 * The backup type code, options vary by the type of cloud and source
 * @member {module:model/BackupTypeProvider.BackupTypeEnum} backupType
 */
BackupTypeProvider.prototype['backupType'] = undefined;

/**
 * Create a new backup job, clone an existing job or add the new backup to an existing job
 * @member {module:model/BackupTypeProvider.JobActionEnum} jobAction
 */
BackupTypeProvider.prototype['jobAction'] = undefined;

/**
 * The ID of the job to clone or add to. Only applies to jobAction `clone` and `addTo`.
 * @member {Number} jobId
 */
BackupTypeProvider.prototype['jobId'] = undefined;

/**
 * Name for new job. Only applies to jobAction `new` and `clone`.
 * @member {String} jobName
 */
BackupTypeProvider.prototype['jobName'] = undefined;
 ...
 */
BackupTypeProvider.prototype['jobSchedule'] = undefined;
 ...
 */
BackupTypeProvider.prototype['retentionCount'] = undefined;
 ...
 * @readonly
 */
BackupTypeProvider['LocationTypeEnum'] = {
 ...
 * @readonly
 */
BackupTypeProvider['BackupTypeEnum'] = {
 ...
 * @readonly
 */
BackupTypeProvider['JobActionEnum'] = {
...
export default BackupTypeProvider;
