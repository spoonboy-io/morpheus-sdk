    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('namespace')) {
                obj['namespace'] = ClusterNamespace.constructFromObject(data['namespace']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/ClusterNamespace} namespace
 */
InlineResponse20031.prototype['namespace'] = undefined;
