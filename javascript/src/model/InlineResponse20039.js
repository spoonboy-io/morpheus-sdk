    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('version')) {
                obj['version'] = DeploymentVersion.constructFromObject(data['version']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/DeploymentVersion} version
 */
InlineResponse20039.prototype['version'] = undefined;
