...
import OptionTypeListUpdate from './OptionTypeListUpdate';
...
class InlineObject120 {
    ...
    constructor() { 
        ...
        InlineObject120.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('optionTypeList')) {
                obj['optionTypeList'] = OptionTypeListUpdate.constructFromObject(data['optionTypeList']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/OptionTypeListUpdate} optionTypeList
 */
InlineObject120.prototype['optionTypeList'] = undefined;
