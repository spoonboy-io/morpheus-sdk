...
import ClusterMasters from './ClusterMasters';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('masters')) {
                obj['masters'] = ApiClient.convertToType(data['masters'], [ClusterMasters]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/ClusterMasters>} masters
 */
InlineResponse20030.prototype['masters'] = undefined;
