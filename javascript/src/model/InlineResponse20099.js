    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rule')) {
                obj['rule'] = NetworkRouterFirewallRule.constructFromObject(data['rule']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/NetworkRouterFirewallRule} rule
 */
InlineResponse20099.prototype['rule'] = undefined;
