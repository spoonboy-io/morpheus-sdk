...
/**
 * The PolicyGroupCreatePolicyType model module.
 * @module model/PolicyGroupCreatePolicyType
 * @version 6.2.1
 */
class PolicyGroupCreatePolicyType {
    /**
     * Constructs a new <code>PolicyGroupCreatePolicyType</code>.
     * @alias module:model/PolicyGroupCreatePolicyType
     */
    constructor() { 
        
        PolicyGroupCreatePolicyType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyGroupCreatePolicyType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyGroupCreatePolicyType} obj Optional instance to populate.
     * @return {module:model/PolicyGroupCreatePolicyType} The populated <code>PolicyGroupCreatePolicyType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyGroupCreatePolicyType();
...
/**
 * The policy type
 * @member {module:model/PolicyGroupCreatePolicyType.CodeEnum} code
 */
PolicyGroupCreatePolicyType.prototype['code'] = undefined;
 ...
 */
PolicyGroupCreatePolicyType.prototype['config'] = undefined;
 ...
 * @default true
 */
PolicyGroupCreatePolicyType.prototype['enabled'] = true;

/**
 * Scope object type
 * @member {module:model/PolicyGroupCreatePolicyType.RefTypeEnum} refType
 */
PolicyGroupCreatePolicyType.prototype['refType'] = undefined;

/**
 * Scope object ID (`group`)
 * @member {Number} refId
 */
PolicyGroupCreatePolicyType.prototype['refId'] = undefined;

/**
 * Array of tenants to scope the policy to
 * @member {Array.<Number>} accounts
 */
PolicyGroupCreatePolicyType.prototype['accounts'] = undefined;

/**
 * Apply individually to each user in role.  Only when `refType` equals `Role`
 * @member {Boolean} eachUser
 */
PolicyGroupCreatePolicyType.prototype['eachUser'] = undefined;
 ...
 * @readonly
 */
PolicyGroupCreatePolicyType['CodeEnum'] = {
 ...
 * @readonly
 */
PolicyGroupCreatePolicyType['RefTypeEnum'] = {
...
export default PolicyGroupCreatePolicyType;
