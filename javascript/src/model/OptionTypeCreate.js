...
/**
 * The OptionTypeCreate model module.
 * @module model/OptionTypeCreate
 * @version 6.2.1
 */
class OptionTypeCreate {
    /**
     * Constructs a new <code>OptionTypeCreate</code>.
     * @alias module:model/OptionTypeCreate
     * @param name {String} The name of the option type for handy reference
     */
    constructor(name) { 
        
        OptionTypeCreate.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>OptionTypeCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptionTypeCreate} obj Optional instance to populate.
     * @return {module:model/OptionTypeCreate} The populated <code>OptionTypeCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptionTypeCreate();
 ...
 * @member {String} name
 */
OptionTypeCreate.prototype['name'] = undefined;

/**
 * Short description of the option type
 * @member {String} description
 */
OptionTypeCreate.prototype['description'] = undefined;

/**
 * Array of label strings, can be used for filtering.
 * @member {Array.<String>} labels
 */
OptionTypeCreate.prototype['labels'] = undefined;
 ...
 */
OptionTypeCreate.prototype['fieldName'] = undefined;
 ...
 * @default 'text'
 */
OptionTypeCreate.prototype['type'] = 'text';

/**
 * Field Label, the label for user input.
 * @member {String} fieldLabel
 */
OptionTypeCreate.prototype['fieldLabel'] = undefined;

/**
 * Any placeholder text when nothing is yet entered
 * @member {String} placeholder
 */
OptionTypeCreate.prototype['placeholder'] = undefined;
 ...
 */
OptionTypeCreate.prototype['verifyPattern'] = undefined;
 ...
 */
OptionTypeCreate.prototype['defaultValue'] = undefined;
 ...
 * @default false
 */
OptionTypeCreate.prototype['required'] = false;
 ...
 * @default false
 */
OptionTypeCreate.prototype['exportMeta'] = false;
 ...
 * @default false
 */
OptionTypeCreate.prototype['editable'] = false;

/**
 * @member {module:model/OptionTypeCreateOptionList} optionList
 */
OptionTypeCreate.prototype['optionList'] = undefined;
...
export default OptionTypeCreate;
