...
class InlineResponse200168 {
    ...
    constructor() { 
        ...
        InlineResponse200168.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('page')) {
                obj['page'] = WikiPage.constructFromObject(data['page']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/WikiPage} page
 */
InlineResponse200168.prototype['page'] = undefined;
...
export default InlineResponse200168;
