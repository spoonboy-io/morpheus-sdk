...
/**
 * The RouteOptionType model module.
 * @module model/RouteOptionType
 * @version 6.2.1
 */
class RouteOptionType {
    /**
     * Constructs a new <code>RouteOptionType</code>.
     * @alias module:model/RouteOptionType
     */
    constructor() { 
        
        RouteOptionType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RouteOptionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteOptionType} obj Optional instance to populate.
     * @return {module:model/RouteOptionType} The populated <code>RouteOptionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteOptionType();
 ...
 * @member {Number} id
 */
RouteOptionType.prototype['id'] = undefined;

/**
 * @member {String} name
 */
RouteOptionType.prototype['name'] = undefined;

/**
 * @member {String} description
 */
RouteOptionType.prototype['description'] = undefined;

/**
 * @member {String} code
 */
RouteOptionType.prototype['code'] = undefined;

/**
 * @member {String} fieldName
 */
RouteOptionType.prototype['fieldName'] = undefined;

/**
 * @member {String} fieldLabel
 */
RouteOptionType.prototype['fieldLabel'] = undefined;

/**
 * @member {String} fieldCode
 */
RouteOptionType.prototype['fieldCode'] = undefined;

/**
 * @member {String} fieldContext
 */
RouteOptionType.prototype['fieldContext'] = undefined;

/**
 * @member {String} fieldGroup
 */
RouteOptionType.prototype['fieldGroup'] = undefined;

/**
 * @member {String} fieldClass
 */
RouteOptionType.prototype['fieldClass'] = undefined;

/**
 * @member {String} fieldAddOn
 */
RouteOptionType.prototype['fieldAddOn'] = undefined;

/**
 * @member {String} fieldComponent
 */
RouteOptionType.prototype['fieldComponent'] = undefined;

/**
 * @member {String} fieldInput
 */
RouteOptionType.prototype['fieldInput'] = undefined;

/**
 * @member {String} placeHolder
 */
RouteOptionType.prototype['placeHolder'] = undefined;

/**
 * @member {String} verifyPattern
 */
RouteOptionType.prototype['verifyPattern'] = undefined;

/**
 * @member {String} helpBlock
 */
RouteOptionType.prototype['helpBlock'] = undefined;

/**
 * @member {String} helpBlockFieldCode
 */
RouteOptionType.prototype['helpBlockFieldCode'] = undefined;

/**
 * @member {String} defaultValue
 */
RouteOptionType.prototype['defaultValue'] = undefined;

/**
 * @member {String} optionSource
 */
RouteOptionType.prototype['optionSource'] = undefined;

/**
 * @member {String} optionSourceType
 */
RouteOptionType.prototype['optionSourceType'] = undefined;

/**
 * @member {String} optionList
 */
RouteOptionType.prototype['optionList'] = undefined;

/**
 * @member {String} type
 */
RouteOptionType.prototype['type'] = undefined;

/**
 * @member {Boolean} advanced
 */
RouteOptionType.prototype['advanced'] = undefined;

/**
 * @member {Boolean} required
 */
RouteOptionType.prototype['required'] = undefined;

/**
 * @member {Boolean} exportMeta
 */
RouteOptionType.prototype['exportMeta'] = undefined;

/**
 * @member {Boolean} editable
 */
RouteOptionType.prototype['editable'] = undefined;

/**
 * @member {Boolean} creatable
 */
RouteOptionType.prototype['creatable'] = undefined;

/**
 * @member {Object} config
 */
RouteOptionType.prototype['config'] = undefined;

/**
 * @member {Number} displayOrder
 */
RouteOptionType.prototype['displayOrder'] = undefined;

/**
 * @member {String} wrapperClass
 */
RouteOptionType.prototype['wrapperClass'] = undefined;

/**
 * @member {Boolean} enabled
 */
RouteOptionType.prototype['enabled'] = undefined;

/**
 * @member {Boolean} noBlank
 */
RouteOptionType.prototype['noBlank'] = undefined;

/**
 * @member {String} dependsOnCode
 */
RouteOptionType.prototype['dependsOnCode'] = undefined;

/**
 * @member {String} visibleOnCode
 */
RouteOptionType.prototype['visibleOnCode'] = undefined;

/**
 * @member {String} requireOnCode
 */
RouteOptionType.prototype['requireOnCode'] = undefined;

/**
 * @member {Boolean} contextualDefault
 */
RouteOptionType.prototype['contextualDefault'] = undefined;

/**
 * @member {Boolean} displayValueOnDetails
 */
RouteOptionType.prototype['displayValueOnDetails'] = undefined;

/**
 * @member {Boolean} showOnCreate
 */
RouteOptionType.prototype['showOnCreate'] = undefined;

/**
 * @member {Boolean} showOnEdit
 */
RouteOptionType.prototype['showOnEdit'] = undefined;
...
export default RouteOptionType;
