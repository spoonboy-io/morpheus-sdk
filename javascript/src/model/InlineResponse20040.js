...
import InlineResponse20040AppDeploy from './InlineResponse20040AppDeploy';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('appDeploy')) {
                obj['appDeploy'] = InlineResponse20040AppDeploy.constructFromObject(data['appDeploy']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20040AppDeploy} appDeploy
 */
InlineResponse20040.prototype['appDeploy'] = undefined;
