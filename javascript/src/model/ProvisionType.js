...
/**
 * The ProvisionType model module.
 * @module model/ProvisionType
 * @version 6.2.1
 */
class ProvisionType {
    /**
     * Constructs a new <code>ProvisionType</code>.
     * @alias module:model/ProvisionType
     */
    constructor() { 
        
        ProvisionType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProvisionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProvisionType} obj Optional instance to populate.
     * @return {module:model/ProvisionType} The populated <code>ProvisionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvisionType();
 ...
 * @member {Number} id
 */
ProvisionType.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ProvisionType.prototype['name'] = undefined;

/**
 * @member {String} description
 */
ProvisionType.prototype['description'] = undefined;

/**
 * @member {String} code
 */
ProvisionType.prototype['code'] = undefined;

/**
 * @member {Boolean} aclEnabled
 */
ProvisionType.prototype['aclEnabled'] = undefined;

/**
 * @member {Boolean} multiTenant
 */
ProvisionType.prototype['multiTenant'] = undefined;

/**
 * @member {Boolean} managed
 */
ProvisionType.prototype['managed'] = undefined;

/**
 * @member {Boolean} hostNetwork
 */
ProvisionType.prototype['hostNetwork'] = undefined;

/**
 * @member {Boolean} customSupported
 */
ProvisionType.prototype['customSupported'] = undefined;

/**
 * @member {Boolean} mapPorts
 */
ProvisionType.prototype['mapPorts'] = undefined;

/**
 * @member {Boolean} exportServer
 */
ProvisionType.prototype['exportServer'] = undefined;

/**
 * @member {String} viewSet
 */
ProvisionType.prototype['viewSet'] = undefined;

/**
 * @member {String} serverType
 */
ProvisionType.prototype['serverType'] = undefined;

/**
 * @member {String} hostType
 */
ProvisionType.prototype['hostType'] = undefined;

/**
 * @member {Boolean} addVolumes
 */
ProvisionType.prototype['addVolumes'] = undefined;

/**
 * @member {Boolean} hasVolumes
 */
ProvisionType.prototype['hasVolumes'] = undefined;

/**
 * @member {Boolean} hasDatastore
 */
ProvisionType.prototype['hasDatastore'] = undefined;

/**
 * @member {Boolean} hasNetworks
 */
ProvisionType.prototype['hasNetworks'] = undefined;

/**
 * @member {Number} maxNetworks
 */
ProvisionType.prototype['maxNetworks'] = undefined;

/**
 * @member {Boolean} customizeVolume
 */
ProvisionType.prototype['customizeVolume'] = undefined;

/**
 * @member {Boolean} rootDiskCustomizable
 */
ProvisionType.prototype['rootDiskCustomizable'] = undefined;

/**
 * @member {Boolean} rootDiskSizeKnown
 */
ProvisionType.prototype['rootDiskSizeKnown'] = undefined;

/**
 * @member {Boolean} rootDiskResizable
 */
ProvisionType.prototype['rootDiskResizable'] = undefined;

/**
 * @member {Boolean} lvmSupported
 */
ProvisionType.prototype['lvmSupported'] = undefined;

/**
 * @member {String} hostDiskMode
 */
ProvisionType.prototype['hostDiskMode'] = undefined;

/**
 * @member {Number} minDisk
 */
ProvisionType.prototype['minDisk'] = undefined;

/**
 * @member {String} maxDisk
 */
ProvisionType.prototype['maxDisk'] = undefined;

/**
 * @member {Boolean} resizeCopiesVolumes
 */
ProvisionType.prototype['resizeCopiesVolumes'] = undefined;

/**
 * @member {Boolean} supportsAutoDatastore
 */
ProvisionType.prototype['supportsAutoDatastore'] = undefined;

/**
 * @member {Boolean} hasZonePools
 */
ProvisionType.prototype['hasZonePools'] = undefined;

/**
 * @member {Boolean} hasSecurityGroups
 */
ProvisionType.prototype['hasSecurityGroups'] = undefined;

/**
 * @member {Boolean} hasParameters
 */
ProvisionType.prototype['hasParameters'] = undefined;

/**
 * @member {Boolean} canEnforceTags
 */
ProvisionType.prototype['canEnforceTags'] = undefined;

/**
 * @member {Boolean} disableRootDatastore
 */
ProvisionType.prototype['disableRootDatastore'] = undefined;

/**
 * @member {Boolean} hasSnapshots
 */
ProvisionType.prototype['hasSnapshots'] = undefined;

/**
 * @member {Boolean} hasSpecTemplates
 */
ProvisionType.prototype['hasSpecTemplates'] = undefined;

/**
 * @member {Boolean} hasPreview
 */
ProvisionType.prototype['hasPreview'] = undefined;

/**
 * @member {Boolean} zonePoolRequired
 */
ProvisionType.prototype['zonePoolRequired'] = undefined;

/**
 * @member {Boolean} planRequiresPool
 */
ProvisionType.prototype['planRequiresPool'] = undefined;

/**
 * @member {Boolean} hasFolders
 */
ProvisionType.prototype['hasFolders'] = undefined;

/**
 * @member {Array.<module:model/OptionType>} optionTypes
 */
ProvisionType.prototype['optionTypes'] = undefined;

/**
 * @member {Array.<module:model/OptionType>} customOptionTypes
 */
ProvisionType.prototype['customOptionTypes'] = undefined;

/**
 * @member {Array.<module:model/NetworkType>} networkTypes
 */
ProvisionType.prototype['networkTypes'] = undefined;

/**
 * @member {Array.<module:model/StorageType>} storageTypes
 */
ProvisionType.prototype['storageTypes'] = undefined;

/**
 * @member {Array.<module:model/StorageType>} rootStorageTypes
 */
ProvisionType.prototype['rootStorageTypes'] = undefined;

/**
 * @member {Array.<module:model/ControllerType>} controllerTypes
 */
ProvisionType.prototype['controllerTypes'] = undefined;
