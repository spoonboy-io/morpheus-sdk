...
class InlineResponse200152 {
    ...
    constructor() { 
        ...
        InlineResponse200152.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('account')) {
                obj['account'] = ApiClient.convertToType(data['account'], TenantGroup);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/TenantGroup} account
 */
InlineResponse200152.prototype['account'] = undefined;
...
export default InlineResponse200152;
