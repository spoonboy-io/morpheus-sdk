    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('instanceTypeLayout')) {
                obj['instanceTypeLayout'] = InstanceTypeLayout.constructFromObject(data['instanceTypeLayout']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InstanceTypeLayout} instanceTypeLayout
 */
InlineResponse20072.prototype['instanceTypeLayout'] = undefined;
