...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineResponse2001 result = apiInstance.getApprovals(id);
...
# **listApprovals**
> Object listApprovals(max, offset, sort, direction, phrase, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.listApprovals(max, offset, sort, direction, phrase, name);
      System.out.println(result);
    } catch (ApiException e) {
