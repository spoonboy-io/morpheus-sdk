...
<a name="addBudgets"></a>
# **addBudgets**
> Object addBudgets(inlineObject22)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.addBudgets(inlineObject22);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getBudgets(id);
      System.out.println(result);
    } catch (ApiException e) {
...
# **listBudgets**
> Object listBudgets(max, offset, sort, direction, phrase, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.listBudgets(max, offset, sort, direction, phrase, name);
      System.out.println(result);
    } catch (ApiException e) {
...
# **updateBudgets**
> Object updateBudgets(id, inlineObject23)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.updateBudgets(id, inlineObject23);
      System.out.println(result);
    } catch (ApiException e) {
