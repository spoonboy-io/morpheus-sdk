...
<a name="addStorageBuckets"></a>
# **addStorageBuckets**
> Object addStorageBuckets(inlineObject232)
...
public class Example {
  public static void main(String[] args) {
    ...
    InlineObject232 inlineObject232 = new InlineObject232(); // InlineObject232 | 
    try {
      Object result = apiInstance.addStorageBuckets(inlineObject232);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#addStorageBuckets");
...
<a name="addStorageServers"></a>
# **addStorageServers**
> Object addStorageServers(inlineObject234)
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageApi apiInstance = new StorageApi(defaultClient);
    InlineObject234 inlineObject234 = new InlineObject234(); // InlineObject234 | 
    try {
      Object result = apiInstance.addStorageServers(inlineObject234);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#addStorageServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="addStorageVolumes"></a>
# **addStorageVolumes**
> Object addStorageVolumes(inlineObject236)
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageApi apiInstance = new StorageApi(defaultClient);
    InlineObject236 inlineObject236 = new InlineObject236(); // InlineObject236 | 
    try {
      Object result = apiInstance.addStorageVolumes(inlineObject236);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#addStorageVolumes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineResponse200145 result = apiInstance.getStorageBuckets(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#getStorageBuckets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getStorageServerTypes"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      InlineResponse200146 result = apiInstance.getStorageServerTypes(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#getStorageServerTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      InlineResponse200147 result = apiInstance.getStorageServers(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#getStorageServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getStorageVolumeTypes"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      InlineResponse200148 result = apiInstance.getStorageVolumeTypes(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#getStorageVolumeTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      InlineResponse200149 result = apiInstance.getStorageVolumes(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#getStorageVolumes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listStorageBuckets"></a>
# **listStorageBuckets**
> Object listStorageBuckets(max, offset, sort, direction, phrase, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.listStorageBuckets(max, offset, sort, direction, phrase, name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#listStorageBuckets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listStorageServerTypes"></a>
# **listStorageServerTypes**
> Object listStorageServerTypes(max, offset, sort, direction, name, code, phrase)
...
public class Example {
  public static void main(String[] args) {
    ...
    String phrase = "phrase_example"; // String | Search phrase for partial matches on name or description
    try {
      Object result = apiInstance.listStorageServerTypes(max, offset, sort, direction, name, code, phrase);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#listStorageServerTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listStorageServers"></a>
# **listStorageServers**
> Object listStorageServers(max, offset, sort, direction, phrase, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "example-%"; // String | Filter by name, wildcard may be specified as %, eg. example-%
    try {
      Object result = apiInstance.listStorageServers(max, offset, sort, direction, phrase, name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#listStorageServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listStorageVolumeTypes"></a>
# **listStorageVolumeTypes**
> Object listStorageVolumeTypes(max, offset, sort, direction, name, code, phrase)
...
public class Example {
  public static void main(String[] args) {
    ...
    String phrase = "phrase_example"; // String | Search phrase for partial matches on name or description
    try {
      Object result = apiInstance.listStorageVolumeTypes(max, offset, sort, direction, name, code, phrase);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#listStorageVolumeTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listStorageVolumes"></a>
# **listStorageVolumes**
> Object listStorageVolumes(max, offset, sort, direction, phrase, name)
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "example-%"; // String | Filter by name, wildcard may be specified as %, eg. example-%
    try {
      Object result = apiInstance.listStorageVolumes(max, offset, sort, direction, phrase, name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#listStorageVolumes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      Model200Success result = apiInstance.removeStorageBuckets(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#removeStorageBuckets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      Model200Success result = apiInstance.removeStorageServers(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#removeStorageServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    try {
      Model200Success result = apiInstance.removeStorageVolumes(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#removeStorageVolumes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateStorageBuckets"></a>
# **updateStorageBuckets**
> Object updateStorageBuckets(id, inlineObject233)
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageApi apiInstance = new StorageApi(defaultClient);
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    InlineObject233 inlineObject233 = new InlineObject233(); // InlineObject233 | 
    try {
      Object result = apiInstance.updateStorageBuckets(id, inlineObject233);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#updateStorageBuckets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateStorageServers"></a>
# **updateStorageServers**
> Object updateStorageServers(id, inlineObject235)
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageApi apiInstance = new StorageApi(defaultClient);
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    InlineObject235 inlineObject235 = new InlineObject235(); // InlineObject235 | 
    try {
      Object result = apiInstance.updateStorageServers(id, inlineObject235);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#updateStorageServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateStorageVolumes"></a>
# **updateStorageVolumes**
> Object updateStorageVolumes(id, inlineObject237)
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageApi apiInstance = new StorageApi(defaultClient);
    Long id = 1L; // Long | Morpheus ID of the Object being referenced
    InlineObject237 inlineObject237 = new InlineObject237(); // InlineObject237 | 
    try {
      Object result = apiInstance.updateStorageVolumes(id, inlineObject237);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageApi#updateStorageVolumes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
