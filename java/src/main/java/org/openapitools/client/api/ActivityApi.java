...
import org.openapitools.client.model.ListActivity200Response;
...
public class ActivityApi {
    ...
    private okhttp3.Call listActivityValidateBeforeCall(Long max, Long offset, String sort, String order, String phrase, String name, Long userId, BigDecimal tenantId, String timeframe, OffsetDateTime start, OffsetDateTime end, final ApiCallback _callback) throws ApiException {
        return listActivityCall(max, offset, sort, order, phrase, name, userId, tenantId, timeframe, start, end, _callback);
     ...
     */
    public ListActivity200Response listActivity(Long max, Long offset, String sort, String order, String phrase, String name, Long userId, BigDecimal tenantId, String timeframe, OffsetDateTime start, OffsetDateTime end) throws ApiException {
        ApiResponse<ListActivity200Response> localVarResp = listActivityWithHttpInfo(max, offset, sort, order, phrase, name, userId, tenantId, timeframe, start, end);
     ...
     * @param start Filter by activity on or after a date(time). Default is 1 month prior (optional)
     * @param end Filter by activity on or before a date(time). Default is current date (optional)
     * @return ApiResponse&lt;ListActivity200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListActivity200Response> listActivityWithHttpInfo(Long max, Long offset, String sort, String order, String phrase, String name, Long userId, BigDecimal tenantId, String timeframe, OffsetDateTime start, OffsetDateTime end) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListActivity200Response>(){}.getType();
     ...
     */
    public okhttp3.Call listActivityAsync(Long max, Long offset, String sort, String order, String phrase, String name, Long userId, BigDecimal tenantId, String timeframe, OffsetDateTime start, OffsetDateTime end, final ApiCallback<ListActivity200Response> _callback) throws ApiException {
