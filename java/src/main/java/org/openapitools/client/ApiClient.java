...
public class ApiClient {
    ...
    private String basePath = "https://CHANGEME";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{serverURL}",
      "Morpheus API",
      new HashMap<String, ServerVariable>() {{
        put("serverURL", new ServerVariable(
    ...
    public ApiClient() {
        ...
        authentications.put("cypherAuth-XCToken", new ApiKeyAuth("header", "X-Cypher-Token"));
        authentications.put("cypherAuth-XVToken", new ApiKeyAuth("header", "X-Vault-Token"));
        authentications.put("cypherAuth-XMLease", new ApiKeyAuth("header", "X-Morpheus-Lease"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://CHANGEME
