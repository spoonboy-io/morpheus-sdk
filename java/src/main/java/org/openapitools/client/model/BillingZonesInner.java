...
public class BillingZonesInner {
  ...
  public BillingZonesInner() {
  }

  public BillingZonesInner zoneName(String zoneName) {
  ...
  **/
  ...
  public BillingZonesInner zoneId(Long zoneId) {
  ...
  **/
  ...
  public BillingZonesInner zoneUUID(String zoneUUID) {
  ...
  **/
  ...
  public BillingZonesInner zoneCode(String zoneCode) {
  ...
  **/
  ...
  public BillingZonesInner startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public BillingZonesInner endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public BillingZonesInner priceUnit(String priceUnit) {
  ...
  **/
  ...
  public BillingZonesInner computeServers(BillingZonesInnerComputeServers computeServers) {
  ...
  **/
  ...
  public BillingZonesInner instances(BillingZonesInnerInstances instances) {
  ...
  **/
  ...
  public BillingZonesInner discoveredServers(BillingZonesInnerComputeServers discoveredServers) {
  ...
  **/
  ...
  public BillingZonesInner loadBalancers(BillingZonesInnerLoadBalancers loadBalancers) {
  ...
  **/
  ...
  public BillingZonesInner virtualImages(BillingZonesInnerVirtualImages virtualImages) {
  ...
  **/
  ...
  public BillingZonesInner snapshots(BillingZonesInnerSnapshots snapshots) {
  ...
  **/
  ...
  public BillingZonesInner price(BigDecimal price) {
  ...
  **/
  ...
  public BillingZonesInner cost(BigDecimal cost) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BillingZonesInner billingZonesInner = (BillingZonesInner) o;
    return Objects.equals(this.zoneName, billingZonesInner.zoneName) &&
        Objects.equals(this.zoneId, billingZonesInner.zoneId) &&
        Objects.equals(this.zoneUUID, billingZonesInner.zoneUUID) &&
        Objects.equals(this.zoneCode, billingZonesInner.zoneCode) &&
        Objects.equals(this.startDate, billingZonesInner.startDate) &&
        Objects.equals(this.endDate, billingZonesInner.endDate) &&
        Objects.equals(this.priceUnit, billingZonesInner.priceUnit) &&
        Objects.equals(this.computeServers, billingZonesInner.computeServers) &&
        Objects.equals(this.instances, billingZonesInner.instances) &&
        Objects.equals(this.discoveredServers, billingZonesInner.discoveredServers) &&
        Objects.equals(this.loadBalancers, billingZonesInner.loadBalancers) &&
        Objects.equals(this.virtualImages, billingZonesInner.virtualImages) &&
        Objects.equals(this.snapshots, billingZonesInner.snapshots) &&
        Objects.equals(this.price, billingZonesInner.price) &&
        Objects.equals(this.cost, billingZonesInner.cost);
  }
  ...
  public String toString() {
    ...
    sb.append("class BillingZonesInner {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BillingZonesInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingZonesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingZonesInner is not found in the empty JSON string", BillingZonesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillingZonesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillingZonesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillingZonesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillingZonesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillingZonesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillingZonesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BillingZonesInner>() {
           @Override
           public void write(JsonWriter out, BillingZonesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BillingZonesInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BillingZonesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillingZonesInner
  * @throws IOException if the JSON string is invalid with respect to BillingZonesInner
  */
  public static BillingZonesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillingZonesInner.class);
  }

 /**
  * Convert an instance of BillingZonesInner to an JSON string
  *
  * @return JSON string
  */
