...
import org.openapitools.client.model.VirtualImageUpdateRemoveTags;

/**
 * VirtualImageUpdate
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-08-21T11:26:47.028Z[GMT]")
public class VirtualImageUpdate {
  ...
  private List<VirtualImageCreateTags> addTags = null;

  public static final String SERIALIZED_NAME_REMOVE_TAGS = "removeTags";
  @SerializedName(SERIALIZED_NAME_REMOVE_TAGS)
  private List<VirtualImageUpdateRemoveTags> removeTags = null;


  public VirtualImageUpdate name(String name) {
  ...
  **/
  ...
  public VirtualImageUpdate labels(List<String> labels) {
    
    this.labels = labels;
    return this;
  }

  public VirtualImageUpdate addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public VirtualImageUpdate imageType(String imageType) {
  ...
  **/
  ...
  public VirtualImageUpdate storageProvider(VirtualImageCreateStorageProvider storageProvider) {
  ...
  **/
  ...
  public VirtualImageUpdate isCloudInit(Boolean isCloudInit) {
  ...
  **/
  ...
  public VirtualImageUpdate userData(String userData) {
  ...
  **/
  ...
  public VirtualImageUpdate installAgent(Boolean installAgent) {
  ...
  **/
  ...
  public VirtualImageUpdate sshUsername(String sshUsername) {
  ...
  **/
  ...
  public VirtualImageUpdate sshPassword(String sshPassword) {
  ...
  **/
  ...
  public VirtualImageUpdate sshKey(String sshKey) {
  ...
  **/
  ...
  public VirtualImageUpdate osType(OneOfobjectstring osType) {
  ...
  **/
  ...
  public VirtualImageUpdate visibility(String visibility) {
  ...
  **/
  ...
  public VirtualImageUpdate accounts(List<Long> accounts) {
    
    this.accounts = accounts;
    return this;
  }

  public VirtualImageUpdate addAccountsItem(Long accountsItem) {
  ...
  **/
  ...
  public VirtualImageUpdate isAutoJoinDomain(Boolean isAutoJoinDomain) {
  ...
  **/
  ...
  public VirtualImageUpdate virtioSupported(Boolean virtioSupported) {
  ...
  **/
  ...
  public VirtualImageUpdate vmToolsInstalled(Boolean vmToolsInstalled) {
  ...
  **/
  ...
  public VirtualImageUpdate isForceCustomization(Boolean isForceCustomization) {
  ...
  **/
  ...
  public VirtualImageUpdate trialVersion(Boolean trialVersion) {
  ...
  **/
  ...
  public VirtualImageUpdate isSysprep(Boolean isSysprep) {
  ...
  **/
  ...
  public VirtualImageUpdate config(OneOfobjectobject config) {
  ...
  **/
  ...
  public VirtualImageUpdate tags(List<VirtualImageCreateTags> tags) {
    
    this.tags = tags;
    return this;
  }

  public VirtualImageUpdate addTagsItem(VirtualImageCreateTags tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public VirtualImageUpdate addTags(List<VirtualImageCreateTags> addTags) {
    
    this.addTags = addTags;
    return this;
  }

  public VirtualImageUpdate addAddTagsItem(VirtualImageCreateTags addTagsItem) {
    if (this.addTags == null) {
      this.addTags = new ArrayList<VirtualImageCreateTags>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Add or update value of Metadata tags, Array of objects having a name and value.")

  public List<VirtualImageCreateTags> getAddTags() {
    return addTags;
  }


  public void setAddTags(List<VirtualImageCreateTags> addTags) {
    this.addTags = addTags;
  }


  public VirtualImageUpdate removeTags(List<VirtualImageUpdateRemoveTags> removeTags) {
    
    this.removeTags = removeTags;
    return this;
  }

  public VirtualImageUpdate addRemoveTagsItem(VirtualImageUpdateRemoveTags removeTagsItem) {
    if (this.removeTags == null) {
      this.removeTags = new ArrayList<VirtualImageUpdateRemoveTags>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Remove Metadata tags, Array of objects having a name and an optional value. If value is passed, it must match to be removed.")

  public List<VirtualImageUpdateRemoveTags> getRemoveTags() {
    return removeTags;
  }


  public void setRemoveTags(List<VirtualImageUpdateRemoveTags> removeTags) {
    this.removeTags = removeTags;
  }
  ...
  public boolean equals(Object o) {
    ...
    VirtualImageUpdate virtualImageUpdate = (VirtualImageUpdate) o;
    return Objects.equals(this.name, virtualImageUpdate.name) &&
        Objects.equals(this.labels, virtualImageUpdate.labels) &&
        Objects.equals(this.imageType, virtualImageUpdate.imageType) &&
        Objects.equals(this.storageProvider, virtualImageUpdate.storageProvider) &&
        Objects.equals(this.isCloudInit, virtualImageUpdate.isCloudInit) &&
        Objects.equals(this.userData, virtualImageUpdate.userData) &&
        Objects.equals(this.installAgent, virtualImageUpdate.installAgent) &&
        Objects.equals(this.sshUsername, virtualImageUpdate.sshUsername) &&
        Objects.equals(this.sshPassword, virtualImageUpdate.sshPassword) &&
        Objects.equals(this.sshKey, virtualImageUpdate.sshKey) &&
        Objects.equals(this.osType, virtualImageUpdate.osType) &&
        Objects.equals(this.visibility, virtualImageUpdate.visibility) &&
        Objects.equals(this.accounts, virtualImageUpdate.accounts) &&
        Objects.equals(this.isAutoJoinDomain, virtualImageUpdate.isAutoJoinDomain) &&
        Objects.equals(this.virtioSupported, virtualImageUpdate.virtioSupported) &&
        Objects.equals(this.vmToolsInstalled, virtualImageUpdate.vmToolsInstalled) &&
        Objects.equals(this.isForceCustomization, virtualImageUpdate.isForceCustomization) &&
        Objects.equals(this.trialVersion, virtualImageUpdate.trialVersion) &&
        Objects.equals(this.isSysprep, virtualImageUpdate.isSysprep) &&
        Objects.equals(this.config, virtualImageUpdate.config) &&
        Objects.equals(this.tags, virtualImageUpdate.tags) &&
        Objects.equals(this.addTags, virtualImageUpdate.addTags) &&
        Objects.equals(this.removeTags, virtualImageUpdate.removeTags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, labels, imageType, storageProvider, isCloudInit, userData, installAgent, sshUsername, sshPassword, sshKey, osType, visibility, accounts, isAutoJoinDomain, virtioSupported, vmToolsInstalled, isForceCustomization, trialVersion, isSysprep, config, tags, addTags, removeTags);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualImageUpdate {\n");
