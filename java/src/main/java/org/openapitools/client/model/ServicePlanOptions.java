 ...
 */
@ApiModel(description = "Map of custom options depending on selected service plan.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-08-21T11:26:47.028Z[GMT]")
public class ServicePlanOptions {
  ...
  public ServicePlanOptions maxCores(Long maxCores) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "Core Count")
  ...
  public ServicePlanOptions coresPerSocket(Long coresPerSocket) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Cores Per Socket")
  ...
  public ServicePlanOptions maxMemory(Long maxMemory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "536870912", value = "Memory in bytes For backwards compatability, values less than 1048576 are treated as being in MB and will be converted to bytes")
  ...
  public boolean equals(Object o) {
    ...
    ServicePlanOptions servicePlanOptions = (ServicePlanOptions) o;
    return Objects.equals(this.maxCores, servicePlanOptions.maxCores) &&
        Objects.equals(this.coresPerSocket, servicePlanOptions.coresPerSocket) &&
        Objects.equals(this.maxMemory, servicePlanOptions.maxMemory);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServicePlanOptions {\n");
