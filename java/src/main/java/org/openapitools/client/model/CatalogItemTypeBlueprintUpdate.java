...
public class CatalogItemTypeBlueprintUpdate {
  ...
  public CatalogItemTypeBlueprintUpdate() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CatalogItemTypeBlueprintUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogItemTypeBlueprintUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogItemTypeBlueprintUpdate is not found in the empty JSON string", CatalogItemTypeBlueprintUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CatalogItemTypeBlueprintUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogItemTypeBlueprintUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogItemTypeBlueprintUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogItemTypeBlueprintUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogItemTypeBlueprintUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogItemTypeBlueprintUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogItemTypeBlueprintUpdate>() {
           @Override
           public void write(JsonWriter out, CatalogItemTypeBlueprintUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogItemTypeBlueprintUpdate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CatalogItemTypeBlueprintUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CatalogItemTypeBlueprintUpdate
  * @throws IOException if the JSON string is invalid with respect to CatalogItemTypeBlueprintUpdate
  */
  public static CatalogItemTypeBlueprintUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogItemTypeBlueprintUpdate.class);
  }

 /**
  * Convert an instance of CatalogItemTypeBlueprintUpdate to an JSON string
  *
  * @return JSON string
  */
