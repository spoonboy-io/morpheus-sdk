...
public class ResetPassword200Response {
  ...
  public ResetPassword200Response success(Boolean success) {
  ...
  **/
  ...
  public ResetPassword200Response msg(String msg) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, resetPassword200Response.success) &&
        Objects.equals(this.msg, resetPassword200Response.msg);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetPassword200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResetPassword200Response is not found in the empty JSON string", ResetPassword200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResetPassword200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResetPassword200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
