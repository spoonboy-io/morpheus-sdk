...
import org.openapitools.client.model.BillingInstanceContainersInnerUsagesInnerApplicablePricesInner;
...
public class BillingInstanceContainersInnerUsagesInner {
  ...
  private List<BillingInstanceContainersInnerUsagesInnerApplicablePricesInner> applicablePrices;
  ...
  public BillingInstanceContainersInnerUsagesInner() {
  }

  public BillingInstanceContainersInnerUsagesInner name(String name) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner instanceName(String instanceName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner zoneName(String zoneName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner accountName(String accountName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner volumes(List<BillingInstancesInstancesInnerContainersInnerUsagesInnerVolumesInner> volumes) {
    
    this.volumes = volumes;
    return this;
  }

  public BillingInstanceContainersInnerUsagesInner addVolumesItem(BillingInstancesInstancesInnerContainersInnerUsagesInnerVolumesInner volumesItem) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner maxMemory(Long maxMemory) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner maxCpu(String maxCpu) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner maxCores(Long maxCores) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner serverExternalId(String serverExternalId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner serverInternalId(String serverInternalId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner planName(String planName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner hourlyPrice(BigDecimal hourlyPrice) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner hourlyCost(BigDecimal hourlyCost) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner currency(String currency) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner pricesUsed(List<BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner> pricesUsed) {
    
    this.pricesUsed = pricesUsed;
    return this;
  }

  public BillingInstanceContainersInnerUsagesInner addPricesUsedItem(BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner pricesUsedItem) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner cost(BigDecimal cost) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner price(BigDecimal price) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner createdByUser(String createdByUser) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner createdByUserId(Long createdByUserId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner siteId(Long siteId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner siteName(String siteName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner siteUUID(String siteUUID) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner siteCode(String siteCode) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner status(String status) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner tags(List<Object> tags) {
    
    this.tags = tags;
    return this;
  }

  public BillingInstanceContainersInnerUsagesInner addTagsItem(Object tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner applicablePrices(List<BillingInstanceContainersInnerUsagesInnerApplicablePricesInner> applicablePrices) {
    
    this.applicablePrices = applicablePrices;
    return this;
  }

  public BillingInstanceContainersInnerUsagesInner addApplicablePricesItem(BillingInstanceContainersInnerUsagesInnerApplicablePricesInner applicablePricesItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<BillingInstanceContainersInnerUsagesInnerApplicablePricesInner> getApplicablePrices() {
    return applicablePrices;
  }


  public void setApplicablePrices(List<BillingInstanceContainersInnerUsagesInnerApplicablePricesInner> applicablePrices) {
    this.applicablePrices = applicablePrices;
  }


  public BillingInstanceContainersInnerUsagesInner servicePlanId(Long servicePlanId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner servicePlanName(String servicePlanName) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner resourcePoolId(Long resourcePoolId) {
  ...
  **/
  ...
  public BillingInstanceContainersInnerUsagesInner resourcePoolName(String resourcePoolName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BillingInstanceContainersInnerUsagesInner billingInstanceContainersInnerUsagesInner = (BillingInstanceContainersInnerUsagesInner) o;
    return Objects.equals(this.name, billingInstanceContainersInnerUsagesInner.name) &&
        Objects.equals(this.instanceName, billingInstanceContainersInnerUsagesInner.instanceName) &&
        Objects.equals(this.zoneName, billingInstanceContainersInnerUsagesInner.zoneName) &&
        Objects.equals(this.accountName, billingInstanceContainersInnerUsagesInner.accountName) &&
        Objects.equals(this.volumes, billingInstanceContainersInnerUsagesInner.volumes) &&
        Objects.equals(this.maxMemory, billingInstanceContainersInnerUsagesInner.maxMemory) &&
        Objects.equals(this.maxCpu, billingInstanceContainersInnerUsagesInner.maxCpu) &&
        Objects.equals(this.maxCores, billingInstanceContainersInnerUsagesInner.maxCores) &&
        Objects.equals(this.serverExternalId, billingInstanceContainersInnerUsagesInner.serverExternalId) &&
        Objects.equals(this.serverInternalId, billingInstanceContainersInnerUsagesInner.serverInternalId) &&
        Objects.equals(this.planName, billingInstanceContainersInnerUsagesInner.planName) &&
        Objects.equals(this.hourlyPrice, billingInstanceContainersInnerUsagesInner.hourlyPrice) &&
        Objects.equals(this.hourlyCost, billingInstanceContainersInnerUsagesInner.hourlyCost) &&
        Objects.equals(this.currency, billingInstanceContainersInnerUsagesInner.currency) &&
        Objects.equals(this.pricesUsed, billingInstanceContainersInnerUsagesInner.pricesUsed) &&
        Objects.equals(this.cost, billingInstanceContainersInnerUsagesInner.cost) &&
        Objects.equals(this.price, billingInstanceContainersInnerUsagesInner.price) &&
        Objects.equals(this.createdByUser, billingInstanceContainersInnerUsagesInner.createdByUser) &&
        Objects.equals(this.createdByUserId, billingInstanceContainersInnerUsagesInner.createdByUserId) &&
        Objects.equals(this.siteId, billingInstanceContainersInnerUsagesInner.siteId) &&
        Objects.equals(this.siteName, billingInstanceContainersInnerUsagesInner.siteName) &&
        Objects.equals(this.siteUUID, billingInstanceContainersInnerUsagesInner.siteUUID) &&
        Objects.equals(this.siteCode, billingInstanceContainersInnerUsagesInner.siteCode) &&
        Objects.equals(this.startDate, billingInstanceContainersInnerUsagesInner.startDate) &&
        Objects.equals(this.endDate, billingInstanceContainersInnerUsagesInner.endDate) &&
        Objects.equals(this.status, billingInstanceContainersInnerUsagesInner.status) &&
        Objects.equals(this.tags, billingInstanceContainersInnerUsagesInner.tags) &&
        Objects.equals(this.applicablePrices, billingInstanceContainersInnerUsagesInner.applicablePrices) &&
        Objects.equals(this.servicePlanId, billingInstanceContainersInnerUsagesInner.servicePlanId) &&
        Objects.equals(this.servicePlanName, billingInstanceContainersInnerUsagesInner.servicePlanName) &&
        Objects.equals(this.resourcePoolId, billingInstanceContainersInnerUsagesInner.resourcePoolId) &&
        Objects.equals(this.resourcePoolName, billingInstanceContainersInnerUsagesInner.resourcePoolName);
  }
  ...
  public String toString() {
    ...
    sb.append("class BillingInstanceContainersInnerUsagesInner {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BillingInstanceContainersInnerUsagesInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingInstanceContainersInnerUsagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingInstanceContainersInnerUsagesInner is not found in the empty JSON string", BillingInstanceContainersInnerUsagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillingInstanceContainersInnerUsagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillingInstanceContainersInnerUsagesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("applicablePrices") != null && !jsonObj.get("applicablePrices").isJsonNull()) {
        ...
        if (jsonArrayapplicablePrices != null) {
          ...
          for (int i = 0; i < jsonArrayapplicablePrices.size(); i++) {
            BillingInstanceContainersInnerUsagesInnerApplicablePricesInner.validateJsonElement(jsonArrayapplicablePrices.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillingInstanceContainersInnerUsagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillingInstanceContainersInnerUsagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillingInstanceContainersInnerUsagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillingInstanceContainersInnerUsagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BillingInstanceContainersInnerUsagesInner>() {
           @Override
           public void write(JsonWriter out, BillingInstanceContainersInnerUsagesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BillingInstanceContainersInnerUsagesInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BillingInstanceContainersInnerUsagesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillingInstanceContainersInnerUsagesInner
  * @throws IOException if the JSON string is invalid with respect to BillingInstanceContainersInnerUsagesInner
  */
  public static BillingInstanceContainersInnerUsagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillingInstanceContainersInnerUsagesInner.class);
  }

 /**
  * Convert an instance of BillingInstanceContainersInnerUsagesInner to an JSON string
  *
  * @return JSON string
  */
