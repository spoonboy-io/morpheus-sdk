...
public class ClusterPermissionsResourcePermissions {
  ...
  public ClusterPermissionsResourcePermissions defaultStore(Boolean defaultStore) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions allPlans(Boolean allPlans) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions defaultTarget(Boolean defaultTarget) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions canManage(Boolean canManage) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions all(Boolean all) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions account(ApiBlueprintsIdUpdatePermissionsResourcePermissionSites account) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions sites(List<Object> sites) {
    
    this.sites = sites;
    return this;
  }

  public ClusterPermissionsResourcePermissions addSitesItem(Object sitesItem) {
    if (this.sites == null) {
  ...
  **/
  ...
  public ClusterPermissionsResourcePermissions plans(List<Object> plans) {
    
    this.plans = plans;
    return this;
  }

  public ClusterPermissionsResourcePermissions addPlansItem(Object plansItem) {
    if (this.plans == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClusterPermissionsResourcePermissions clusterPermissionsResourcePermissions = (ClusterPermissionsResourcePermissions) o;
    return Objects.equals(this.defaultStore, clusterPermissionsResourcePermissions.defaultStore) &&
        Objects.equals(this.allPlans, clusterPermissionsResourcePermissions.allPlans) &&
        Objects.equals(this.defaultTarget, clusterPermissionsResourcePermissions.defaultTarget) &&
        Objects.equals(this.canManage, clusterPermissionsResourcePermissions.canManage) &&
        Objects.equals(this.all, clusterPermissionsResourcePermissions.all) &&
        Objects.equals(this.account, clusterPermissionsResourcePermissions.account) &&
        Objects.equals(this.sites, clusterPermissionsResourcePermissions.sites) &&
        Objects.equals(this.plans, clusterPermissionsResourcePermissions.plans);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterPermissionsResourcePermissions {\n");
