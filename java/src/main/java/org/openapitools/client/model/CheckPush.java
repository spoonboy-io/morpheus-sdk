...
import org.openapitools.client.model.CheckPushCheckType;
 ...
 */
@ApiModel(description = "A push Check is not polled regularly by the standard monitoring system. Instead it is expected that an external API push updates as to the status of the check timed closely with the configured check interval setting. This is used to throttle the push from performing too many status updates. To push an update using the api key one must send a json payload like so: `curl -XPOST https://<morpheus url>/api/monitoring/push?apiKey=<apiKey> -H 'Content-Type: application/json' -d '{\"success\":true, \"message\": \"any comment goes here\"}'` The API Key will be returned on successful creation or can be found by getting this check. ")
...
public class CheckPush {
  ...
  private CheckPushCheckType checkType;
  ...
  public CheckPush name(String name) {
  ...
  **/
  ...
  public CheckPush description(String description) {
  ...
  **/
  ...
  public CheckPush checkType(CheckPushCheckType checkType) {
  ...
  **/
  ...
  public CheckPushCheckType getCheckType() {
    return checkType;
  }


  public void setCheckType(CheckPushCheckType checkType) {
    this.checkType = checkType;
  }


  public CheckPush checkInterval(Integer checkInterval) {
  ...
  **/
  ...
  public CheckPush inUptime(Boolean inUptime) {
  ...
  **/
  ...
  public CheckPush active(Boolean active) {
  ...
  **/
  ...
  public CheckPush severity(SeverityEnum severity) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CheckPush checkPush = (CheckPush) o;
    return Objects.equals(this.name, checkPush.name) &&
        Objects.equals(this.description, checkPush.description) &&
        Objects.equals(this.checkType, checkPush.checkType) &&
        Objects.equals(this.checkInterval, checkPush.checkInterval) &&
        Objects.equals(this.inUptime, checkPush.inUptime) &&
        Objects.equals(this.active, checkPush.active) &&
        Objects.equals(this.severity, checkPush.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, checkType, checkInterval, inUptime, active, severity);
  }
