 ...
 */
@ApiModel(description = "Elasticsearch check is capable of connecting to your Elasticsearch, cluster or node, verifying its health. In addition, Morpheus will also pull statistical information such as: document size, capacity, and cpu usage. ")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-08-21T11:26:47.028Z[GMT]")
public class CheckElastic {
  ...
  private CheckElasticCheckType checkType;
  ...
  private CheckElasticsearchConfig config = null;


  public CheckElastic name(String name) {
  ...
  **/
  ...
  public CheckElastic description(String description) {
  ...
  **/
  ...
  public CheckElastic checkType(CheckElasticCheckType checkType) {
  ...
  **/
  ...
  public CheckElasticCheckType getCheckType() {
    return checkType;
  }


  public void setCheckType(CheckElasticCheckType checkType) {
    this.checkType = checkType;
  }


  public CheckElastic checkInterval(Integer checkInterval) {
  ...
  **/
  ...
  public CheckElastic inUptime(Boolean inUptime) {
  ...
  **/
  ...
  public CheckElastic active(Boolean active) {
  ...
  **/
  ...
  public CheckElastic severity(SeverityEnum severity) {
  ...
  **/
  ...
  public CheckElastic config(CheckElasticsearchConfig config) {
  ...
  **/
  ...
  public CheckElasticsearchConfig getConfig() {
    return config;
  }


  public void setConfig(CheckElasticsearchConfig config) {
    this.config = config;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckElastic checkElastic = (CheckElastic) o;
    return Objects.equals(this.name, checkElastic.name) &&
        Objects.equals(this.description, checkElastic.description) &&
        Objects.equals(this.checkType, checkElastic.checkType) &&
        Objects.equals(this.checkInterval, checkElastic.checkInterval) &&
        Objects.equals(this.inUptime, checkElastic.inUptime) &&
        Objects.equals(this.active, checkElastic.active) &&
        Objects.equals(this.severity, checkElastic.severity) &&
        Objects.equals(this.config, checkElastic.config);
  }
