...
import org.openapitools.client.model.CheckSocketCheckType;
import org.openapitools.client.model.CheckSocketConfig;
 ...
 */
@ApiModel(description = "Socket check confirms a certain TCP port is up and responding in your environment.  It can be configured do an initial send upon connect and compare and expected response of the service. ")
...
public class CheckSocket {
  ...
  private CheckSocketCheckType checkType;
  ...
  private CheckSocketConfig config = null;


  public CheckSocket name(String name) {
  ...
  **/
  ...
  public CheckSocket description(String description) {
  ...
  **/
  ...
  public CheckSocket checkType(CheckSocketCheckType checkType) {
  ...
  **/
  ...
  public CheckSocketCheckType getCheckType() {
    return checkType;
  }


  public void setCheckType(CheckSocketCheckType checkType) {
    this.checkType = checkType;
  }


  public CheckSocket checkInterval(Integer checkInterval) {
  ...
  **/
  ...
  public CheckSocket inUptime(Boolean inUptime) {
  ...
  **/
  ...
  public CheckSocket active(Boolean active) {
  ...
  **/
  ...
  public CheckSocket severity(SeverityEnum severity) {
  ...
  **/
  ...
  public CheckSocket config(CheckSocketConfig config) {
  ...
  **/
  ...
  public CheckSocketConfig getConfig() {
    return config;
  }


  public void setConfig(CheckSocketConfig config) {
    this.config = config;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckSocket checkSocket = (CheckSocket) o;
    return Objects.equals(this.name, checkSocket.name) &&
        Objects.equals(this.description, checkSocket.description) &&
        Objects.equals(this.checkType, checkSocket.checkType) &&
        Objects.equals(this.checkInterval, checkSocket.checkInterval) &&
        Objects.equals(this.inUptime, checkSocket.inUptime) &&
        Objects.equals(this.active, checkSocket.active) &&
        Objects.equals(this.severity, checkSocket.severity) &&
        Objects.equals(this.config, checkSocket.config);
  }
