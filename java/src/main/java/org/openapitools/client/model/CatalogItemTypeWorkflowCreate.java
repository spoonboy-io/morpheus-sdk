...
public class CatalogItemTypeWorkflowCreate {
  ...
  **/
  ...
  public CatalogItemTypeWorkflowCreate workflow(ApiBlueprintsIdUpdatePermissionsResourcePermissionSites workflow) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Context for running the workflow, determines if a target resource must be selected.")
