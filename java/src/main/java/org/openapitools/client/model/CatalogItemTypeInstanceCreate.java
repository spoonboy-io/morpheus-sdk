...
public class CatalogItemTypeInstanceCreate {
  ...
  **/
  ...
  public CatalogItemTypeInstanceCreate config(CatalogItemTypeInstanceScribe config) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Documentation content for this Catalog Item. Markdown-formatted text is accepted and displayed appropriately when the item is ordered from the Service Catalog. A new Catalog Item-type Wiki entry will also be added containing this information.")
