...
import org.openapitools.client.model.InstanceStateInput;
...
public class InstanceState {
  ...
  private List<Object> workloads = null;
  ...
  private InstanceStateInput input;
  ...
  public InstanceState workloads(List<Object> workloads) {
    
    this.workloads = workloads;
    return this;
  }

  public InstanceState addWorkloadsItem(Object workloadsItem) {
    if (this.workloads == null) {
      this.workloads = new ArrayList<Object>();
    }
  ...
  **/
  ...
  public List<Object> getWorkloads() {
    return workloads;
  }


  public void setWorkloads(List<Object> workloads) {
    this.workloads = workloads;
  }


  public InstanceState iacDrift(Boolean iacDrift) {
  ...
  **/
  ...
  public InstanceState planResources(List<Object> planResources) {
    
    this.planResources = planResources;
    return this;
  }

  public InstanceState addPlanResourcesItem(Object planResourcesItem) {
  ...
  **/
  ...
  public InstanceState specs(List<Object> specs) {
    
    this.specs = specs;
    return this;
  }

  public InstanceState addSpecsItem(Object specsItem) {
    if (this.specs == null) {
  ...
  **/
  ...
  public InstanceState stateData(String stateData) {
  ...
  **/
  ...
  public InstanceState planData(String planData) {
  ...
  **/
  ...
  public InstanceState input(InstanceStateInput input) {
  ...
  **/
  ...
  public InstanceStateInput getInput() {
    return input;
  }


  public void setInput(InstanceStateInput input) {
    this.input = input;
  }


  public InstanceState output(AppStateOutput output) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workloads, instanceState.workloads) &&
        Objects.equals(this.iacDrift, instanceState.iacDrift) &&
        Objects.equals(this.planResources, instanceState.planResources) &&
        Objects.equals(this.specs, instanceState.specs) &&
        Objects.equals(this.stateData, instanceState.stateData) &&
        Objects.equals(this.planData, instanceState.planData) &&
        Objects.equals(this.input, instanceState.input) &&
        Objects.equals(this.output, instanceState.output);
  }
