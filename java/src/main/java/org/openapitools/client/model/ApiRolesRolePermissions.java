...
public class ApiRolesRolePermissions {
  /**
  ...
  public ApiRolesRolePermissions code(CodeEnum code) {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "`code` of the feature permission")
  ...
  public ApiRolesRolePermissions access(AccessEnum access) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiRolesRolePermissions apiRolesRolePermissions = (ApiRolesRolePermissions) o;
    return Objects.equals(this.code, apiRolesRolePermissions.code) &&
        Objects.equals(this.access, apiRolesRolePermissions.access);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiRolesRolePermissions {\n");
