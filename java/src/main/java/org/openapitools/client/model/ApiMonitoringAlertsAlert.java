...
public class ApiMonitoringAlertsAlert {
  ...
  public ApiMonitoringAlertsAlert name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "My Alert", required = true, value = "Unique name scoped to your account for the alert")
  ...
  public ApiMonitoringAlertsAlert minDuration(Integer minDuration) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert minSeverity(MinSeverityEnum minSeverity) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert active(Boolean active) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert allChecks(Boolean allChecks) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert allGroups(Boolean allGroups) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert allApps(Boolean allApps) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert checks(List<Integer> checks) {
    
    this.checks = checks;
    return this;
  }

  public ApiMonitoringAlertsAlert addChecksItem(Integer checksItem) {
    if (this.checks == null) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert groups(List<Integer> groups) {
    
    this.groups = groups;
    return this;
  }

  public ApiMonitoringAlertsAlert addGroupsItem(Integer groupsItem) {
    if (this.groups == null) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert apps(List<Integer> apps) {
    
    this.apps = apps;
    return this;
  }

  public ApiMonitoringAlertsAlert addAppsItem(Integer appsItem) {
    if (this.apps == null) {
  ...
  **/
  ...
  public ApiMonitoringAlertsAlert contacts(List<ApiMonitoringAlertsAlertContacts> contacts) {
    
    this.contacts = contacts;
    return this;
  }

  public ApiMonitoringAlertsAlert addContactsItem(ApiMonitoringAlertsAlertContacts contactsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiMonitoringAlertsAlert apiMonitoringAlertsAlert = (ApiMonitoringAlertsAlert) o;
    return Objects.equals(this.name, apiMonitoringAlertsAlert.name) &&
        Objects.equals(this.minDuration, apiMonitoringAlertsAlert.minDuration) &&
        Objects.equals(this.minSeverity, apiMonitoringAlertsAlert.minSeverity) &&
        Objects.equals(this.active, apiMonitoringAlertsAlert.active) &&
        Objects.equals(this.allChecks, apiMonitoringAlertsAlert.allChecks) &&
        Objects.equals(this.allGroups, apiMonitoringAlertsAlert.allGroups) &&
        Objects.equals(this.allApps, apiMonitoringAlertsAlert.allApps) &&
        Objects.equals(this.checks, apiMonitoringAlertsAlert.checks) &&
        Objects.equals(this.groups, apiMonitoringAlertsAlert.groups) &&
        Objects.equals(this.apps, apiMonitoringAlertsAlert.apps) &&
        Objects.equals(this.contacts, apiMonitoringAlertsAlert.contacts);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiMonitoringAlertsAlert {\n");
