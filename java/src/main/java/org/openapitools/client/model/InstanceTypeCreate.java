...
public class InstanceTypeCreate {
  ...
  public InstanceTypeCreate name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Instance type name")
  ...
  public InstanceTypeCreate labels(List<String> labels) {
    
    this.labels = labels;
    return this;
  }

  public InstanceTypeCreate addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public InstanceTypeCreate description(String description) {
  ...
  **/
  ...
  public InstanceTypeCreate code(String code) {
  ...
  **/
  ...
  public InstanceTypeCreate category(String category) {
  ...
  **/
  ...
  public InstanceTypeCreate visibility(VisibilityEnum visibility) {
  ...
  **/
  ...
  public InstanceTypeCreate featured(Boolean featured) {
  ...
  **/
  ...
  public InstanceTypeCreate hasSettings(Boolean hasSettings) {
  ...
  **/
  ...
  public InstanceTypeCreate hasAutoScale(Boolean hasAutoScale) {
  ...
  **/
  ...
  public InstanceTypeCreate hasDeployment(Boolean hasDeployment) {
  ...
  **/
  ...
  public InstanceTypeCreate environmentPrefix(String environmentPrefix) {
  ...
  **/
  ...
  public InstanceTypeCreate environmentVariables(List<ClusterLayoutCreateEnvironmentVariables> environmentVariables) {
    
    this.environmentVariables = environmentVariables;
    return this;
  }

  public InstanceTypeCreate addEnvironmentVariablesItem(ClusterLayoutCreateEnvironmentVariables environmentVariablesItem) {
  ...
  **/
  ...
  public InstanceTypeCreate priceSets(List<InstanceTypeCreatePriceSets> priceSets) {
    
    this.priceSets = priceSets;
    return this;
  }

  public InstanceTypeCreate addPriceSetsItem(InstanceTypeCreatePriceSets priceSetsItem) {
  ...
  **/
  ...
  public InstanceTypeCreate optionTypes(List<Long> optionTypes) {
    
    this.optionTypes = optionTypes;
    return this;
  }

  public InstanceTypeCreate addOptionTypesItem(Long optionTypesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InstanceTypeCreate instanceTypeCreate = (InstanceTypeCreate) o;
    return Objects.equals(this.name, instanceTypeCreate.name) &&
        Objects.equals(this.labels, instanceTypeCreate.labels) &&
        Objects.equals(this.description, instanceTypeCreate.description) &&
        Objects.equals(this.code, instanceTypeCreate.code) &&
        Objects.equals(this.category, instanceTypeCreate.category) &&
        Objects.equals(this.visibility, instanceTypeCreate.visibility) &&
        Objects.equals(this.featured, instanceTypeCreate.featured) &&
        Objects.equals(this.hasSettings, instanceTypeCreate.hasSettings) &&
        Objects.equals(this.hasAutoScale, instanceTypeCreate.hasAutoScale) &&
        Objects.equals(this.hasDeployment, instanceTypeCreate.hasDeployment) &&
        Objects.equals(this.environmentPrefix, instanceTypeCreate.environmentPrefix) &&
        Objects.equals(this.environmentVariables, instanceTypeCreate.environmentVariables) &&
        Objects.equals(this.priceSets, instanceTypeCreate.priceSets) &&
        Objects.equals(this.optionTypes, instanceTypeCreate.optionTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, labels, description, code, category, visibility, featured, hasSettings, hasAutoScale, hasDeployment, environmentPrefix, environmentVariables, priceSets, optionTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceTypeCreate {\n");
