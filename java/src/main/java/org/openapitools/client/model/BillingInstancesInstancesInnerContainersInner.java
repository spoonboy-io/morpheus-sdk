...
import org.openapitools.client.model.BillingInstancesInstancesInnerContainersInnerUsagesInner;
...
public class BillingInstancesInstancesInnerContainersInner {
  ...
  private List<BillingInstancesInstancesInnerContainersInnerUsagesInner> usages;
  ...
  public BillingInstancesInstancesInnerContainersInner() {
  }

  public BillingInstancesInstancesInnerContainersInner refType(String refType) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner refUUID(String refUUID) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner refId(Long refId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner cost(BigDecimal cost) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner price(BigDecimal price) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner numUnits(BigDecimal numUnits) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner unit(String unit) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner currency(String currency) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner usages(List<BillingInstancesInstancesInnerContainersInnerUsagesInner> usages) {
    
    this.usages = usages;
    return this;
  }

  public BillingInstancesInstancesInnerContainersInner addUsagesItem(BillingInstancesInstancesInnerContainersInnerUsagesInner usagesItem) {
    if (this.usages == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<BillingInstancesInstancesInnerContainersInnerUsagesInner> getUsages() {
    return usages;
  }


  public void setUsages(List<BillingInstancesInstancesInnerContainersInnerUsagesInner> usages) {
    this.usages = usages;
  }


  public BillingInstancesInstancesInnerContainersInner numUsages(Long numUsages) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner totalUsages(Long totalUsages) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner hasMoreUsages(Boolean hasMoreUsages) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner foundPricing(Boolean foundPricing) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner name(String name) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner serverId(Long serverId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner serverUUID(String serverUUID) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner serverUniqueId(String serverUniqueId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner serverExternalId(String serverExternalId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner serverInternalId(String serverInternalId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner resourcePoolId(Long resourcePoolId) {
  ...
  **/
  ...
  public BillingInstancesInstancesInnerContainersInner resourcePoolName(String resourcePoolName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BillingInstancesInstancesInnerContainersInner billingInstancesInstancesInnerContainersInner = (BillingInstancesInstancesInnerContainersInner) o;
    return Objects.equals(this.refType, billingInstancesInstancesInnerContainersInner.refType) &&
        Objects.equals(this.refUUID, billingInstancesInstancesInnerContainersInner.refUUID) &&
        Objects.equals(this.refId, billingInstancesInstancesInnerContainersInner.refId) &&
        Objects.equals(this.startDate, billingInstancesInstancesInnerContainersInner.startDate) &&
        Objects.equals(this.endDate, billingInstancesInstancesInnerContainersInner.endDate) &&
        Objects.equals(this.cost, billingInstancesInstancesInnerContainersInner.cost) &&
        Objects.equals(this.price, billingInstancesInstancesInnerContainersInner.price) &&
        Objects.equals(this.numUnits, billingInstancesInstancesInnerContainersInner.numUnits) &&
        Objects.equals(this.unit, billingInstancesInstancesInnerContainersInner.unit) &&
        Objects.equals(this.currency, billingInstancesInstancesInnerContainersInner.currency) &&
        Objects.equals(this.usages, billingInstancesInstancesInnerContainersInner.usages) &&
        Objects.equals(this.numUsages, billingInstancesInstancesInnerContainersInner.numUsages) &&
        Objects.equals(this.totalUsages, billingInstancesInstancesInnerContainersInner.totalUsages) &&
        Objects.equals(this.hasMoreUsages, billingInstancesInstancesInnerContainersInner.hasMoreUsages) &&
        Objects.equals(this.foundPricing, billingInstancesInstancesInnerContainersInner.foundPricing) &&
        Objects.equals(this.name, billingInstancesInstancesInnerContainersInner.name) &&
        Objects.equals(this.serverId, billingInstancesInstancesInnerContainersInner.serverId) &&
        Objects.equals(this.serverUUID, billingInstancesInstancesInnerContainersInner.serverUUID) &&
        Objects.equals(this.serverUniqueId, billingInstancesInstancesInnerContainersInner.serverUniqueId) &&
        Objects.equals(this.serverExternalId, billingInstancesInstancesInnerContainersInner.serverExternalId) &&
        Objects.equals(this.serverInternalId, billingInstancesInstancesInnerContainersInner.serverInternalId) &&
        Objects.equals(this.resourcePoolId, billingInstancesInstancesInnerContainersInner.resourcePoolId) &&
        Objects.equals(this.resourcePoolName, billingInstancesInstancesInnerContainersInner.resourcePoolName);
  }
  ...
  public String toString() {
    ...
    sb.append("class BillingInstancesInstancesInnerContainersInner {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BillingInstancesInstancesInnerContainersInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingInstancesInstancesInnerContainersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingInstancesInstancesInnerContainersInner is not found in the empty JSON string", BillingInstancesInstancesInnerContainersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillingInstancesInstancesInnerContainersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillingInstancesInstancesInnerContainersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("usages") != null && !jsonObj.get("usages").isJsonNull()) {
        ...
        if (jsonArrayusages != null) {
          ...
          for (int i = 0; i < jsonArrayusages.size(); i++) {
            BillingInstancesInstancesInnerContainersInnerUsagesInner.validateJsonElement(jsonArrayusages.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillingInstancesInstancesInnerContainersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillingInstancesInstancesInnerContainersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillingInstancesInstancesInnerContainersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillingInstancesInstancesInnerContainersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BillingInstancesInstancesInnerContainersInner>() {
           @Override
           public void write(JsonWriter out, BillingInstancesInstancesInnerContainersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BillingInstancesInstancesInnerContainersInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BillingInstancesInstancesInnerContainersInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillingInstancesInstancesInnerContainersInner
  * @throws IOException if the JSON string is invalid with respect to BillingInstancesInstancesInnerContainersInner
  */
  public static BillingInstancesInstancesInnerContainersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillingInstancesInstancesInnerContainersInner.class);
  }

 /**
  * Convert an instance of BillingInstancesInstancesInnerContainersInner to an JSON string
  *
  * @return JSON string
  */
