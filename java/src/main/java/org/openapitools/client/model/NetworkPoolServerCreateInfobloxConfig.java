...
public class NetworkPoolServerCreateInfobloxConfig {
  /**
   * Inventory Existing
   */
  ...
  public static final String SERIALIZED_NAME_EXTRA_ATTRIBUTES = "extraAttributes";
  @SerializedName(SERIALIZED_NAME_EXTRA_ATTRIBUTES)
  private String extraAttributes;


  public NetworkPoolServerCreateInfobloxConfig inventoryExisting(InventoryExistingEnum inventoryExisting) {
  ...
  **/
  ...
  public NetworkPoolServerCreateInfobloxConfig extraAttributes(String extraAttributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"Date Assigned\":\"<%=dateCreated%>\",\"Requestor\":\"<%=username%>\"}", value = "Extra Attributes")
  ...
  public boolean equals(Object o) {
    ...
    NetworkPoolServerCreateInfobloxConfig networkPoolServerCreateInfobloxConfig = (NetworkPoolServerCreateInfobloxConfig) o;
    return Objects.equals(this.inventoryExisting, networkPoolServerCreateInfobloxConfig.inventoryExisting) &&
        Objects.equals(this.extraAttributes, networkPoolServerCreateInfobloxConfig.extraAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inventoryExisting, extraAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkPoolServerCreateInfobloxConfig {\n");
    sb.append("    inventoryExisting: ").append(toIndentedString(inventoryExisting)).append("\n");
    sb.append("    extraAttributes: ").append(toIndentedString(extraAttributes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
