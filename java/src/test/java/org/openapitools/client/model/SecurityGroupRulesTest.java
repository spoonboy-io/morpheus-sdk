...
/**
 * Model tests for SecurityGroupRules
 */
public class SecurityGroupRulesTest {
    private final SecurityGroupRules model = new SecurityGroupRules();
