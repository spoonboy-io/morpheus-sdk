...
/**
 * Model tests for ContainerTypeUpdate
 */
public class ContainerTypeUpdateTest {
    private final ContainerTypeUpdate model = new ContainerTypeUpdate();
