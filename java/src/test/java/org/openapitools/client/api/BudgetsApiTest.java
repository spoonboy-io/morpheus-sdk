...
public class BudgetsApiTest {
    ...
    public void addBudgetsTest() throws ApiException {
        ...
        Object response = api.addBudgets(inlineObject22);
    ...
    public void getBudgetsTest() throws ApiException {
        Long id = null;
        Object response = api.getBudgets(id);
    ...
    public void listBudgetsTest() throws ApiException {
        ...
        String phrase = null;
        String name = null;
        Object response = api.listBudgets(max, offset, sort, direction, phrase, name);
    ...
    public void updateBudgetsTest() throws ApiException {
        ...
        Object response = api.updateBudgets(id, inlineObject23);
