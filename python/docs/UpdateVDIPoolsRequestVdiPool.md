...
------------ | ------------- | ------------- | -------------
**name** | **str** | Virtual Desktop name | [optional] 
...
**instance_config** | **str** | Instance Config JSON. Passing as a string will preserve property order.  See &#x60;config&#x60; object for required values. | [optional] 
