...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.list_activity  # this is an instance of the class Endpoint
        api_instance.list_activity()  # this invokes api_instance.list_activity.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_activity.callable or self.callable in this class
