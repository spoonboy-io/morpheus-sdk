...
class HistoryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_history_endpoint = _Endpoint(
            settings={
                'response_type': (GetHistory200Response,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/api/processes/{id}',
        ...
        self.get_history_event_endpoint = _Endpoint(
            settings={
                'response_type': (GetHistoryEvent200Response,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/api/processes/events/{id}',
                'operation_id': 'get_history_event',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_history_endpoint = _Endpoint(
            settings={
                'response_type': (ListHistory200Response,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/api/processes',
    ...
    def get_history(
        ...
        **kwargs
        ...
        >>> thread = api.get_history(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_history_event(
        ...
        **kwargs
        ...
        >>> thread = api.get_history_event(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_history_event_endpoint.call_with_http_info(**kwargs)
    ...
    def list_history(
        ...
        **kwargs
        ...
        Retrieves process history for objects   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_history(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_history_endpoint.call_with_http_info(**kwargs)
