...
class IntegrationGitRepo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IntegrationGitRepo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "git"  # noqa: E501
