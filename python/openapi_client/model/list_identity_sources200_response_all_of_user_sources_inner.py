...
class ListIdentitySources200ResponseAllOfUserSourcesInner(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'config': (IdentitySourcesCustomSSOConfigConfig,),  # noqa: E501
            'role_mappings': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListIdentitySources200ResponseAllOfUserSourcesInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            config (IdentitySourcesCustomSSOConfigConfig): [optional]  # noqa: E501
            role_mappings ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
