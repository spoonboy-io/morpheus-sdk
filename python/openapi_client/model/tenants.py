...
class Tenants(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Tenants - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ListDeploys200ResponseAllOfAppDeploysInnerInstance]):  # noqa: E501

        Keyword Args:
            value ([ListDeploys200ResponseAllOfAppDeploysInnerInstance]):  # noqa: E501
