...
class ClusterCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type': (ClusterCreateType,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'group': (ClusterCreateGroup,),  # noqa: E501
            'cloud': (ClusterCreateCloud,),  # noqa: E501
            'layout': (ClusterCreateLayout,),  # noqa: E501
            'server': (ClusterServerCreate,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, name, group, cloud, layout, server, *args, **kwargs):  # noqa: E501
        """ClusterCreate - a model defined in OpenAPI

        Args:
            type (ClusterCreateType):
        ...
        Keyword Args:
            ...
            description (str): Description of the cluster to be created. [optional]  # noqa: E501
            labels ([str]): Array of strings (keywords). This will override labels passed under the `server` object.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, name, group, cloud, layout, server, *args, **kwargs):  # noqa: E501
        """ClusterCreate - a model defined in OpenAPI
