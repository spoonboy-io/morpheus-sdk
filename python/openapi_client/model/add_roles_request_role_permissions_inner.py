...
class AddRolesRequestRolePermissionsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, access, *args, **kwargs):  # noqa: E501
        """AddRolesRequestRolePermissionsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, access, *args, **kwargs):  # noqa: E501
        """AddRolesRequestRolePermissionsInner - a model defined in OpenAPI
