...
class RolePermissionFeature(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_code, access, *args, **kwargs):  # noqa: E501
        """RolePermissionFeature - a model defined in OpenAPI

        Args:
            permission_code (str): The code of the feature permission being changed
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_code, access, *args, **kwargs):  # noqa: E501
        """RolePermissionFeature - a model defined in OpenAPI
