...
class InstanceCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'instance': (InstanceCreateInstance,),  # noqa: E501
            ...
            'service_plan_options': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'security_groups': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}], none_type,),  # noqa: E501
            ...
            'ports': ([InstanceCreatePortsInner],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instance, config, *args, **kwargs):  # noqa: E501
        """InstanceCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            zone_id (int): The Cloud ID to provision the instance onto.. [optional]  # noqa: E501
            ...
            copies (int): Number of copies to provision.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            layout_size (int): Apply a multiply factor of containers/vms within the instance.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            service_plan_options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Map of custom options depending on selected service plan.. [optional]  # noqa: E501
            security_groups ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}], none_type): Key for security group configuration. It should be passed as an array of objects containing the id of the security group to assign the instance to.. [optional]  # noqa: E501
            volumes ([InstanceCreateVolume]): The (optional) volumes parameter is for LV configuration, can create additional LVs at provision It should be passed as an array of. [optional]  # noqa: E501
            ...
            ports ([InstanceCreatePortsInner]): The ports parameter is for port configuration.  The layout may have default ports, which are defined in node types, that are always configured. This parameter will be for additional custom ports to be opened. . [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, instance, config, *args, **kwargs):  # noqa: E501
        """InstanceCreate - a model defined in OpenAPI
