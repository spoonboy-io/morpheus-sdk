...
class CheckVmConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, container_name, *args, **kwargs):  # noqa: E501
        """CheckVmConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, container_name, *args, **kwargs):  # noqa: E501
        """CheckVmConfig - a model defined in OpenAPI
