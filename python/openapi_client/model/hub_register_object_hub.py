...
class HubRegisterObjectHub(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_name, first_name, last_name, email, password, job_title, *args, **kwargs):  # noqa: E501
        """HubRegisterObjectHub - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_name, first_name, last_name, email, password, job_title, *args, **kwargs):  # noqa: E501
        """HubRegisterObjectHub - a model defined in OpenAPI
