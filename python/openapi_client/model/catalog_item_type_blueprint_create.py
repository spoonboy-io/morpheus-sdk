...
class CatalogItemTypeBlueprintCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blueprint, *args, **kwargs):  # noqa: E501
        """CatalogItemTypeBlueprintCreate - a model defined in OpenAPI

        Args:
            blueprint (CatalogItemTypeBlueprintCreateBlueprint):
    ...
    @convert_js_args_to_python_args
    def __init__(self, blueprint, *args, **kwargs):  # noqa: E501
        """CatalogItemTypeBlueprintCreate - a model defined in OpenAPI
