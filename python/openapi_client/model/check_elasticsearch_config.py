...
class CheckElasticsearchConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, es_host, es_port, *args, **kwargs):  # noqa: E501
        """CheckElasticsearchConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, es_host, es_port, *args, **kwargs):  # noqa: E501
        """CheckElasticsearchConfig - a model defined in OpenAPI
