...
class TaskJobPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, task, target_type, schedule_mode, *args, **kwargs):  # noqa: E501
        """TaskJobPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, task, target_type, schedule_mode, *args, **kwargs):  # noqa: E501
        """TaskJobPayload - a model defined in OpenAPI
