...
class BackupTypeProvider(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, backup_type, job_action, *args, **kwargs):  # noqa: E501
        """BackupTypeProvider - a model defined in OpenAPI
        ...
        Keyword Args:
            location_type (str): defaults to "storage", must be one of ["storage", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, backup_type, job_action, *args, **kwargs):  # noqa: E501
        """BackupTypeProvider - a model defined in OpenAPI
