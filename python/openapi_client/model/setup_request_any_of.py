...
class SetupRequestAnyOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, appliance_name, account_name, username, email, password, *args, **kwargs):  # noqa: E501
        """SetupRequestAnyOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, appliance_name, account_name, username, email, password, *args, **kwargs):  # noqa: E501
        """SetupRequestAnyOf - a model defined in OpenAPI
