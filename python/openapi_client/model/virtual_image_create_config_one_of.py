...
class VirtualImageCreateConfigOneOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, publisher, offer, sku, version, *args, **kwargs):  # noqa: E501
        """VirtualImageCreateConfigOneOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, publisher, offer, sku, version, *args, **kwargs):  # noqa: E501
        """VirtualImageCreateConfigOneOf - a model defined in OpenAPI
