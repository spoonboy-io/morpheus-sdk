...
class BackupTypeInstance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, instance_id, container_id, backup_type, job_action, *args, **kwargs):  # noqa: E501
        """BackupTypeInstance - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, instance_id, container_id, backup_type, job_action, *args, **kwargs):  # noqa: E501
        """BackupTypeInstance - a model defined in OpenAPI
