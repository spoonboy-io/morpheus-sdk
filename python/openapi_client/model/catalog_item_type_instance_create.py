...
class CatalogItemTypeInstanceCreate(ModelNormal):
    ...
    def _from_openapi_data(cls, config, *args, **kwargs):  # noqa: E501
        """CatalogItemTypeInstanceCreate - a model defined in OpenAPI

        Args:
            config (CatalogItemTypeInstanceScribe):
        ...
        Keyword Args:
            ...
            option_types ([int]): Array of option type IDs. Only applies to type instance and blueprint.. [optional]  # noqa: E501
