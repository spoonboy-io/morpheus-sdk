...
class ClusterJobs(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'schedule_mode': (str, none_type,),  # noqa: E501
            ...
            'last_result': (str, none_type,),  # noqa: E501
            ...
            'targets': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
            'custom_config': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'custom_options': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ClusterJobs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            schedule_mode (str, none_type): [optional]  # noqa: E501
            date_time (datetime, none_type): [optional]  # noqa: E501
            ...
            last_result (str, none_type): [optional]  # noqa: E501
            ...
            targets ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
            custom_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): [optional]  # noqa: E501
            custom_options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): [optional]  # noqa: E501
        """
