...
class UpdatePricesRequestPrice(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdatePricesRequestPrice - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Price name. [optional]  # noqa: E501
            code (str): Price code, must be unique. [optional]  # noqa: E501
            account (AddPricesRequestPriceAccount): [optional]  # noqa: E501
            price_type (str): Restricts query to only load only prices with specified priceType. * `fixed` - Everything * `compute` - Memory + CPU * `memory` - Memory * `cores` - Cores * `storage` - Storage * `datastore` - Datastore * `platform` - Platform * `software` - Software * `load_balancer` - Load Balancer * `load_balancer_virtual_server` - Load Balancer Virtual Server . [optional]  # noqa: E501
            price_unit (str): The unit of pricing. [optional]  # noqa: E501
            incur_charges (str): Indicates when to incur charge. [optional]  # noqa: E501
            currency (str): ISO Currency code. [optional]  # noqa: E501
