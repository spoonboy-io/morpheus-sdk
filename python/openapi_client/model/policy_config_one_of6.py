...
class PolicyConfigOneOf6(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, removal_age, *args, **kwargs):  # noqa: E501
        """PolicyConfigOneOf6 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, removal_age, *args, **kwargs):  # noqa: E501
        """PolicyConfigOneOf6 - a model defined in OpenAPI
