...
class GetNetworkGroups200ResponseNetworkGroupsInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'networks': ([int],),  # noqa: E501
            'subnets': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetNetworkGroups200ResponseNetworkGroupsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            networks ([int]): [optional]  # noqa: E501
            subnets ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
