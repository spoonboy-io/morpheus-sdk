...
class BackupTypeServer(ModelNormal):
    ...
    def _from_openapi_data(cls, name, backup_type, job_action, *args, **kwargs):  # noqa: E501
        """BackupTypeServer - a model defined in OpenAPI
        ...
        Keyword Args:
            location_type (str): defaults to "instance", must be one of ["instance", ]  # noqa: E501
        ...
        location_type = kwargs.get('location_type', "instance")
