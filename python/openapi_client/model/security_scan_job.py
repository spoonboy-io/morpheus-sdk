...
class SecurityScanJob(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, security_package, target_type, targets, schedule_mode, *args, **kwargs):  # noqa: E501
        """SecurityScanJob - a model defined in OpenAPI

        Args:
            name (str): A name for the Job
            security_package (WorkflowJobPayloadTask):
            target_type (str): Target type where job will execute
            targets ([WorkflowJobPayloadTargetsInner], none_type):
        ...
        self.name = name
        self.security_package = security_package
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, security_package, target_type, targets, schedule_mode, *args, **kwargs):  # noqa: E501
        """SecurityScanJob - a model defined in OpenAPI
