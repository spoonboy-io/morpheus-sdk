...
class AddVDIPoolsRequestVdiPoolOneOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, max_pool_size, instance_config, *args, **kwargs):  # noqa: E501
        """AddVDIPoolsRequestVdiPoolOneOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, max_pool_size, instance_config, *args, **kwargs):  # noqa: E501
        """AddVDIPoolsRequestVdiPoolOneOf - a model defined in OpenAPI
